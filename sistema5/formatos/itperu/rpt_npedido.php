...
<div id="sec2">
<div id="detalle">
  <table width="298"  border="0" align="left" cellpadding="0" cellspacing="0">

      <tr>

        <td width="49" align="center"><span style="visibility:hidden" align ="center">C</span></td>

       

        <td width="158" align="center"><span style="visibility:hidden" >DESCRIPCI&Oacute;N</span></td>

        <td width="44" align="center" class="Estilo3">&nbsp;</td>

        <td width="47" align="center"><span style="visibility:hidden" > I </span></td>
      </tr>
