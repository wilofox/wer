...
<div id="contenedor">
<div id="direTransp" ><?php echo $direTransp ?></div>
<div id="fecha">
<?php echo $dia_fech."/".$mes_fech."/".$año_fech;?></div>
<div id="fecha2">
<?php echo $dia_fech."/".$mes_fech."/".$año_fech;?></div>
<div id="serie"><?php echo $doc ?> / <?php echo $serie ?>-<?php echo $numero ?></div>
<div id="llegada"><?php echo utf8_encode(strtoupper($direc_aux)); ?></div>
<div id="destino"><?php echo utf8_encode($nom_aux)?></div>

<div id="ruc">  
<?php echo $ruc_aux; ?></div>
<div id="trans_nom"><?php echo utf8_encode($nomtrans) ?></div>
...
<div id="detalle">
  <table width="740"  border="0" align="left" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="69" >&nbsp;</td>
      <td width="65" >&nbsp;</td>
      <td width="398" ><span class="Estilo7" style="visibility:hidden">DESCRIPCI&Oacute;N</span></td>
      <td width="29" >&nbsp;</td>
      <td width="124" >&nbsp;</td>
    </tr>
    <?php 	  
...
$resultado4 = mysql_query ($strSQL4,$cn);
	  ...
	  ?>
    <tr>
      <td  align="left" valign="top"><span class="Estilo7"></span><span class="Estilo7"><?php echo $P  ?></td>
      <td  align="center" valign="top"><?php echo $cant ?></td>
      <td  align="center" valign="top"><?php echo $unid ?></td>
      <td colspan="3"  align="left" valign="top"><span class="Estilo7"><?php echo utf8_encode($descripcion);?></span></td>
      </tr>
    <?php 
...
?>
    <tr>
      <td  colspan="28"><div align="left"></div></td>
    </tr>
  </table>
</div>
<div id="fecha2">
