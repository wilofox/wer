...
<div id="ruc"> 
<table width="87" height="19" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="17" align="center" valign="middle"><?php echo $dia_fech;?></td>
      <td width="33" align="center" valign="middle">/<?php echo $mes_fech;?></td>
      <td width="37" align="center" valign="middle">/<?php echo $año_fech;?></td>
    </tr>
  </table>
</div>
...
//echo $acumulador;
	  ...
	  ?>
    <tr>
	<td align="left" valign="top"><p class="Estilo7"><?php echo ++$z; ?></p></td>
