...
<div id="obs5"><?php echo $obs5; ?></div><?php 
*/?>
...
<div id="detalle">
  <table width="702" height="79"   border="0" cellpadding="0" cellspacing="0">
    <tr>
...
//echo $acumulador;
	...
	echo "S/N:".$acumulador;
	 ...
	 ?>
      ...
      <td width="68" align="right" valign="middle"><span class="Estilo7"><?php echo number_format($p_unit,2) ?></span></td>
