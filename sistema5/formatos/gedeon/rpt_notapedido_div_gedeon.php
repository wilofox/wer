...
<div id="fecha"><table border="0" cellpadding="0" cellspacing="0">
      <tr>
...
<div id="email"><?php echo $email_aux ?></div>
<div id="detalle"><table  border="0" align="left" cellpadding="0" cellspacing="0">

      <tr>

        <td width="22" align="center"><span style="visibility:hidden" align ="center">C</span></td>

       

        <td width="223" align="center"><span style="visibility:hidden" >DESCRIPCI&Oacute;N</span></td>

        <td width="24" align="center" class="Estilo3">&nbsp;</td>

        <td width="46" align="center"><span style="visibility:hidden" > I </span></td>
      </tr>
...
//echo $acumulador;
      ...
      <tr>
        ...
        <td  align="left" valign="top"><span style="font-size:14px;"><?php echo $cant ?></span></td>
