...
//echo $acumulador;
	...
	echo "S/N:".$acumulador;
	 ...
	 ?>
      ...
      <td width="67" align="center" valign="top"><span class="Estilo7"><?php echo $garantia." Meses"?>&nbsp;</span></td>
      <td width="51" align="center" valign="top"><span class="Estilo7"><?php echo number_format($p_unit,2) ?></span></td>
...
<div id="fecha">
  <table width="126" height="19" border="0" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="48" align="center" valign="middle"><?php echo $año_fech;?></td>
    </tr>
  </table>
</div>
...
<?php 
/*if($nom_aux4=='1'){
echo "<table width='126' height='19' border='0' cellpadding='0' cellspacing='0'>
    <tr>
      <td width='56' align='center' valign='middle'>$dia_fech </td>
      <td width='54' align='center' valign='middle'>$mes_letra </td>
      <td width='48' align='center' valign='middle'>$año_fech </td>
    </tr>
  </table>";
}
*/
