...
<div id="email"><?php echo "D.N.I.: ".$dni_aux ?></div>
<div id="condicion"><?php echo $condicion ?></div>
</div>
<div id="sec2">
<div id="detalle">
  <table width="712"  border="0" align="left" cellpadding="0" cellspacing="0">

      <tr>

        <td colspan="3" align="center"><span style="visibility:hidden" align ="center">C</span></td>

       

        <td width="416" align="center"><span style="visibility:hidden" >DESCRIPCI&Oacute;N</span></td>

        <td width="57" align="center" class="Estilo3">&nbsp;</td>

        <td width="47" align="center" class="Estilo3">&nbsp;</td>
        <td width="83" align="center"><span style="visibility:hidden" > I </span></td>
      </tr>
...
//echo $acumulador;
      ...
      <tr>
        ...
        <td width="35"  align="center" valign="top"><?php echo $cod_producto ?></td>

        <td width="49"  align="center" valign="top"><?php echo $cant ?></td>
	...
	?>
        ...
        <td align="right" valign="top"><?php echo $garantia." Meses"?></td>
