...
<div id="ruc"> 
<table width="166" height="19" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="37" align="center" valign="middle"><?php echo $dia_fech;?></td>
      <td width="76" align="center" valign="middle"><?php echo $mes_fech;?></td>
      <td width="53" align="center" valign="middle"><?php echo $año_fech;?></td>
    </tr>
  </table>
</div>
...
//echo $acumulador;
	  ...
	  ?>
    <tr>
      <td align="center" valign="top"><p class="Estilo7"><?php  if($row ['cod_prod']!='TEXTO') echo $cant ?></p></td>
	...
	echo "S/N:".$acumulador;
	 ...
	 ?>
      ...
      <td align="center" valign="top"><span class="Estilo7">&nbsp;<?php  if($row ['cod_prod']!='TEXTO') echo number_format($p_unit,2) ?></span></td>
      <td align="center" valign="top"  class="Estilo7" >&nbsp;<?php  if($row ['cod_prod']!='TEXTO') echo number_format($p_tot,2)?></td>
    </tr>
    <?php 
