...
//echo $acumulador;
	  ...
	  ?>
    <tr>
      <td align="left" valign="top"><p class="Estilo7">&nbsp;</p>        <span class="Estilo7"></span></td>
	...
	echo "S/N:".$acumulador;
	 ...
	 ?>      </td>
      <td width="58" align="center" valign="top"><span class="Estilo7">&nbsp;</span><span class="Estilo7"><?php 
	  
	  if($row ['cod_prod']!='TEXTO')echo $cant; 
	  
	  
	  
	   ?></span></td>
      <td width="68" align="right" valign="top"><span class="Estilo7">
	  <?php if($row ['cod_prod']!='TEXTO')echo number_format($p_unit,2)?>
	  </span></td>
      <td align="right" valign="top"  class="Estilo7" >&nbsp;<?php 
	  
	  if($row['cod_prod']!='TEXTO'){
	  echo number_format($p_tot,2); 
	  }else{
	  echo $notas;
	  }
	  ?></td>
