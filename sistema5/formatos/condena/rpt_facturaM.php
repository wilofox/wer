...
//echo $acumulador;
	...
	echo "S/N:".$acumulador;
	 ...
	 ?>
      ...
      <td width="69" align="right" valign="top"><span class="Estilo7"><?php echo number_format($p_unit,2) ?></span></td>
...
<div id="fecha">
  <table width="208" height="19" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="49" align="center" valign="middle"><?php echo $dia_fech;?></td>
      <td width="67" align="center" valign="middle"><?php echo $mes_letra;?></td>
      <td width="92" align="right" valign="middle"><?php echo $año_fech;?></td>
    </tr>
  </table>
</div>
