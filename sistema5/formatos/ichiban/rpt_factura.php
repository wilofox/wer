...
<div id="fecha">
  <table width="412" height="19" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="108" align="right" valign="middle"><?php echo $dia_fech;?></td>
      <td width="173" align="center" valign="middle"><?php echo $mes_letra;?></td>
      <td width="131" align="right" valign="middle"><?php echo $año_fech;?></td>
    </tr>
  </table>
</div>
