...
<div id="telefono"><?php //echo $telefono; ?></div>
<div id="fecha"> 
...
//echo $acumulador;
	...
	echo "&nbsp;S/N:".$acumulador;
	 ...
	 ?>
      ...
      <td align="right" valign="top"><span class="Estilo7">&nbsp;<?php echo $ancho ?></span></td>
      <td align="right" valign="top"  class="Estilo7" >&nbsp;<?php echo $largo ?></td>
	  <td align='right' valign="top">&nbsp;<?php echo $cant ?></td>
	  <td align='right' valign="top">&nbsp;<?php echo $p_tot ?></td>
    </tr>
    <?php 
...
?>
    <tr>
      <td height="19" colspan="38"><div align="left"></div></td>
    </tr>
  </table>
</div>
</div>
<div id="sec3">
<div id="total"><?php echo $m_total ?></div>
<div id="acta"><?php echo $m_total-$m_saldo ?></div>
<div id="saldo"><?php echo $m_saldo ?></div>
</div>
</div>
</body>
</body>
