...
?>
<div id="fecha2">
  <table width="236" height="18" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="80" align="center" valign="middle"><?php echo $dia_fech;?></td>
      <td width="110" align="center" valign="middle"><?php echo $mes_letra;?></td>
      <td width="93" align="center" valign="middle"><?php echo $año_fech;?></td>
    </tr>
  </table>
</div>
<?php 
