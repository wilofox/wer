...
<div id="serie" style="position:absolute; left: 402px; top: 98px;"><?php echo $doc ?> / <?php echo $serie ?>-<?php echo $numero ?></div>
...
$resultado4 = mysql_query ($strSQL4,$cn);
	  ...
	  ?>
    <tr>
      <td  align="center" valign="top"><span class="Estilo7"></span><span class="Estilo7"><?php echo $cant ?></td>
