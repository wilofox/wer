...
<div id="fecha">
  <table width="279" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="51" align="center" valign="middle"><?php echo $dia_fech ?></td>
        <td width="143" align="center" valign="middle"><?php echo $mes_letra?></td>
        <td width="58" align="right" valign="middle"><?php echo $año_fech ?></td>
      </tr>
    </table>
</div>
<div id="cliente"><?php echo utf8_encode(strtoupper($nom_aux)); ?></div>
<div id="direccion"><?php echo utf8_encode(strtoupper($direc_aux)); ?></div>
<div id="referencia">
  <?php 
...
<div id="detalle">
  <table width="715"  border="0" align="left" cellpadding="0" cellspacing="0">

      <tr>

        <td width="77" align="center"><span style="visibility:hidden" align ="center">C</span></td>

       

        <td width="473" align="center"><span style="visibility:hidden" >DESCRIPCI&Oacute;N</span></td>

        <td width="63" align="center" class="Estilo3">&nbsp;</td>

        <td width="102" align="center"><span style="visibility:hidden" > I </span></td>
      </tr>
...
//echo $acumulador;
      ...
      <tr>
        ...
        <td height="20" align="left" valign="top"><p class="Estilo7"><?php echo utf8_encode(substr($descripcion,0,80));
