	...
	while ($rowdet = mysql_fetch_array ( $rsdet )) 
{
	...
	if( $rowdet['afectoigv'] == 'S'){
	$montoafecto  = $montob*100/(100+$igv);$igvp = $montoafecto*($igv/100); 
	}
 ...
 <?php /*?>   <td width="49"><span class="EstiloItem"><?=$rowdet['cantidad'].'('.$rowuni['nombre'].')';?></span></td>
  ...
  <tr style="display:none">
    ...
    <td align="right" class="Estilo50"><?php echo number_format($montogeafecto,2);?></td>
  </tr>
...
?>	
  ...
  <tr>
    <td colspan="2"><span class="Estilo50">A CUENTA</span></td>
 ...
 <!-- <tr>
  ...
  <tr>
    <td colspan="2"><span class="Estilo50">VUELTO S/. <?php echo number_format($_REQUEST['vuelto'],2);?></span></td>
    <td align="right"><span class="Estilo50">
      <? //$rowmo['simbolo']?>
    </span></td>
  </tr>
  <tr>
