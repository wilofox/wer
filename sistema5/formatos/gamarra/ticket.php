<?php 
	...
	$strcab		= 	"select * from cab_mov where cod_cab='".$cod2_cab."' " ;
 ...
 <table width="242" border="0" cellpadding="0" cellspacing="0" align="center">
   <tr>
     <td colspan="3" align="center" ><span class="Estilo50">
         ...
         R.U.C: <?=$rowemp['ruc']?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=$rowti['telefono']?><br>
      <?=$rowti['direccion']?> - <?=$rowti['des_tienda']?> </span></td>
   </tr>
   <tr>
   ...
   <tr>
     <td colspan="3" align="center"><span class="Estilo50"><?php  
	   if( empty($rowcli['ruc'] ) ){ 
	   ...
	   ?>
      <?php echo $serie."-".$numero ?></span></td></tr>
