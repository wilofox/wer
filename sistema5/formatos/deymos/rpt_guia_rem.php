...
<div id="detalle">
  <table width="654"  border="0" align="left" cellpadding="0" cellspacing="0">
    <tr>
      <td colspan="2" ><span class="Estilo7" style="visibility:hidden">DESCRIPCI&Oacute;N</span></td>
      <td width="119" >&nbsp;</td>
      <td width="37" >&nbsp;</td>
    </tr>
    <?php 	  
...
$resultado4 = mysql_query ($strSQL4,$cn);
	...
	$resultado4 = mysql_query ($strSQL4,$cn);
	  ...
	  ?>
    <tr>
      <td width="36" height="20" align="left" valign="top"><span class="Estilo7"><?php echo $unid?> &nbsp;</span></td>
      <td width="462" align="left" valign="top">
	  <p class="Estilo7"><?php echo 
	  $descripcion;
		 if ($simanejaser == "S" )
				 {
		  		?> <br>
