...
<div id="subtotal" style=" font-size:22px !important; "><?php echo $moneda.number_format($m_bruto,2) ?></div>
<div id="igv" style="font-size:22px !important; "><?php echo $impto?></div>
<div id="imp" style="font-size:22px !important; "><?php echo $p_igv." ".$moneda. number_format( $igv,2) ?></div>
<div id="total" style="font-size:22px !important; "><?php echo $moneda.number_format($m_total,2) ?></div>
