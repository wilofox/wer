...
<div id="fecha">
  <table width="130" height="20" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="60" align="center" valign="middle"><?php echo $mes_fech?></td>
...
<div id="sec2">
<div id="detalle">
  <table width="717"  border="0" align="left" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="452" align="center"><span style="visibility:hidden" >DESCRIPCI&Oacute;N</span></td>

        <td width="84" align="center" class="Estilo3">&nbsp;</td>
        <td width="95" align="center"><span style="visibility:hidden" > I </span></td>
      </tr>
...
//echo $acumulador;
      ...
      <tr>
        ...
        <td width="86"  align="ringt" valign="top"><?php echo $cant ?></td>
	...
	?>
        ...
        <td align="ringth" valign="top"><?php echo number_format($p_unit,2) ?></td>
