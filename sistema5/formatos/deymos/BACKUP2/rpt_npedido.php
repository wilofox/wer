...
<div id="sec2">
<div id="detalle">
  <table width="318"  border="0" align="left" cellpadding="0" cellspacing="0">

      <tr>

        <td width="62" align="center"><span style="visibility:hidden" align ="center">C</span></td>

       

        <td width="157" align="center"><span style="visibility:hidden" >DESCRIPCI&Oacute;N</span></td>

        <td width="40" align="center" class="Estilo3">&nbsp;</td>

        <td width="59" align="center"><span style="visibility:hidden" > I </span></td>
      </tr>
...
//echo $acumulador;
      ...
      <tr>
        ...
        <td  align="ringth" valign="top"><?php echo $cant ?></td>
