...
<div id="responsable"><?php echo strtoupper($responsable); ?></div>
</div>
<div id="sec2">
<div id="detalle">
  <table width="326"  border="0" align="left" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="42" align="center"><span style="visibility:hidden" align ="center">C</span></td>

       

        <td width="177" align="center"><span style="visibility:hidden" >DESCRIPCI&Oacute;N</span></td>

        <td width="52" align="center" class="Estilo3">&nbsp;</td>

        <td width="55" align="center"><span style="visibility:hidden" > I </span></td>
      </tr>
