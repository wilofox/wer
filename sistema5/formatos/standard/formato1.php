...
list($fontsize,$altura,$fuente,$separacion,$anchodoc)=mysql_fetch_row(mysql_query("select fontsize,altura,fuente,separacion,anchodoc from formatos where doc='".$doc."' and sucursal='".$empresa."' and pc='".$_SESSION['codterminal']."'"));
...
if($habilitar[$pos]=='S')$display='block'; else $display='none';?>
<div style="width:<?php echo $ancho[$pos]?> ; height:<?php echo $alto[$pos]?> ; left:<?php echo $coordx[$pos]?> ; top:<?php echo $coordy[$pos]?>; position: absolute ;font-size:<?php echo $fontsize?>; font-family:<?php echo $fuenteTexto?> ; display:<?php echo $display?>; text-align:right"><?php echo " *OPERACION SUJETA A PERCEPCION DEL IGV.   ".$porPercentaje." %   TOTAL: " ?></div>
...
//echo $acumulador;
	  ?>
		...
		<div style="width:<?php echo $ancho2?> ; height:<?php echo $alto2?> ; left:<?php echo $coordx2?> ; top:<?php echo $coordy2?>; position: absolute ;font-size:<?php echo $fontsize?>; font-family:<?php echo $fuenteTexto?> ; text-align:left ;  "><?php echo $descripcion; ?></div>
...
//echo $acumulador;
	...
	//echo $acumulador;
		...
		//********************************** Codigo para productos sin Modelo *****************************
...
//echo $acumulador;
	...
	<?php /*?>	
		<div style="width:<?php echo $ancho2?> ; height:<?php echo $alto2?> ; left:<?php echo $coordx2?> ; top:<?php echo $coordy2?>; position: absolute ;font-size:<?php echo $fontsize?>; font-family:<?php echo $fuenteTexto?> ; text-align:left ;  "><?php echo $descripcion." --->7"; ?></div><?php */?>
		
		
		<div style="width:<?php echo $ancho3?> ; height:<?php echo $alto3?> ; left:<?php echo $coordx3?> ; top:<?php echo $coordy3?>; position: absolute ;font-size:<?php echo $fontsize?>; font-family:<?php echo $fuenteTexto?> ; display:<?php echo $display3?>; text-align:right"><?php 
		...
		<div style="width:<?php echo $ancho4?> ; height:<?php echo $alto4?> ; left:<?php echo $coordx4?> ; top:<?php echo $coordy4?>; position: absolute ;font-size:<?php echo $fontsize?>; font-family:<?php echo $fuenteTexto?> ; display:<?php echo $display4?>">
	...
	<?php	
		...
		if($descripcion!=''){
		$totalCaracteres=strlen($descripcion);
		//echo $totalCaracteres;
		$j=1;
		$acumulador="";
		$array="";
		
		for($k1=0;$k1<$totalCaracteres;$k1++){	

		$caracter=substr($descripcion,$k1,1);	
		//echo $caracter;
			if($k1>60*$j){
			//echo "entrar";
				if($caracter==' '){
	...
	//	print_r($array);
		...
		if($array!==''){
		//********************************************
		for($k1=0;$k1<count($array);$k1++){	
				// for( k=0; 0<22;    )
		
		//$cadena_imp=substr($nota,$divisor*$k1,$divisor);
		
		
		/*$posEspB=strpos($cadena_imp," ",60);
	//echo "--->".$posEspB;
		if($posEspB!=''){
		
		$cadena_imp2=substr($nota,$divisor*$k1,$divisor);		
		$cadena_imp=substr($nota,$divisor*$k1,$posEspB);
		
		}else{
		$cadena_imp2=$cadena_imp;
		}
		
		
		$diferencia=substr($cadena_imp2,$posEspB,70-$posEspB);*/
		...
		<div style="width:<?php echo $ancho2?> ; height:<?php echo $alto2?> ; left:<?php echo $coordx2?> ; top:<?php echo $coordy2?>; position: absolute ;font-size:<?php echo $fontsize?>; font-family:<?php echo $fuenteTexto?> ; text-align:left ;  "><?php echo $array[$k1]; ?></div>		
		...
		<div style="width:<?php echo $ancho2?> ; height:<?php echo $alto2?> ; left:<?php echo $coordx2?> ; top:<?php echo $coordy2?>; position: absolute ;font-size:<?php echo $fontsize?>; font-family:<?php echo $fuenteTexto?> ; text-align:left ;  "><?php echo $acumulador; ?></div>		
...
//*************************************************************************************	
	...
	//echo $acumulador;
		...
		//*************************************************************************************	 1567/70= 22   Residuo=27
//echo $nota;
		/*
		$divisor=70; // cantidad de caracteres por linea
		$dividendo=strlen($nota); // cantidad de caracteres totales
		$cociente=$dividendo / $divisor;  // diviendo = divisor*Cociente + R
		$residuo=$dividendo % $divisor;
		*/
...
if($habilitar[$pos]=='S' && $pos!='')$display='block'; else $display='none';?>
<div style="width:<?php echo $ancho[$pos]?> ; height:<?php echo $alto[$pos]?> ; left:<?php echo $coordx[$pos]?> ; top:<?php echo $coordy2 ?>; position: absolute ;font-size:<?php echo $fontsize?>; font-family:<?php echo $fuenteTexto?> ; display:<?php echo $display?>; text-align:right"><?php echo number_format($m_total,2); ?></div>
...
if($habilitar[$pos]=='S' && $pos!='')$display='block'; else $display='none';?>
<div style="width:<?php echo $ancho[$pos]?> ; height:<?php echo $alto[$pos]?> ; left:<?php echo $coordx[$pos]?> ; top:<?php echo $coordy2 ?>; position: absolute ;font-size:<?php echo $fontsize?>; font-family:<?php echo $fuenteTexto?> ; display:<?php echo $display?>; text-align:right; font:bold"><?php echo number_format($m_total+$percepcion,2); ?></div>
...
if($habilitar[$pos]=='S' && $pos!='')$display='block'; else $display='none';?>
<div style="width:<?php echo $ancho[$pos]?> ; height:<?php echo $alto[$pos]?> ; left:<?php echo $coordx[$pos]?> ; top:<?php echo $coordy2 ?>; position: absolute ;font-size:<?php echo $fontsize?>; font-family:<?php echo $fuenteTexto?> ; display:<?php echo $display?>; text-align:right"><?php echo number_format($m_total+$vuelto,2); ?></div>
