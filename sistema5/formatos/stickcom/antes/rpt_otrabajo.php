...
<div id="subtotal" <?php echo $prmUsu?> ><?php echo $moneda.number_format($m_bruto,2) ?></div>
</div>
<div id="sec2">
<div id="detalle">
	 ...
	 ?>
      ...
      <td align="center" valign="top"  class="Estilo7">&nbsp;<?php echo $largo ?></td>
	    <td align='center' valign="top" class="Estilo7">&nbsp;<?php echo $cant ?></td>
		  <td align='center' valign="top" <?php echo $prmUsu?> ><span class="Estilo7"><?php echo number_format($p_tot,2)?></span></td>
...
<div id="imp" <?php echo $prmUsu?> ><?php echo $p_igv." ".$moneda. number_format( $igv,2) ?></div>
