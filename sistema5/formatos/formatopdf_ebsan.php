...
$etiquetaOSB3=$row_doc['obs3'];
		...
		*/
		...
		$this->Cell(40,5,$dia_fech." de ".$mes_letra." del ".$año_fech,0,0,'L');
		...
		//$this->Cell(5,6,'',0,0,'L');
		$this->Cell(-5);
		$this->Cell(75,8,'DATOS DEL '.$desAux.".-",0,0,'L');
		
		$this->Cell(40);
		$this->Cell(75,8,"CONDICIONES DE PAGO.-",0,0,'L');
		...
		$this->Cell(-5);
		$this->Cell(35,6,$desAux2,0,0,'L');
				
		
		$this->Cell(3,6,':',0,0,'R');
		$this->SetFont('Arial','B',9);
		$this->Cell(50,6,substr($nom_aux,0,32),0,0,'L');
		$this->SetFont('Arial','',9);
		
		$this->Cell(27);
		$this->Cell(28,6,'Validez de la oferta',0,0,'R');
		$this->Cell(3,6,':',0,0,'R');
		$this->Cell(50,6,$obs1,0,0,'L');
		
		$this->Ln();						
		$this->Cell(10,6,'',0,0,'L');
		$this->Cell(20,6,utf8_decode('Domicilio'),0,0,'R');
		$this->Cell(3,6,':',0,0,'R');
		$this->Cell(50,6,substr($direc_aux,0,34),0,0,'L');
		
		
		$this->Cell(27);
		$this->Cell(28,6,'Plazo de Entrega',0,0,'R');
		$this->Cell(3,6,':',0,0,'R');
		...
		$this->Cell(10,6,'',0,0,'L');
		$this->Cell(20,6,'  R.U.C.',0,0,'R');
		$this->Cell(3,6,':',0,0,'R');
		$this->Cell(50,6,$docu_aux,0,0,'L');
		
		
		$this->Cell(27);
		$this->Cell(28,6,'Moneda',0,0,'R');
		$this->Cell(3,6,':',0,0,'R');
		$this->Cell(50,6,$monedalet,0,0,'L');
		//$this->Cell(10,6,'',0,0,'L');
		...
		$this->Cell(10,6,'',0,0,'L');
		$this->Cell(20,6,'  Contacto',0,0,'R');
		$this->Cell(3,6,':',0,0,'R');
		$this->Cell(50,6,substr($contacto,0,32),0,0,'L');
		
		
		$this->Cell(27);
		$this->Cell(28,6,utf8_decode('Condición de pago'),0,0,'R');
		$this->Cell(3,6,':',0,0,'R');
		...
		$this->SetFont('Arial','',10);
		$this->Cell(0,5,utf8_decode('Estimados Señores, por medio de la presente, y de acuerdo a su solicitud sometemos a su '),0,0,'C');
		$this->Ln();
		$this->Cell(0,5,utf8_decode('consideración nuestra oferta como sigue : '),0,0,'C');
		...
		*/
		...
		$this->Cell(-5);
		$this->Cell(5,5,'IT',0,0,'C',0);
		$this->Cell(30,5,'COD.ESPC',0,0,'C',0);
		$this->Cell(10,5,'CANT.',0,0,'C',0);
		$this->Cell(10,5,'UND',0,0,'C',0);
		$this->Cell(110,5,utf8_decode('DESCRIPCION'),0,0,'C',0);
		$this->Cell(15,5,'P. UNIT.',0,0,'C',0);
		$this->Cell(15,5,'TOTAL',0,0,'C',0);
		...
		$this->Cell(30,5,$cod_anexo1,'',0,'C',0);
		$this->Cell(10,5,$cant,'',0,'C',0);
		$this->Cell(10,5,$unid,'',0,'C',0);
		$this->Cell(110,5,substr($descripcion,0,52),'',0,'L',0);
		$this->Cell(15,5,number_format($p_unit,2)." ",'',0,'R',0);
		$this->Cell(15,5,number_format($p_tot,2)." ",'',0,'R',0);
		...
		$this->Ln();
		$this->Cell(-5);
		$this->Cell(5,2,'','B',0,'C',0);
		$this->Cell(30,2,'','B',0,'C',0);
		$this->Cell(10,2,'','B',0,'C',0);
		$this->Cell(10,2,'','B',0,'C',0);
		$this->Cell(110,2,'','B',0,'C',0);
		$this->Cell(15,2,'','B',0,'C',0);
		$this->Cell(15,2,'','B',0,'C',0);
		...
		$this->Cell(30,5,'','',0,'C',0);
		$this->Cell(10,5,'','',0,'C',0);
		$this->Cell(10,5,'','',0,'C',0);
		$this->Cell(110,5,'SUBTOTAL : ','',0,'R',0);
		$this->SetFont('Arial','B',9);
		
		$this->Cell(15,5,$moneda,'',0,'C',0);
		$this->Cell(15,5,number_format($m_bruto,2)." ",'',0,'R',0);
		...
		$this->Cell(10,5,'','',0,'C',0);
		$this->Cell(10,5,'','',0,'C',0);
		$this->Cell(110,5,'IGV : ','',0,'R',0);
		$this->SetFont('Arial','B',9);
		$this->Cell(15,5,$moneda,'',0,'C',0);
		$this->Cell(15,5,number_format($igv,2)." ",'',0,'R',0);
		...
		$this->Cell(10,5,'','',0,'C',0);
		$this->Cell(10,5,'','',0,'C',0);
		$this->Cell(110,5,'TOTAL : ','',0,'R',0);
		$this->SetFont('Arial','B',9);
		
		$this->Cell(15,5,$moneda,'',0,'C',0);
		$this->Cell(15,5,number_format($m_total,2)." ",'',0,'R',0);
		...
		*/
		...
		$this->Ln();
		$this->SetFont('Arial','',10);
		$this->Cell(0,5,utf8_decode('Sin otro particular y a la espera de su aceptación a la presente, quedamos a su disposición para cualquier consulta '),0,0,'C');
		$this->Ln();
		$this->Cell(0,5,utf8_decode('que ustedes estimen conveniente. '),0,0,'C');
		...
		*/
		$this->Ln(10);
		//$this->Image('../imagenes/cuentasebsan.jpg',15,120,150,29);
		$this->Image('../imagenes/cuentasebsan.jpg', $this->GetX(),$this->GetY(),120,25);
		/*
		$this->Ln(2);
		$this->SetFont('Arial','B',9);
		$this->Cell(10,6,'',0,0,'L');
	...
	function Footer()
	{
		...
		$this->SetDrawColor(10,151,247);
		$this->Ln();
		$this->Cell(-5);
		$this->Cell(5,2,'','B',0,'C',0);
		$this->Cell(20,2,'','B',0,'C',0);
		$this->Cell(15,2,'','B',0,'C',0);
		$this->Cell(15,2,'','B',0,'C',0);
		$this->Cell(110,2,'','B',0,'C',0);
		$this->Cell(15,2,'','B',0,'C',0);
		...
		$this->Ln(5);
		$this->Cell(-5);
		$this->Cell(20,5,utf8_decode("Jirón Nazca Nº "),0,0,'L');
		$this->SetTextColor(10,151,247);
		$this->Cell(5,5,"482",0,0,'L');
		$this->SetTextColor(0,0,0);		
		$this->Cell(10,5," Oficina ",0,0,'L');
		$this->SetTextColor(10,151,247);
		$this->Cell(10,5," 703",0,0,'L');
		$this->SetTextColor(0,0,0);	
		
		$this->Cell(120,5," Telefax: ",0,0,'R');
		$this->SetTextColor(10,151,247);
		$this->Cell(0,5," 423-4151 - 782-3077 ",0,0,'L');
		$this->SetTextColor(0,0,0);	
		
		$this->Ln();
		$this->Cell(-5);
		$this->Cell(60,5,utf8_decode("Urb. Fundo Santa Beatriz - Jesús María - Lima - Lima "),0,0,'L');	
			
		$this->Cell(105,5,utf8_decode(" RPM: "),0,0,'R');
		$this->SetTextColor(10,151,247);
		$this->Cell(0,5,utf8_decode(" #879767 - 996026264 "),0,0,'L');
		$this->SetTextColor(0,0,0);	
		
		$this->Ln();
		$this->Cell(-5);
		$this->SetFont('Arial','BU',8);
		$this->SetTextColor(10,100,150);
		$this->Cell(45,5,utf8_decode("www.ebsaninternational.com  "),0,0,'L');
		$this->Cell(15,5,utf8_decode("ventas@ebsaninternational.com "),0,0,'L');
		$this->SetTextColor(0,0,0);
		
		$this->SetFont('Arial','B',8);						
		$this->Cell(105,5,utf8_decode(" Nextel: "),0,0,'R');
		$this->SetTextColor(10,151,247);
		$this->Cell(0,5,utf8_decode(" 816*6014 - 738*0717 "),0,0,'L');
		$this->SetTextColor(0,0,0);
		/*
...
$pdf->Image('../imagenes/logo_ebsan.jpg',5,2,130);
