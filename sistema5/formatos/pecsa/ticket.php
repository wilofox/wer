 ...
 <table width="242" border="0" cellpadding="0" cellspacing="0" align="center">
   ...
   <tr>
    <td colspan="3"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="14"  align="center"><span class="Estilo50">Maq.Reg.Nro.FF9F010812</span></td>
      </tr>
      <tr>
   ...
   <tr>
     <td height="18" colspan="3" align="center"><span class="Estilo50"><?php echo $fechaEmision ;?>&nbsp;
...
<?php
 ...
 ?>
    <td width="49"><span class="EstiloItem"><?=$rowdet['cantidad'].'('.$rowuni['nombre'].')';?></span></td>
  ...
  <tr>
    <td colspan="2"><span class="Estilo50">VUELTO S/. <?php echo number_format($_REQUEST['vuelto'],2);?><? //$rowmo['simbolo']?></span></td>
    <td align="right">&nbsp;</td>
  </tr>
  <tr>
    <td height="19" colspan="2"><span class="Estilo50">USUARIO:<?=$rowusu['usuario'] ?></span></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
