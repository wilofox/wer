...
<div id="detalle">
  <table width="654"  border="0" align="left" cellpadding="0" cellspacing="0">
    <tr>
      <td width="109" ><span class="Estilo7" style="visibility:hidden">DESCRIPCI&Oacute;N</span></td>
      <td width="8" >&nbsp;</td>
      <td width="537" >&nbsp;</td>
    </tr>
    <?php 	  
...
$resultado4 = mysql_query ($strSQL4,$cn);
    ...
    <tr>
      ...
      <td align="center" valign="top"><span class="Estilo7"><?php echo $unid?> <?php echo $descripcion;?></span></td>
    </tr>
    <?php 
}
