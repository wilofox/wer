...
#docReferencia {	position:absolute;
	top:69.85mm;
	right:22.49mm;
	border:0px solid;
	width: 185px;
...
<!--onLoad="defrente()"-->
<body onLoad="printer()"><strong></strong>
...
<div id="direccion"><?php echo strtoupper(htmlspecialchars($direc_aux)); ?></div>
<div id="mail"></div>
<p></p>
<p></p>
 </div>
...
<div id="detalle">
  <table width="855"  border="0" align="left" cellpadding="0" cellspacing="0">
      ...
      <tr>
		<td align="center" width="199"><span style="visibility:hidden">Codigo</span></td>
        <td align="center" width="86"><span style="visibility:hidden">Cantidad</span></td>
        <td align="center" width="205"><span style="visibility:hidden">Descripcion</span></td>
		<td align="center" width="108"><span style="visibility:hidden">Descuento</span></td>
		<td align="center" width="69"><span style="visibility:hidden">Precio unit.</span></td>
		<td align="center" width="99"><span style="visibility:hidden">unit con desc</span></td>
		<td align="center" width="89"><span style="visibility:hidden">sub total</span></td>
      </tr>
...
<?php
	...
	while ($row = mysql_fetch_array ($resultado)) {
      ...
      <tr>
	  	<td width="199"  align="center" valign="top"><?php echo $codAnexo1 ?></td>
        <td width="86"  align="center" valign="top"><?php echo $cant ?></td>
		...
		<td width="108"  align="center" valign="top"><?php //echo number_format(($p_unit*$row['desc1']/100)*$cant,2) 
		echo $row['desc1']." % ";
		?></td>
...
<div id="fechaVen">
  <table width="165" height="20" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="60" align="center" valign="middle"><?php echo $dia_fech2 ?></td>
      <td width="60" align="center" valign="middle"><?php echo $mes_letra2 ?></td>
      <td width="60" align="center" valign="middle"><?php echo $anio_fech2 ?></td>
    </tr>
  </table>
</div>
<div id="docReferencia"> <?php echo $num_ref_cod; ?> / <?php echo $num_ref_ser; ?> - <?php echo $num_ref_corr; ?> </div>
<p></p>
<p></p>
...
<div id="bi"><font class="Estilo7"><?php echo $moneda." ".$m_bruto ?></font></div>
<div id="igv"><font class="Estilo7"><?php echo $moneda." ".$igv ?></font></div>
<div id="totalg"><font class="Estilo7"><?php echo $moneda." ".$m_total ?></font></div>

<div id="telefono"><font class="Estilo7"><?php echo $telefono ?></font></div>

<div id="rucAux"><font class="Estilo7"><?php echo " ".$ruc_aux ?></font></div>
