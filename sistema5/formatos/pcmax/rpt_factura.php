...
//echo $acumulador;
	  ...
	  ?>
    <tr>
      <td align="center" valign="middle"><p class="Estilo7"><?php echo $cant ?></p></td>
      <td width="471" height="15" align="left" valign="middle"><p class="Estilo7"><?php echo $descripcion;
		 if ($simanejaser == "S" )
				 {
		  		?> 
              <?php 
	...
	echo "S/N:".$acumulador;
	 ...
	 ?>
      ...
      <td align="right" valign="middle"><span class="Estilo7"> &nbsp;<?php echo number_format($p_unit,2) ?></span></td>
      <td align="right" valign="middle"  class="Estilo7" >&nbsp;<?php echo number_format($p_tot,2)?></td>
    </tr>
    <?php 
...
<div id="fecha">
  <table width="272" height="19" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="94" align="center" valign="middle"><?php echo $dia_fech;?></td>
      <td width="114" align="center" valign="middle"><?php echo $mes_letra;?></td>
      <td width="64" align="center" valign="middle"><?php echo $año_fech;?></td>
    </tr>
  </table>
</div>
