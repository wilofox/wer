...
//echo $acumulador;
	  ...
	  ?>
    <tr>
      <td width="55" align="center" valign="top"><p class="Estilo7"><?php echo $cant ?></p></td>
      <td width="51" align="center" valign="top"><?php echo $P ?></td>
...
<div id="sec3">
  <div id="fecha">
  <table width="299" height="19" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="94" align="center" valign="middle"><?php echo $dia_fech;?></td>
      <td width="126" align="center" valign="middle"><?php echo $mes_letra;?></td>
