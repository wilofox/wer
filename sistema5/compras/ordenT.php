...
scrollDivs[1]="dimensionesOT";
scrollDivs[1]="totalesOT";
...
function domo(){
 ...
 jQuery(document).bind('keydown', 'f6',function (evt){jQuery('#_f6').addClass('dirty');
	...
	window.open('observaciones.php?doc='+document.formulario.doc.value+'&obs1='+document.formulario.obs1.value,'','width=350,height=300,top=250,left=350,scroolbars=no,directories=no,location=no,menubar =no,titlebar=no,toolbar=no,status=yes');
...
jQuery(document).bind('keyup', 'return',function (evt){jQuery('#_return').addClass('dirty'); 
		//alert();
			...
			return false;
			 ...
			 if(document.getElementById('dimensionesOT').style.visibility=='visible'){
			 
			 	if(document.activeElement.name=="ancho"){
			    document.formulario.largo.focus();
				document.formulario.largo.select();
				document.formulario.SubmitOT.disabled=false;
				}
				return false;
	...
	if(document.getElementById('productos').style.visibility=='visible'){
	  ...
	  // document.formulario.precosto.value=unidad[6];
	   document.formulario.manejaFactorOt.value=unidad[12];
	   document.formulario.preMinOT.value=unidad[14];
					 ...
					 if(document.formulario.tipomov.value==2){
						...
						if( parseFloat(saldo) >= parseFloat(cant) || prms_doc_stock=='N' ){
							...
							//alert(permiso10);
							 ...
							 if(document.formulario.tempDim.value=="" && document.formulario.manejaFactorOt.value=="S"){
							 
						     document.getElementById('dimensionesOT').style.visibility='visible';
							 document.getElementById('cbo_uni').style.visibility='hidden';
							
							 document.formulario.ancho.focus();
							 document.formulario.SubmitOT.disabled=false;
							 return false;
							 }
							...
							if(document.activeElement.name=='punit'){
							//document.getElementById('totalesOT').style.visibility='visible';
							return false;
							}
...
function salir(){
		...
		if(document.getElementById('dimensionesOT').style.visibility=='visible'){
		document.getElementById('dimensionesOT').style.visibility='hidden';
			
			if(document.formulario.SubmitOT.disabled){	
			document.formulario.ancho.value="";
			document.formulario.largo.value="";
			document.formulario.mt2.value="";
			document.formulario.factorOT.value="";
			}
		...
		if(document.getElementById('totalesOT').style.visibility=='visible'){
		document.getElementById('totalesOT').style.visibility='hidden';
		document.getElementById('cbo_uni').style.visibility='visible';
		//enviar();
		return false;
		}
...
document.formulario.tempDim.value="";
...
function listaprod(texto){
	...
	//alert(temp_criterio);
	doAjax('det_aux.php','&clasificacion=1&nomb_det='+valor+'&temp='+temp+'&tipomov='+tipomov+'&tienda='+tienda+'&criterio='+temp_criterio+'&prov_asoc='+document.formulario.prov_asoc.value+'&moneda_doc='+moneda_doc,'detalle_prod','get','0','1','','');
...
function buscar_item2(texto){
	...
	enviar();
		...
		if(confirm('Este item ya se encuentra ingresado en el detalle desea repetir este item? ')){
...
<form id="formulario" name="formulario" method="post" action="">
  <table width="795" border="0" cellpadding="0" cellspacing="0">
     ...
     <tr style="background:url(../imagenes/white-top-bottom.gif)">
       ...
       </span><span class="Estilo14 Estilo38">
       <input name="tempDim" id="tempDim" type="hidden" size="6" maxlength="6" value="">
       </span>
       <input type="hidden" name="manejaFactorOt" id="manejaFactorOt" value="N" size="6" maxlength="6">
	   <input type="hidden" name="preMinOT" id="preMinOT" value="" size="6" maxlength="6">
	   <input type="hidden" name="desc1OT" id="desc1OT" value="" size="6" maxlength="6">
	   <input type="hidden" name="desc2OT" id="desc2OT" value="" size="6" maxlength="6">
	   <input type="hidden" name="descSelec" id="descSelec" value="" size="6" maxlength="6">
    ...
    <tr style="background:url(../imagenes/botones.gif)" >
      ...
      <td width="5">&nbsp;</td>
      <td colspan="7"><table width="70%" height="21" border="0" cellpadding="0" cellspacing="0" style="border-bottom:#CCCCCC solid 1px">
        <tr>
          ...
          <td width="91" style="display:none"><table title="Cambiar Moneda [F8]" width="80" height="21" border="0" cellpadding="0" cellspacing="0">
          ...
          <td width="79" style="display:none">
		  
		  <table title="Incl./no Incl.[F9]" width="70" height="21" border="0" cellpadding="0" cellspacing="0">
            <tr onMouseOver="entrar_btn(this);" onMouseOut="salir_btn(this)" style="cursor:pointer" onClick="">
              <td width="3" ></td>
          ...
          <td width="85" style="display:none"><table title="Nuevo[F3]" width="75" height="21" border="0" cellpadding="0" cellspacing="0">
          ...
          <td width="85" style="display:none"><table title="Copiar Documento[F4]" width="85" height="21" border="0" cellpadding="0" cellspacing="0">
...
$k++;
    ...
    Calendar.setup({
        ...
        <tr>
		  ...
		  <strong><span style="font:Verdana, Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300">ORDEN DE TRABAJO</span></strong> 
		       
          </center>
          ...
          <td><input name="fven" type="text" size="15" maxlength="10"  value="<?php echo date('d-m-Y')?>"  onKeyUp="generar_ceros(event,'0',this)" onChange="enfocar_fecha(this)">
    ...
    <tr>
      <td></td>
      <td ></td>
      <td colspan="7"><table width="791" height="5" border="0" cellpadding="0" cellspacing="0" style="border-top: #CCCCCC solid 1px">
        <tr>
          <td width="791" height="5"></td>
        </tr>
      </table></td>
    </tr>
    <tr>
      ...
      <td colspan="7"><table width="781" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="175"><span class="Estilo14">Notas</span></td>
        </tr>
        <tr>
          ...
          <input style="text-align:right" name="cantidad" id="cantidad"  type="text" size="8" onKeyUp="calculos_pretot()" />
          ...
          <td><span class="Estilo14">
            <input  name="punit" type="text" size="8" style=" text-align:right"  onKeyPress="calcular_ptotal(event,this)" />
          </span></td>
          <td>&nbsp;</td>
...
-->
        ...
        <tr>
          ...
          <td width="290" align="left"><button title="[Alt+r]" disabled="disabled" onClick="vent_ref()" type="button" id="doc_ref"  style="height:18px"><span style=" font-family:Arial, Helvetica, sans-serif;font-size:9px">Referencia</span></button>
            <button title="[Alt+r]" disabled="disabled" onClick="vent_referenciado()" type="button" id="doc_ref2"  style="height:18px"><span style=" font-family:Arial, Helvetica, sans-serif;font-size:9px">Referenciado</span></button>
			 ...
			 <button title="" disabled="disabled" onClick="cambiar_dir()" type="button" id="btnCambiarDir"  style="height:18px"><span style=" font-family:Arial, Helvetica, sans-serif;font-size:9px">Cambiar Direcci&oacute;n</span></button>
			
			</td>
          </tr>
      </table></td>
      <td width="59">&nbsp;</td>
      <td width="93"><input name="saldo" type="hidden" size="10" maxlength="10">
  ...
  <span style="font:Arial, Helvetica, sans-serif; font-size:11px; font:bold; color:#0066FF">Natural.</span></td>
      ...
      <tr>
        ...
        <td width="141"><input name="aux_ruc" type="text" size="17" maxlength="11"  disabled="disabled" /></td>
 ...
 <div id="dimensionesOT" style="border:#238CE2 solid 1px; background:#E2FAFE; position:absolute; left:274px; top:139px; width:300px; height:180px; z-index:2; visibility:hidden; background-color: #F1FBFE;">
 
 <table width="298" height="172" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="26" style="background:url(../imagenes/bg_contentbase2.gif); background-position:100px 60px; color:#FFFFFF">&nbsp;</td>
    <td height="26" colspan="2" style="background:url(../imagenes/bg_contentbase2.gif); background-position:100px 60px; color:#FFFFFF"><strong>Ingresar Dimensiones </strong></td>
  ...
  <tr>
    <td width="8">&nbsp;</td>
    <td width="95" height="23"><span class="Estilo112">Ancho </span><span class="Estilo112">(mts) </span></td>
    <td width="169"><input type="text" name="ancho" id="ancho" style="text-align:right" ></td>
    <td width="26" rowspan="4">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td height="23"><span class="Estilo112">Largo (mts) </span></td>
    <td><input type="text" name="largo" id="largo" style="text-align:right" onKeyUp="buscarFactorOT(event)"></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td height="23"><span class="Estilo112">Mt2</span></td>
    <td><input type="text" name="mt2" id="mt2" value="0.000" style="text-align:right" disabled="disabled"></td>
  </tr>
  <tr>
    <td width="8">&nbsp;</td>
    <td width="95" height="22"><span class="Estilo112">Factor</span></td>
    <td><input type="text" name="factorOT" id="factorOT" value="0.000" style="text-align:right" disabled="disabled"></td>
  </tr>
  
  <tr>
      <td height="46" colspan="4" align="center">
	  
	  <input onClick="aceptar_dim();" type="button" name="SubmitOT" value="Aceptar">
      <input type="button" name="Submit4" value="Cancelar" onClick="salir();">
 ...
 <div id="totalesOT" style="border:#238CE2 solid 1px; background:#E2FAFE; position:absolute; left:274px; top:139px; width:300px; height:180px; z-index:2; visibility:hidden; background-color: #F1FBFE;">
 
 <table width="298" height="162" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="26" style="background:url(../imagenes/bg_contentbase2.gif); background-position:100px 60px; color:#FFFFFF">&nbsp;</td>
    <td height="26" colspan="2" style="background:url(../imagenes/bg_contentbase2.gif); background-position:100px 60px; color:#FFFFFF"><strong>Seleccionar Total  </strong></td>
    <td height="26" align="center" style="background:url(../imagenes/bg_contentbase2.gif); background-position:100px 60px; color:#FFFFFF; text-decoration:underline; cursor:pointer" onClick="salir();"><strong>x</strong></td>
  </tr>
  <tr>
    <td height="9" colspan="4"></td>
   ...
   <tr>
    <td width="8">&nbsp;</td>
    <td width="72" height="29" align="center"><input style="background:none; border:none" name="radiototal1" id="radiototal1" type="radio" value="radiobutton" onKeyUp="chkTotalOT(event);"></td>
    <td width="192"><span class="Estilo112"><label id="totalOT1">monto1</label>  (s/Descuento)</span></td>
    <td width="26" rowspan="2">&nbsp;</td>
   </tr>
  <tr>
    <td width="8">&nbsp;</td>
    <td width="72" height="25" align="center"><input onKeyUp="chkTotalOT(event)" style="background:none; border:none" name="radiototal1" id="radiototal2" type="radio" value="radiobutton"></td>
    <td><span class="Estilo112"><label id="totalOT2">monto1</label>  (c/Descuento)</span></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td height="27" align="center"><input onKeyUp="chkTotalOT(event)" style="background:none; border:none" name="radiototal1" id="radiototal3" type="radio" value="radiobutton"></td>
    <td><span class="Estilo112"><label id="totalOT3">monto1</label>  (c/Descuento por cantidad)</span></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="46" colspan="4" align="center"><input onClick="acepTotOT();" type="button" name="btnTotalesOt" id="btnTotalesOt" value="Aceptar">
      <input type="button" name="Submit4" value="Cancelar" onClick="salir();"></td>
    </tr>
</table>
</div>
...
if(punit!="" && document.formulario.cantidad.value==""){
	...
	if(document.formulario.manejaFactorOt.value=='S'){
	document.formulario.punit.value=(precio/(parseFloat(document.formulario.mt2.value)*parseFloat(document.formulario.factorOT.value))).toFixed(4);
	}else{
...
function enviar(){
	...
	//alert(document.formulario.precio.value+ "  "+ document.formulario.preMinOT.value);
	...
	var ancho=document.formulario.ancho.value;
	var largo=document.formulario.largo.value;
	var mt2=document.formulario.mt2.value;
	var factorOT=document.formulario.factorOT.value;
	var descOT=parseFloat(document.formulario.descSelec.value);
	
	var tempPrecio=parseFloat(document.formulario.precio.value)- descOT;
	
	
	//document.formulario.precio.value=(parseFloat(document.formulario.mt2.value)*parseFloat(document.formulario.punit.value)*parseFloat(document.formulario.factorOT.value)).toFixed(2);
	
	
	//document.formulario.punit.value=tempUnit.toFixed(3);
	
	if(document.formulario.tmoneda.value=='01'){
		var tempUnit=parseFloat(document.formulario.preMinOT.value)/(parseFloat(document.formulario.mt2.value)*parseFloat(document.formulario.factorOT.value));
	
		if(tempPrecio.toFixed(0)<parseFloat(document.formulario.preMinOT.value)){
			if(confirm("El precio minimo para este item es de: S/."+document.formulario.preMinOT.value+" \n Desea modificar el precio unitario por este otro : "+ tempUnit.toFixed(3))){
				document.formulario.punit.value=tempUnit.toFixed(3);
				punit=tempUnit.toFixed(3);		
			}else{
				document.formulario.punit.focus();
				document.formulario.punit.select();
				return false;
		...
		var precioMinOt=parseFloat(document.formulario.preMinOT.value)/tc_doc;
		
		var tempUnit=parseFloat(precioMinOt)/(parseFloat(document.formulario.mt2.value)*parseFloat(document.formulario.factorOT.value));
		
		if(tempPrecio.toFixed(0)<precioMinOt){
			//alert("El precio minimo para este item es de: U$S/."+precioMinOt.toFixed(2));
			//return false;
			if(confirm("El precio minimo para este item es de: U$S/."+ precioMinOt.toFixed(2)+" \n Desea modificar el precio unitario por este otro : "+ tempUnit.toFixed(3))){
				document.formulario.punit.value=tempUnit.toFixed(3);
				punit=tempUnit.toFixed(3);		
			}else{
				document.formulario.punit.focus();
	...
	doAjax('detalle_docOT.php','&incluidoigv='+document.formulario.incluidoigv.value+'&punitario='+punit+'&tmoneda='+document.formulario.tmoneda.value+'&mon_ini='+temp_mon+'&permiso4='+permiso4+'&notas='+notas+'&presentacion='+presentacion+'&esserie='+esserie+'&permiso10='+permiso10+'&cargar_ref=noref&precosto='+precosto+'&impto='+impto+'&percep_suc='+percep_suc+'&percep_doc='+percep_doc+'&min_percep_doc='+min_percep_doc+'&est_percep_clie='+est_percep_clie+'&por_percep_clie='+por_percep_clie+'&total_doc='+total_doc+'&tipomov='+tipomov+'&ancho='+ancho+'&largo='+largo+'&mt2='+mt2+'&factorOT='+factorOT+'&descOT='+descOT,'mostrar','get','0','1','','');
...
function calcular_ptotal(e,control){
...
document.formulario.tempDim.value="";
	...
	if(e.keyCode==13 && control.name=="punit"){
		
		var ptotal=parseFloat(document.formulario.precio.value);
		//var desc1OT	=1 + (parseFloat(document.formulario.desc1OT.value)/100);
	//	var desc2OT	=1 + (parseFloat(document.formulario.desc2OT.value)/100);
		
		var desc1OT	= parseFloat(document.formulario.desc1OT.value);
		var desc2OT	= parseFloat(document.formulario.desc2OT.value);
			//alert(desc1OT+" "+ptotal);
			var montoConDesc1=(ptotal/desc1OT).toFixed(2);				
			var montoConDesc2=(ptotal/desc2OT).toFixed(2);
			
			document.formulario.radiototal1[0].checked=true;
			
		if(document.formulario.cantidad.value>=5000){
			document.formulario.radiototal1[0].checked=false;
			document.formulario.radiototal1[1].checked=true;
			document.formulario.radiototal1[2].checked=false;
			
		}
		if(document.formulario.cantidad.value>=10000){
			document.formulario.radiototal1[0].checked=false;
			document.formulario.radiototal1[1].checked=false;
			document.formulario.radiototal1[2].checked=true;
						
		}
		
		document.formulario.radiototal1[0].value=0;
		document.formulario.radiototal1[1].value=parseFloat(ptotal-montoConDesc1).toFixed(2);
		document.formulario.radiototal1[2].value=parseFloat(ptotal-montoConDesc2).toFixed(2);
						
		document.getElementById("totalOT1").innerHTML=ptotal;
		document.getElementById("totalOT2").innerHTML=montoConDesc1;
		document.getElementById("totalOT3").innerHTML=montoConDesc2;	
			
		document.getElementById('totalesOT').style.visibility='visible';
		//document.getElementById('radiototal1').focus();
		document.formulario.radiototal1[0].focus();
		//alert();
		document.getElementById('cbo_uni').style.visibility='hidden';
		return false;
		//document.formulario.btnTotalesOt.focus();
		//document.formulario.btnTotalesOt.select();
...
function eliminar(codigo){
	...
	doAjax('detalle_docOT.php','&incluidoigv='+document.formulario.incluidoigv.value+'&cod_delete='+codigo+'&tmoneda='+document.formulario.tmoneda.value+'&mon_ini='+temp_mon+'&permiso4='+permiso4+'&tienda='+tienda+'&permiso10='+permiso10+'&cargar_ref&impto='+impto+'&tipomov='+tipomov,'mostrar','get','0','1',codigo,'eliminar');
	}
}
...
///	document.formulario.prueba.value=temp[2];
	...
	*/
	...
	doAjax('detalle_docOT.php','&incluidoigv='+document.formulario.incluidoigv.value+'&tmoneda='+document.formulario.tmoneda.value+'&mon_ini='+temp_mon+'&permiso4='+permiso4+'&permiso10='+permiso10+'&cargar_ref=ref'+'&accion=mostrarprod&impto='+impto+'&percep_suc='+percep_suc+'&percep_doc='+percep_doc+'&min_percep_doc='+min_percep_doc+'&est_percep_clie='+est_percep_clie+'&por_percep_clie='+por_percep_clie+'&total_doc='+total_doc+'&tipomov='+tipomov,'mostrar','get','0','1','','');
...
function cargar_cbo_doc(){
	...
	function filtros(){
		...
		doAjax('det_aux.php','&clasificacion=1&nomb_det='+valor+'&temp='+temp+'&tipomov='+tipomov+'&tienda='+tienda+'&criterio='+temp_criterio+'&prov_asoc='+document.formulario.prov_asoc.value+'&comboclasificacion='+comboclasificacion+'&categoria='+categoria+'&subcategoria='+subcategoria+'&moneda_doc='+moneda_doc,'detalle_prod','get','0','1','','');
	...
	function calculos_pretot(){
		...
		var total_precio="";	
		var precio=des_pres.substring(10);
		//alert(precio);
		var moneda_doc=document.formulario.tmoneda.value;
	...
	var pagina = self.location.href.match( /\/([^/]+)$/ )[1];
		...
		function cambiar_moneda_ini(){
			...
			doAjax('detalle_docOT.php','&incluidoigv='+document.formulario.incluidoigv.value+'&accion=cambiar_dolar&tmoneda='+document.formulario.tmoneda.value+'&mon_ini='+temp_mon+'&permiso4='+permiso4+'&permiso10='+permiso10+'&cargar_ref&impto='+impto+'&percep_suc='+percep_suc+'&percep_doc='+percep_doc+'&min_percep_doc='+min_percep_doc+'&est_percep_clie='+est_percep_clie+'&por_percep_clie='+por_percep_clie+'&total_doc='+total_doc+'&tipomov='+tipomov,'mostrar','get','0','1','','');
			}else{
				if(document.getElementById('moneda').innerHTML=='(S/.)'){
				temp_mon="01";
				}else{
...
function recalcular_precios(control,producto,e,precosto,mon_prod,pre_actual){
	...
	doAjax('detalle_docOT.php','&incluidoigv='+document.formulario.incluidoigv.value+'&accion=cambiar_dolar&tmoneda='+document.formulario.tmoneda.value+'&mon_ini='+temp_mon+'&permiso4='+permiso4+'&permiso10='+permiso10+'&precio_nuevo='+precio_nuevo+'&producto='+producto+'&cambiar_precio&impto='+impto+'&percep_suc='+percep_suc+'&percep_doc='+percep_doc+'&min_percep_doc='+min_percep_doc+'&est_percep_clie='+est_percep_clie+'&por_percep_clie='+por_percep_clie+'&total_doc='+total_doc+'&tipomov='+tipomov,'mostrar','get','0','1','','');
...
function aceptar_dim(){



if(document.formulario.largo.value=='' || document.formulario.ancho.value=='' || document.formulario.mt2.value==0 || document.formulario.factorOT.value==0 ){
alert("Uno de los campos esta vacio o tiene valor numerico igual a cero.");
return false;

}
document.formulario.tempDim.value="S";
salir();
...
function buscarFactorOT(e){

	if(e.keyCode==13){
	
	var largo=parseFloat(document.formulario.largo.value);
	var ancho=parseFloat(document.formulario.ancho.value);
	var cantidad=parseFloat(document.formulario.cantidad.value);
	
	var mt2=parseFloat(((largo*ancho*cantidad*1.05)/10000)).toFixed(4);
	document.formulario.mt2.value=mt2;
		
	var producto=document.formulario.codprod.value;
	
	doAjax('peticion_datos.php','&peticion=buscarFactorOT&mt2='+mt2+'&producto='+producto+'&cantidad='+cantidad+'&largo='+largo+'&ancho='+ancho,'rpta_buscarFactor','get','0','1','','');
		
	}
}

function rpta_buscarFactor(texto){

	//alert(texto);
	var temp_ot=texto.split("-");
		
	document.formulario.factorOT.value=temp_ot[0];
	document.formulario.preMinOT.value=temp_ot[1];
	document.formulario.desc1OT.value=temp_ot[2];
	document.formulario.desc2OT.value=temp_ot[3];
	
	document.formulario.SubmitOT.focus();
	document.formulario.SubmitOT.select();

}

function verDatosOT(producto){
doAjax('peticion_datos.php','&producto='+producto+'&peticion=verDatosOT','RptverDatosOT','get','0','1','','');
}

function RptverDatosOT(texto){
//alert(texto);
var temp=texto.split("-");

document.getElementById("dimensionesOT").style.visibility="visible";
document.formulario.ancho.value=temp[0];
document.formulario.largo.value=temp[1];
document.formulario.mt2.value=temp[2];
document.formulario.factorOT.value=temp[3];

document.formulario.SubmitOT.disabled=true;
}

function acepTotOT(){

	for(var i=0; i<document.formulario.radiototal1.length;i++){
		if(document.formulario.radiototal1[i].checked){
		document.formulario.descSelec.value=document.formulario.radiototal1[i].value;		
		}
	}
	salir();
	enviar();
