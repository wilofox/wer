...
session_start();
   ...
   if($_REQUEST['tipomov']==1){
	...
	//$titulo="Salidas - Ventas";
	  ...
	  $resulB = mysql_query("select * from operacion where codigo='HI' ",$cn); 
	  $rowB=mysql_fetch_array($resulB);
	  $usetrans=substr($rowB['p1'],12,1);
	  
	  $strSQLC="select * from docuser where tipomov='1' and doc ='HI' and usuario='".$_SESSION['codvendedor']."' ";
...
if (document.formulario.doc.value==''){
	alert('Falta asignar documento HI');
	return false;	
}
			...
			//alert(serie_ref);			
			var obs1=document.formulario.poliza.value;//document.formulario.obs1.value;
...
//alert(temp_doc+'//'+responsable+'//'+tipomov+'//'+tienda+'//'+condicion+'//'+femision+'//'+fvencimiento+'//'+monto+'//'+impuesto1+'//'+total_doc+'//'+incluidoigv+'//'+auxiliar+'//'+tmoneda+'//'+tcambio+'//'+sucursal+'//'+correlativo_ref+'//'+serie_ref+'//'+obs1+'//'+obs2+'//'+obs3+'//'+obs4+'//'+obs5+'//'+cod_cab_ref+'//'+kardex_doc+'//'+act_kardex_doc+'//'+doc+'//'+serie+'//'+numero+'//'+auxiliar+'//'+impto+'//'+transportista+'//'+chofer+'//'+nom_chofer+'//'+percepcion+'//'+porcen_percep+'//'+dirPartida+'//'+dirDestino+'//'+prms_doc_stock);
			  
doAjax('peticion_datos.php','&temp_doc='+temp_doc+'&responsable='+responsable+'&tipomov='+tipomov+'&tienda='+tienda+'&condicion='+condicion+'&femision='+femision+'&fvencimiento='+fvencimiento+'&monto='+monto+'&impuesto1='+impuesto1+'&total_doc='+total_doc+'&incluidoigv='+incluidoigv+'&auxiliar='+auxiliar+'&tmoneda='+tmoneda+'&tcambio='+tcambio+'&peticion=save_importacion'+'&sucursal='+sucursal+'&correlativo_ref='+correlativo_ref+'&serie_ref='+serie_ref+'&obs1='+obs1+'&obs2='+obs2+'&obs3='+obs3+'&obs4='+obs4+'&obs5='+obs5+'&cod_cab_ref='+cod_cab_ref+'&kardex_doc='+kardex_doc+'&act_kardex_doc='+act_kardex_doc+'&doc='+doc+'&serie='+serie+'&numero='+numero+'&auxiliar='+auxiliar+'&impto='+impto+'&transportista='+transportista+'&chofer='+chofer+'&nom_chofer='+nom_chofer+'&percepcion='+percepcion+'&porcen_percep='+porcen_percep+'&dirPartida='+dirPartida+'&dirDestino='+dirDestino+'&pds='+prms_doc_stock,'mostrar_grabacion','get','0','1','','');			
		      }						
			}else{
...
jQuery(document).bind('keyup', 'return',function (evt){jQuery('#_return').addClass('dirty'); 
	...
	///-------------------	
		document.formulario.clasificacion.style.visibility="";
		document.formulario.categoria.style.visibility="";
		document.formulario.subcategoria.style.visibility="";
...
if (document.formulario.doc.value=='0'){
	alert('Falta asignar documento "HI" al usuario..');
	location.href = '../modulos_usuarios/docxuser.php';
	return false;	
}
...
function enfoque2(e,ceros,control){	
	 if(e.keyCode==13 ){
	 	//alert(control.name);
		if(control.name=="poliza"){
			//condicion
		document.formulario.poliza.disabled=true;	
		document.formulario.codprod.disabled=false;
		document.formulario.codprod.focus();
		}
		if(control.name=="termino"){
		document.formulario.clasificacion.focus();
		}
		if(control.name=="clasificacion"){
		document.formulario.categoria.focus();
		}
		if(control.name=="categoria"){
		document.formulario.subcategoria.focus();
		}
		if(control.name=="subcategoria"){
		document.formulario.cantidad.focus();
		}
...
function cambiar_enfoque(control){
		...
		var tipomov=document.formulario.tipomov.value;
			...
			if(control.name=="responsable"){
				//condicion
			document.formulario.poliza.disabled=false;
			document.formulario.poliza.focus();
			document.formulario.responsable.disabled=true;			
			}
...
document.getElementById('num_doc').innerHTML='Nº '+document.formulario.num_serie.value+' - '+document.formulario.num_correlativo.value;
		  /*document.formulario.num_correlativo.focus();
	      document.formulario.num_correlativo.select();*/
		 // cbo_cond();
		 // tem doc yedem
...
<form id="formulario" name="formulario" method="post" action="">
  <table width="790" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr style="background:url(../imagenes/white-top-bottom.gif)">
       <td height="27" colspan="13" style="border:#999999">&nbsp;<span class="Estilo34">Generador de Productos de Importacion  :: <span class="Estilo14 Estilo38"><?php echo $titulo?>
    ...
    <tr style="background:url(../imagenes/botones.gif)" >
      ...
      <td colspan="7"><table width="98%" height="21" border="0" cellpadding="0" cellspacing="0" style="border-bottom:#CCCCCC solid 1px">
        <tr>
          ...
          <td width="99">
		  <table style="visibility:hidden" title="Incl./no Incl.[F9]" width="70" height="21" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td colspan="7" rowspan="2" align="left" valign="top"><table width="765" border="0" cellpadding="0" cellspacing="0">
        <tr>
		  ...
		  ?></span></td>
          <td width="187">
		  <input name="num_serie" type="hidden" value="<?=$Serie;?>" size="3" >
          ...
          </span><img style="cursor:pointer; visibility:hidden" onClick="ver_clientes()" src="../imagenes/ico_lupa.jpg" width="15" height="15"></td>
          <td width="54" class="Estilo14">F.Emisi&oacute;n</td>
          <td width="173"><input name="femi" type="text" size="10" maxlength="10" value="<?php echo date('d-m-Y')?>"  onKeyUp="generar_ceros(event,'0',this)"  onChange="enfocar_fecha(this)" onBlur="sumarFechaVen(document.formulario.condicion)" disabled >
    ...
    Calendar.setup({
          ...
          <td width="159" rowspan="2"><table width="159" height="44" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="150" align="center"><fieldset>
                ...
                <div id="tipodoc2" style="display:block"><span class="Estilo1 Estilo35"><span class="Estilo44"> HI-COMPRAS <br> 
        ...
        <tr>
          ...
          <td><span class="Estilo15">
		   ...
		   <select name="responsable" style="width:120"  onChange=""  onFocus="enfocar_cbo(this);limpiar_enfoque(this);cbo_cond();"  disabled>
		  <?php 
			$marcar="";
          ...
          <td class="Estilo14">Nº Poliza Referencia</td>
          <td>
            <input name="poliza" type="text" id="poliza" onKeyUp="enfoque2(event,'0',this)" size="15"  >			
			</td>
    ...
    Calendar.setup({
		...
		<button  id="btn_transp" type="button" title="Cambiar transportista" style="height:18; vertical-align:top" onClick="cambiar_chofer('T')" >...</button>		</td>
          <td class="Estilo14"><div id="cbo_cond" style="visibility:hidden">
           <select name="condicion" style="width:0" onChange=""  onFocus="enfocar_cbo(this);limpiar_enfoque(this);"  >
              <?php 
			$marcar="";
		    //$resultados11 = mysql_query("select * from condicion order by codigo ",$cn); 
			$strSQLD="select * from detope where documento='HI' order by condicion";	
    ...
    <tr>
      ...
      <td colspan="7"><table width="766" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="218"><span class="Estilo14">Cod. Anexo: Producto:</span></td>
          <td width="143"><span class="Estilo14">Clasificaci&oacute;n:</span></td>
          <td width="11">&nbsp;</td>
          <td width="66"><span class="Estilo14">Cant.:</span></td>
          <td width="11">&nbsp;</td>
          <td width="66"><span class="Estilo14" title="precio de costo">P.Unit:</span></td>
          <td width="10">&nbsp;</td>
        ...
        <tr>
          <td>
		<!-- validartecla(event,this,'productos')
		 filtroanexo(event,this,'productos')
		 -->
		<input autocomplete="off"  name="codprod"  type="text" size="10"  onKeyUp="filtroanexo(event,this,'productos')" onFocus="activar2;"  />
		<span class="Estilo15">
            <input name="pro" type="hidden" size="3"  value="0"/>
              </span><span class="Estilo14">
			  <!--onKeyUp="activar(event)"--> 
            <input name="termino" type="text" size="20" onFocus="validarDoc('anexo');activar(event);" onKeyUp="enfoque2(event,'0',this)">
			 <div id="cbo_uni" >
			 <input name="presentacion" type="hidden" value="07"/>
			</div>
			
            <span class="Estilo15"> </span></span></td>
          <td><span class="Estilo14"><span class="Estilo15">          
			<div id="clasificacion">
			  <select name="clasificacion" style="width:140px"  id="select" onkeyup="enfoque2(event,'0',this)">
                <option value="000">-|Clasificaci&oacute;n|-</option>
				<?php 
	$resultados11 = mysql_query("select * from clasificacion order by des_clas ",$cn); 
	while($row11=mysql_fetch_array($resultados11)){					
		  ?>
                <option value="<?php echo $row11['idclasificacion']?>"><?php echo $row11['des_clas'];?></option>
                <?php 
			  }
			  ?>
              </select>
			  <select name="categoria" style="width:140px"  id="categoria" onKeyUp="enfoque2(event,'0',this)">
			  <option value="000">-|Categoria|-</option>
			<?php 
	$resultados11 = mysql_query("select * from categoria order by des_cat ",$cn); 
	while($row11=mysql_fetch_array($resultados11)){					
		  ?>
                <option value="<?php echo $row11['idCategoria']?>"><?php echo $row11['des_cat'];?></option>
                <?php 
			  }
			  ?>
			</select>
			<select name="subcategoria" style="width:140px"  id="subcategoria" onKeyUp="enfoque2(event,'0',this)">
			<option value="000">-|SubCategoria|-</option>
			<?php 
	$resultados11 = mysql_query("select * from subcategoria order by des_subcateg ",$cn); 
	while($row11=mysql_fetch_array($resultados11)){					
		  ?>
                <option value="<?php echo $row11['idsubcategoria']?>"><?php echo $row11['des_subcateg'];?></option>
                <?php 
			  }
			  ?>
			</select>
          ...
          <input style="text-align:right" name="cantidad2" id="cantidad2"  type="text" size="8" onKeyUp="calc_pre_total()" />
          <!--doAjax('../calcular_precio.php','','mostrar_precio','get','0','1','','');-->
          <?php }else{?>
          <input style=" text-align:right" name="cantidad" id="cantidad"  type="text" size="8" onKeyUp="cambiar_foco(event);calcular_ptotal()" onFocus="validarDoc('producto');" />
          <?php } ?>
          </span></td>
          <td>&nbsp;</td>
          <td><span class="Estilo14">
            <input  name="punit" type="text" size="8" style=" text-align:right" onKeyUp="calcular_ptotal()" onFocus="validarDoc('anexo');"  />
          </span></td>
          <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td colspan="7">
	  <div id="resultado">
	    <table width="715" border="0" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
          <tr>
            <td width="47" rowspan="2" align="center" bgcolor="#3366CC"><span class="Estilo31">Cod.Anexo</span></td>
            <td width="296" rowspan="2" bgcolor="#3366CC"><span class="Estilo31">Descripci&oacute;n</span></td>
            <td width="73" rowspan="2" align="center" bgcolor="#3366CC"><span class="Estilo31">UND</span></td>
            <td height="18" colspan="3" align="center" bgcolor="#3366CC"><span class="Estilo31">Clasificaci&oacute;n</span></td>
            <td width="51" rowspan="2" align="center" bgcolor="#3366CC"><span class="Estilo31">Cant.</span></td>
            <td width="71" rowspan="2" bgcolor="#3366CC"><span class="Estilo32"><span class="Estilo31">P. Unit.</span></span></td>
            <td width="65" rowspan="2" bgcolor="#3366CC"><span class="Estilo31">Total</span></td>
            <td width="52" rowspan="2" align="center" bgcolor="#3366CC"><span class="Estilo31">Notas</span></td>
            <td width="44" rowspan="2" align="center" bgcolor="#3366CC"><span class="Estilo31">E</span></td>
          </tr>
          <tr>
            <td width="51" height="18" align="center" bgcolor="#3366CC"><span class="Estilo31">Clas.</span></td>
            <td width="51" align="center" bgcolor="#3366CC"><span class="Estilo31">Cat.</span></td>
            <td width="51" align="center" bgcolor="#3366CC"><span class="Estilo31">Scat.</span></td>
            </tr>
          ...
          <tr style="font:Verdana, Arial, Helvetica, sans-serif; font-size:12px">
            ...
            <td colspan="5" bgcolor="#FFFFFF">SubTotal</td>
          ...
          <tr style="font:Verdana, Arial, Helvetica, sans-serif; font-size:12px">
            ...
            <td bgcolor="#FFFFFF"><label style="color:#FF0000" id="moneda"><?php echo "(US$.)" ?></label></td>
            <td align="right" bgcolor="#FFFFFF">&nbsp;</td>
            <td colspan="5" bgcolor="#FFFFFF"><table width="115" border="0" cellpadding="0" cellspacing="0">
              <tr>
          ...
          <tr style="font:Verdana, Arial, Helvetica, sans-serif; font-size:12px">
            ...
            <td bgcolor="#FFFFFF"></td>
            <td align="right" bgcolor="#FFFFFF">&nbsp;</td>
            <td colspan="5" bgcolor="#FFFFFF"><span class="Estilo111" style="font:Arial, Helvetica, sans-serif; font-size:11px; font:bold">TOTAL DOC </span></td>
  ...
  <tr>
	...
	<table width="413" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr style="background:url(../imagenes/bg_contentbase2.gif) 100% 70%">
        ...
        <td colspan="2"><span class="text5 Estilo116"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><strong>Nuevo Proveedor</strong></font></span></td>
        <td colspan="2">&nbsp;</td>
      </tr>
...
function enviar(){
	...
	if(document.formulario.serie_ing.value=="" && document.formulario.series.value=='S' && permiso10=='S' && prms_doc_stock=='S'){ //Rk Maneja stock las serie
	...
	var subcategoria=document.formulario.subcategoria.value;	

//esserie  impto  percep_suc  percep_doc  min_percep_doc  est_percep_clie   por_percep_clie
   
	doAjax('detalle_docImportacion.php','&incluidoigv='+document.formulario.incluidoigv.value+'&punitario='+punit+'&tmoneda='+document.formulario.tmoneda.value+'&mon_ini='+temp_mon+'&permiso4='+permiso4+'&notas='+notas+'&presentacion='+presentacion+'&esserie='+esserie+'&permiso10='+permiso10+'&cargar_ref=noref&precosto='+precosto+'&impto='+impto+'&percep_suc='+percep_suc+'&percep_doc='+percep_doc+'&min_percep_doc='+min_percep_doc+'&est_percep_clie='+est_percep_clie+'&por_percep_clie='+por_percep_clie+'&total_doc='+total_doc+'&tipomov='+tipomov+'&codAnexProd='+codAnexProd+'&termino='+termino+'&clasificacion='+clasificacion+'&categoria='+categoria+'&subcategoria='+subcategoria,'mostrar','get','0','1','','');
...
//alert(temp);
	...
	doAjax('detalle_docImportacion.php','&incluidoigv='+document.formulario.incluidoigv.value+'&punitario='+document.formulario.punit.value+'&accion=mostrarprod&estado='+estado+'&permiso4='+permiso4+'&tmoneda2='+tmoneda+'&permiso10='+permiso10+'&impto='+impto+'&percep_suc='+percep_suc+'&percep_doc='+percep_doc+'&min_percep_doc='+min_percep_doc+'&est_percep_clie='+est_percep_clie+'&por_percep_clie='+por_percep_clie+'&total_doc='+total_doc+'&percep_recp='+percep_recp+'&tipomov='+tipomov,'mostrar','get','0','1','','');
...
function validarDoc(obj){
 	if(document.formulario.codprod.value.length<4 && obj=='anexo' ){
		alert('Código anexo minimo 4 caracteres...');
		document.formulario.codprod.focus();	
		return false;
	}
	if(document.formulario.termino.value.length<2 && obj=='producto' ){
...
function filtroanexo(e,valor,temp){

if (document.formulario.impto.value==''){
	alert('Llene datos el Documento');
	document.formulario.auxiliar.focus();	
	return false;
}
...
return false;
	...
	document.formulario.codAnexProd.value='';	
	document.formulario.termino.value='';
	document.formulario.clasificacion.value='000';
	document.formulario.categoria.value='000';
	document.formulario.subcategoria.value='000';
	document.formulario.punit.value='';
	
		campo=valor.value;
		doAjax('peticion_datos.php','&peticion=anexo_datos&campo='+campo,'valorAnexo','get','0','1','','');
	}
	

}
function valorAnexo(texto){
var r = texto.split('|');
...
return false;
	...
	//alert(r[0]);	
//	var answer = confirm ("Producto ya registrado desea llamarlo?")
//if (answer){

	document.formulario.pro.value=r[0];
	document.formulario.codAnexProd.value=r[1];	
	document.formulario.termino.value=r[2];
	document.formulario.clasificacion.value=r[3];
	document.formulario.categoria.value=r[4];
	document.formulario.subcategoria.value=r[5];
	document.formulario.presentacion.value=r[6];
	document.formulario.punit.value=r[7];
...
function validartecla(e,valor,temp){
	...
	document.formulario.clasificacion.style.visibility="hidden";
	document.formulario.categoria.style.visibility="hidden";
	document.formulario.subcategoria.style.visibility="hidden";
...
function eliminar(codigo){
	...
	doAjax('detalle_docImportacion.php','&incluidoigv='+document.formulario.incluidoigv.value+'&cod_delete='+codigo+'&tmoneda='+document.formulario.tmoneda.value+'&mon_ini='+temp_mon+'&permiso4='+permiso4+'&tienda='+tienda+'&permiso10='+permiso10+'&cargar_ref&impto='+impto+'&tipomov='+tipomov,'mostrar','get','0','1',codigo,'eliminar');
	}
}
...
///	document.formulario.prueba.value=temp[2];
	...
	doAjax('detalle_docImportacion.php','&incluidoigv='+document.formulario.incluidoigv.value+'&tmoneda='+document.formulario.tmoneda.value+'&mon_ini='+temp_mon+'&permiso4='+permiso4+'&permiso10='+permiso10+'&cargar_ref=ref'+'&accion=mostrarprod&impto='+impto+'&percep_suc='+percep_suc+'&percep_doc='+percep_doc+'&min_percep_doc='+min_percep_doc+'&est_percep_clie='+est_percep_clie+'&por_percep_clie='+por_percep_clie+'&total_doc='+total_doc+'&tipomov='+tipomov,'mostrar','get','0','1','','');
...
doAjax('sub_unidad.php','&codp='+document.formulario.codprod.value+'&facp='+document.formulario.factor_p.value+'&fac1='+document.formulario.presentacion.value+'&saldo='+saldo+'&cant='+cant,'CountSubUnidad','get','0','1','','');
	...
	*/
	...
	//
		...
		//alert();
		objeto.cells[0].childNodes[0].checked=true;
		document.formulario.cod_aux_sel.value=objeto.cells[1].childNodes[0].innerHTML;
		document.formulario.nom_aux_sel.value=objeto.cells[2].childNodes[0].innerHTML;
		document.formulario.ruc_aux_sel.value=objeto.cells[3].childNodes[0].innerHTML;
		document.formulario.dir_aux_sel.value=objeto.cells[1].childNodes[0].innerHTML;
	...
	var pagina = self.location.href.match( /\/([^/]+)$/ )[1];
		...
		function cambiar_moneda_ini(){
			...
			doAjax('detalle_docImportacion.php','&incluidoigv='+document.formulario.incluidoigv.value+'&accion=cambiar_dolar&tmoneda='+document.formulario.tmoneda.value+'&mon_ini='+temp_mon+'&permiso4='+permiso4+'&permiso10='+permiso10+'&cargar_ref&impto='+impto+'&percep_suc='+percep_suc+'&percep_doc='+percep_doc+'&min_percep_doc='+min_percep_doc+'&est_percep_clie='+est_percep_clie+'&por_percep_clie='+por_percep_clie+'&total_doc='+total_doc+'&tipomov='+tipomov,'mostrar','get','0','1','','');
			}else{
				if(document.getElementById('moneda').innerHTML=='(S/.)'){
				temp_mon="01";
				}else{
...
salir();
	...
	var randomnumber=Math.floor(Math.random()*99999);
	Modalbox.show('../lista_auxiliar.php?ran='+randomnumber+'&buton=sel_aux&tipomov=1', {title: 'Lista de Auxiliares( PROVEEDOR )', width: 500});return false; 
}
function filtrar(){	
...
function cargar(){
		...
		try{
			...
			document.formulario.cod_aux_sel.value=document.getElementById('lista_aux').rows[0].cells[1].childNodes[0].innerHTML;
		 } catch(e) { }
		 
}
function sel_aux(){
	document.formulario.auxiliar.value=document.formulario.nom_aux_sel.value;
	document.formulario.auxiliar2.value=document.formulario.cod_aux_sel.value;
	Modalbox.hide();
	//alert();
	//CliFocus();
...
function rspta_aux(texto){
	document.formulario.auxiliar.value=document.formulario.aux_razon.value;
	document.formulario.auxiliar2.value=document.formulario.codClie.value;
