...
$temopCONT=0;
  ...
  //--------------------------------------------------------------------------------------------------
		...
		$strSQL2="select idproducto,p.* from producto p ,clasificacion ,categoria ,subcategoria where p.clasificacion=idclasificacion and p.categoria=idcategoria and p.subcategoria=idsubcategoria  group by nombre,idproducto order by idproducto,nombre ";
			//echo $strSQL;
			$j=0;
...
<table width="725" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border:#999999 solid 0px" >
  <tr>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:#999999 solid 0px">
      ...
      <tr>
        <td colspan="3"><span class="Estilo19">Sucursal: <?php
...
<?php 
	...
	$strSQL="select ".$filtro2.",idproducto,nombre, p.* from producto p ,clasificacion ,categoria ,subcategoria where ".$filtro3." ".$filtro1." ".$filtro_incluir.$filtro4." and p.idproducto in('".trim($prod2)."') group by nombre,idproducto order by  ".$filtro_ordenar." ";	
 ...
 // $_SESSION['totgr']+=$total;
  ...
  <?php } ?>
	...
	//$strSQLx ="select idproducto,nombre,precio,costo_inven1,moneda,($col)as total  from producto p ,clasificacion ,categoria ,subcategoria where ".$filtro3." ".$filtro1." ".$filtro_incluir." ";
			$strSQLx="select ".$filtro2.",idproducto,nombre,precio,costo_inven1,p.moneda,($col)as total from producto p ,clasificacion ,categoria ,subcategoria where ".$filtro3." ".$filtro1." ".$filtro_incluir."  group by nombre,idproducto order by des_clas asc,des_cat asc,des_subcateg asc, ".$filtro_ordenar." ";	
