	  ...
	  <tr>
	    <td align="center"><table id="tbl_series" width="295" border="0" cellpadding="1" cellspacing="1">
	      <tr style="background:url(../imagenes/bg_contentbase2.gif); background-position:100px 60px" >
	        ...
	        <td width="248" align="center" style="font:Arial, Helvetica, sans-serif; font-size:11px; color:#FFFFFF"><strong>Producto</strong></td>
          </tr>
          
          <?php 
		  
		  $strSQL='select * from producto order by nombre limit 20';
		  ...
		  $tepmSer=(caracteres(str_replace("’","&#8217;",$row['nombre'])));
		// $tepmSer=((($row['serie2'])));
