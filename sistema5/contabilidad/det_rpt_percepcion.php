...
//--fin rk
	...
	//echo $filtrodocs2;
	 ...
	 $strSQL="select cm.*,co.nombre as nomcondi,c.razonsocial as razon,c.ruc as nruc,c.doc_iden as ndni, o.descripcion as desDoc,cm.fecha as fechaDoc, c.codcliente as codcliente from cab_mov cm, cliente c, operacion o,
	...
	and co.codigo in ('".$filtrodocs2."')
	 ...
	 and flag_r<>'RA' and flag<>'A' and cm.percepcion > 0 order by $filtro_orden  ";	
	...
	while($rowreporte=mysql_fetch_array($resultadoreporte)){ 
	 ...
	 ?>
      <tr >
		...
		?></span></td>
        <td  style="background:<?php echo $colorTD?>" align="left" bgcolor="#FFFFFF">&nbsp;</td>
        ...
        <td  style="background:<?php echo $colorTD?>" align="center" bgcolor="#FFFFFF"><span class="Estilo54"><?php echo $porcen_percep; ?></span></td>
        <td  style="background:<?php echo $colorTD?>" align="right" bgcolor="#FFFFFF"><span class="Estilo54"><?php echo number_format($imp_percepcion,2); ?></span></td>
        <td  style="background:<?php echo $colorTD?>" align="right" bgcolor="#FFFFFF"><span class="Estilo54"><?php echo number_format($montoTrans+$imp_percepcion,2); ?></span></td>
...
if($total_paginas==$pagina || $_REQUEST['excel']=="S"){
 ...
 $strSQL="select cm.*,co.nombre as nomcondi,c.razonsocial as razon,c.ruc as nruc, o.descripcion as desDoc,cm.fecha as fechaDoc, c.codcliente as codcliente from cab_mov cm, cliente c, operacion o,
      condicion co  where cm.cod_ope = o.codigo
	AND cm.condicion=co.codigo 
    AND cm.cliente = c.codcliente     
	and co.codigo in ('".$filtrodocs2."')
...
//---------------------------------------------------------------------------------------	 
 ...
 ?>
  ...
  <tr style='color:#000000;font-size:12px;font-family:Arial, Helvetica, sans-serif'>
        ...
        <td  style="font-weight: bold" align="right" bgcolor="#DDDDDD"><?php echo number_format($montoTransT,2)?></td>
        ...
        <td  style="font-weight: bold" align="right" bgcolor="#DDDDDD"><?php echo number_format($totalGeneral,2)?></td>
