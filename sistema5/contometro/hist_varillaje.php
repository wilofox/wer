...
if(isset($_REQUEST['accion'])){
 ...
 $accion=$_REQUEST['accion'];
	 ...
	 if($accion=='n'){
		$clase->new_hisvarillaje($id,$fecha,$c_usuario,$pc,$c_tanque,$contometro,$R,$L,$G);
	}
	if($accion=='e'){
		$clase->act_hisvarillaje($id,$fecha,$c_tanque,$contometro,$R,$L,$G);
	}
	if($accion=='el' && isset($_REQUEST['codigo'])){
		$clase->elim_hisvarillaje($_REQUEST['codigo']);
	}
...
event.keyCode=0;
	event.returnValue=false;
//	alert("m");
 doAjax('new_hisvarillaje.php','accion=n','nuevo_suc','get','0','1','','');
...
<?php
  ...
  <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC" >
       ...
       <td height="27" colspan="13" style="border:#999999"><span class="Estilo34">Grifo :: <span class="Estilo14 Estilo38">Historial de Varillaje </span></span></td>
    </tr>
    <tr>
        ...
        <tr>
		  ...
		  //obj.cells[3].style.backgroundImage="";
		      ...
		      <table title="Nuevo[F3]" width="80" height="21" border="0" cellpadding="0" cellspacing="0">
                <tr onMouseOver="entrar_btn(this);" onMouseOut="salir_btn(this)" style="cursor:pointer" onClick="javascript: doAjax('new_hisvarillaje.php','accion=n','nuevo_suc','get','0','1','','');" >
                  <td width="1" ></td>
		...
		//	alert(tab11);
          ...
          <tr>
            ...
            <td><select name="tipo" id="tipo">
              ...
              <option value="nom_tanq" selected >Tanque</option>
              </select></td>
...
<table width="178" height="27" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="91%">
			  <fieldset>
            ...
            <table width="109%" height="31" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="32%" height="15" align="center"><table style="border:#999999 solid 1px"  width="25" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td  height="8" bgcolor="#CEF3FF"></td>
                    </tr>
                </table></td>
                <td width="68%"><span class="Estilo122">Productos  GLP </span></td>
              </tr>
              <tr>
...
doAjax('new_hisvarillaje.php','accion=e&cod='+cod,'nuevo_suc','get','0','1','','');
//}
}
function eliminar(cod){

	if(confirm('Esta seguro que desea eliminar ?')){
	location.href='hist_varillaje.php?accion=el&codigo='+cod;
	//this.form1.submit();
	}
...
function validar(){
	document.form1.elements[10].value=document.getElementById("RadioX").innerHTML;
	document.form1.elements[11].value=document.getElementById("LargoX").innerHTML;
	document.form1.elements[12].value=document.getElementById("GalonesX").innerHTML;
	
	cond=document.form1.elements[1].value;
	fecha=document.form1.elements[2].value;	
	tanque=document.form1.elements[7].value;
	contometraje=document.form1.elements[9].value;		
	...
	if(contometraje==""){
		alert("Ingrese valor de varillaje...");
		document.form1.elements[9].focus();
		return false;
	}	
	
/*	doAjax('lista_varillaje.php','ventana=vhc&condicion='+cond+'&fecha='+fecha+'&tanque='+tanque+'&contometraje='+contometraje,'validar_dato','get','0','1','','');
...
doAjax('lista_varillaje.php','ventana=hc&condicion='+cond+'&texto='+texto+'&fec1='+fec1+'&fec2='+fec2+'&tipo2='+tipo2+'&texto2='+texto2+'&pag='+pag,'view_det','get','0','1','','');
...
function tanqueSelec(texto){
cond=texto.value;
//alert(cond);
doAjax('lista_varillaje.php','ventana=mg&condicion='+cond,'view_mg','get','0','1','','');
}
...
function tipo_tanque(){
	cond=document.form1.elements[7].value;
	doAjax('lista_varillaje.php','ventana=ttv&condicion='+cond,'det_tipo_tanque','get','0','1','','');
	
}
function det_tipo_tanque(texto){
var r = texto.split('|');
//alert(r[0]);
document.getElementById('txttiptanque').innerHTML='Varillaje Altura(H)  : ';
if (r[0]=='GLP'){
	//document.form1.contometro.value=r[0];
	document.getElementById('txttiptanque').innerHTML='Volumen Actual   : ';
	document.getElementById('LargoX').innerHTML=r[0];
	
}
//document.getElementById('mancaje').innerHTML=r[0];
	//if (document.form1.accion.value=='n'){
		//document.form1.elements[10].value=r[0];	
		//document.form1.elements[11].value=r[1];	
	//}
