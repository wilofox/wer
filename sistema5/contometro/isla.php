...
//echo "entro";
 $accion=$_REQUEST['accion'];
	 ...
	 if($accion=='n'){
		$clase->new_isla($id,$nombre,$descripcion,$tienda,$sucursal);
	}

	if($accion=='e'){

		$clase->act_isla($id,$nombre,$descripcion,$tienda,$sucursal);
	}
	if($accion=='el' && isset($_REQUEST['codigo'])){
	//echo $_REQUEST['cod'];
		$clase->elim_isla($_REQUEST['codigo']);
	}
...
event.keyCode=0;
	event.returnValue=false;
//	alert("m");
 doAjax('new_isla.php','accion=n','nuevo_suc','get','0','1','','');
...
<?php
  ...
  <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC" >
       ...
       <td height="27" colspan="13" style="border:#999999"><span class="Estilo34">Mantenimientos :: <span class="Estilo14 Estilo38">Islas </span></span></td>
    </tr>
    <tr>
        ...
        <tr>
		  ...
		  //obj.cells[3].style.backgroundImage="";
		      ...
		      <table title="Nuevo[F3]" width="80" height="21" border="0" cellpadding="0" cellspacing="0">
                <tr onMouseOver="entrar_btn(this);" onMouseOut="salir_btn(this)" style="cursor:pointer" onClick="javascript: doAjax('new_isla.php','accion=n','nuevo_suc','get','0','1','','');" >
                  <td width="1" ></td>
      ...
      <td colspan="7"><form name="formbuscar" method="post" action="?" onSubmit="return false"><table width="329" border="0" align="center">
          <tr>
            ...
            <select name="tipo" id="tipo">
              ...
              <option value="nom_isl" selected>Nombre</option>
...
doAjax('new_isla.php','accion=e&cod='+cod,'nuevo_suc','get','0','1','','');
//}
}
function eliminar(cod){

	if(confirm('Esta seguro que desea eliminar ?')){
	location.href='isla.php?accion=el&codigo='+cod;
	//this.form1.submit();
	}
...
doAjax('lista_isla.php','condicion='+cond+'&texto='+texto+'&pag='+pag,'view_det','get','0','1','','');
