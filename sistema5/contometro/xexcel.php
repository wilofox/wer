  ...
  <td   width="80" align="center" style=" border:#CCCCCC solid 1px" class="EstiloTexto1">Importe</td>	
	...
	$i++;
	 echo '<tr bgcolor="#FFFFFF">
		  ...
		  $IT+=$Impor;
		   echo '
		   <td width="80" align="right"><span class="Estilo12">'.$row2X['cont_fin'].'</span></td>
...
,max(capacidad) as capacidad from hist_varillaje HC inner join tanques T on HC.cod_tanque=T.id 
 where  cod_tanque in (
...
<tr height="20px" style="background:url(../imagenes/sky_blue_grid.gif); border:#999999 solid 1px">
  ...
  <td   width="70"  align="center" style=" border:#CCCCCC solid 1px" class="EstiloTexto1" >Fecha</td>
  ...
  <td   width="70" align="center" style=" border:#CCCCCC solid 1px" class="EstiloTexto1">Nivel</td>
	...
	$i++;
	 echo '<tr bgcolor="#FFFFFF">
		   ...
		   <td width="70"><span class="Estilo12">'.formatofecha(substr($row2['fecha_his'],0,10)).'</span></td>
		   <td width="80"><span class="Estilo12">'.$row2['nom_tanq'].'</span></td>	
		   <td width="70" align="right"><span class="Estilo12">'.$row2['cantidad'].'</span></td>';		 
		  ...
		  $resultado4=mysql_query($strSQL1);
 		  $row2X=mysql_fetch_array($resultado4); 		
			...
			$capGalon='<img src="http://www.grifoscopa.com/prolyamrp/contometro/img/'.$imgG.'" width="68" height="25" alt="'.$altcapGalon.'"  />';
			
		   echo '<td width="70" align="right"><span class="Estilo12">'.number_format($Formula,2).'</span></td>
