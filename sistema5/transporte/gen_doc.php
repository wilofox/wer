...
doAjax('det_producto.php','&filtro='+filtro+'&criterio='+criterio+'&ordenar='+ordenar+'&orden='+orden+'&pagina='+pagina,'cargar_detalle2','get','0','1','','');
}	
    ...
    <tr style="background:url(../imagenes/botones.gif)" >
      ...
      <td colspan="7"><table width="97%" height="21" border="0" cellpadding="0" cellspacing="0" style="border-bottom:#CCCCCC solid 1px">
        <tr>
          ...
          <td width="72" ><table title="Grabar [F2]" width="80" height="21" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
		  ...
		  <fieldset style="padding-left:8px; padding-top:5px; padding-bottom:5px; ">
                <span class="Estilo34">Placa :</span>
				 <span class="text3" style="color:#000000"><?=$placa;?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				 <span class="Estilo34">Veh&iacute;culo :</span>
				 <span class="text3"  style="color:#000000"><?=$vehiculo;?></span>
                               
              <div id="tipodoc2" style="display:block"><table width="200" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="115"><span class="Estilo1 Estilo35"><span class="Estilo44">Puntos Acumulados : </span></span></td>
    <td width="85"><span class="Estilo1 Estilo35"><span class="Estilo44">
    ...
    <tr>
      ...
      <td colspan="7">
	    ...
	    <table width="350" border="0" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
          <tr>
            <td width="24" align="center" bgcolor="#3366CC">&nbsp;</td>
            <td width="46" align="center" bgcolor="#3366CC"><span class="Estilo31">C&oacute;digo</span></td>
            <td width="47" height="18" align="center" bgcolor="#3366CC"><span class="Estilo31">Anexo</span></td>
            <td width="121" bgcolor="#3366CC"><span class="Estilo31">Descripci&oacute;n</span></td>
            <td width="45" align="center" bgcolor="#3366CC"><span class="Estilo31">Punto</span></td>
...
<DIV id=modal style="BORDER-RIGHT: white 3px solid;  BORDER-TOP: white 3px solid; DISPLAY: none;   BORDER-LEFT: white 3px solid;  BORDER-BOTTOM: white 3px solid; BACKGROUND-COLOR:#003366; "> 
  ...
  <div id="importar_excel" style="position:absolute; left:381px; top:179px; width:237px; height:58px; z-index:1;">
    <table width="90%" height="27" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="93%"><fieldset>
          <legend>Estado de Canje:</legend>
          <table width="182" height="120" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="15" colspan="2" ><b>Producto :</b> <br>
