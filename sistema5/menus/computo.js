...
//	["|Proyectos","","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , ventaxref, "0", , , ],
	...
	*/
    ...
    ["Log&iacute;stica","","imgenes/icon1.gif","imgenes/icon1o.gif", , , "0", , , ],
		...
		/*-------------------------------control de series-------------------------------------------
		*/
		["|Control de Series","","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , , "0", , , ],
		 ["||Inventario F&iacute;sico de Series","compras/inv_valorizado_serien.php?menu_temp=1", "imgenes/icon5.gif", "imgenes/icon5o.gif", "",  , transferencia , , , ],
		...
		*/		
		...
		["|Compras por Proveedor","reportes/comprovee.php?tipo=1","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , redocC, "0", , , ],
	       ...
	       ["Finanzas","","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , , "0", , , ],
            ["|Cr&eacute;ditos y Cobranzas","", "imgenes/icon5.gif", "imgenes/icon5.gif", ,cuentasCC , , , , ],
				["||Cobranza Cuentas Cliente","Finanzas/cuentaCorrienteN.php?tipo=2", "imgenes/icon5.gif", "imgenes/icon5.gif", ,cuentasCC , , , , ],
				["||Estado Cta. Cte. Cliente","Finanzas/Estado_Cta_Cte.php?tipo=2", "imgenes/icon5.gif", "imgenes/icon5.gif", , cuentasC, , , , ],
				["||Documentos Pendientes Clientes","Finanzas/reportect1.php?tipo=2", "imgenes/icon5.gif", "imgenes/icon5.gif", , cuentasC, , , , ],
				["||Cr&eacute;ditos por Cliente","reportes/rpt_creditoxcliente.php","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , ,cuentasC , "0", , , ],	
				["||Planilla de Cobranzas","reportes/rpt_planilla_cobranzas.php", "imgenes/icon5.gif", "imgenes/icon5.gif", ,cuentasC , , , , ],
