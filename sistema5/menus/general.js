...
*/
	/*
	 ["|Facturaci&oacute;n por Referencia de Pedidos ","","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , ventaxref, "0", , , ],
		...
		["||Seguimiento de Multifacturador","ventas/genDocSegMiltifac.php", "imgenes/icon5.gif", "imgenes/icon5o.gif", , , , , , ],
	 ...
	 ["|Ventas - Multifacturaci&oacute;n","","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , ventaxref, "0", , , ],
		["||Punto de Venta Vendedor","compras/gen_docVendedor.php?tipomov=2", "imgenes/icon5.gif", "imgenes/icon5o.gif", , puntven , , , , ],
		["||Caja - Multifacturaci&oacute;n","ventas/genDocMiltifactura.php", "imgenes/icon5.gif", "imgenes/icon5o.gif", ,cajamult , , , , ],
		["||Caja - Cr&eacute;ditos","ventas/genDocSegMiltifac.php", "imgenes/icon5.gif", "imgenes/icon5o.gif", ,cajacred  , , , , ],
		["||Listado Planilla de Cobranza","", "imgenes/icon5.gif", "imgenes/icon5o.gif", , , , , , ],
		["||Opci&oacute;n de Cierre ''X'' y Cierre ''Z'' ","", "imgenes/icon5.gif", "imgenes/icon5o.gif", , , , , , ],
		["||Listado Planilla por D&iacute;as ","", "imgenes/icon5.gif", "imgenes/icon5o.gif", , , , , , ],	
...
*/	
	...
	*/
	["|Servicio T&#233;cnico Y Garant&#237;a","","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , servTecGar, "0", , , ],
		["||&Oacute;rdenes Pendientes de Entrega","serv_tg/genDoc.php","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , , "0", , , ],
		["||Seguimiento de Art&iacute;culos Entregados","serv_tg/genDocSeg.php","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , , "0", , , ],
		...
		*/
		...
		["|Proyectos","","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , ventas, "0", , , ],
	
		["||Mantenimiento de Tablas ","administracion/m_costo.php", "imgenes/icon5.gif", "imgenes/icon5.gif", , centroCosto, , , , ],
		
			["|||Tipo de Negocio ","administracion/m_area_costo.php", "imgenes/icon5.gif", "imgenes/icon5.gif", , centroCosto, , , , ],
			["|||Actividades de Obra ","administracion/procesos.php", "imgenes/icon5.gif", "imgenes/icon5.gif", , centroCosto, , , , ],
			["|||Centro Costo ","administracion/m_costo.php", "imgenes/icon5.gif", "imgenes/icon5.gif", , centroCosto, , , , ],
			["|||Costos Operativo","administracion/cOperativo.php", "imgenes/icon5.gif", "imgenes/icon5.gif", ,, , , , ],
			["|||Factores Utilidad","administracion/factUtil.php", "imgenes/icon5.gif", "imgenes/icon5.gif", ,, , , , ],
	
	//-------------------------------------Presuppuestos----------------------------------------------------
	/**/
	
	
		["||Presupuestos de Obras","","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , centroCosto, "0", , , ],
	...
	["||&Oacute;rdenes de Trabajo","","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , inventarios, "0", , , ],
		
		
		["|||Generador de &Oacute;rdenes Trabajo","ordenTrabajo/genOT.php?tipomov=2","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , centroCosto, "0", , , ],
   	//["||Generador de Ordenes Trabajo","compras/ordenT.php?tipomov=2","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , transferencia, "0", , , ],
		...
		["|||Seguimiento de O.T.","ventas/genDocRefOT2.php?docRef=OT","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , transferencia, "0", , , ],
		["|||Seguimiento de Entregas","ventas/genDocRefSM.php","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , transferencia, "0", , , ],
		["|||Seguimiento de Gastos","ventas/segimientoGastos.php","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , centroCosto, "0", , , ],
		["|||Seguimiento de Actividades","ventas/segimientoActv.php","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , centroCosto, "0", , , ],
		
	
		["|M&oacute;dulo: Acumulaci&oacute;n de Puntos","","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , ventaxref, "0", , , ],
		["||Registro de Puntos ","transporte/maestro_transportista.php","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , inventarios, "0", , , ],	
		["||Seguimiento de Canjes","transporte/seguimiento_canje.php","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , inventarios, "0", , , ],	
...
["|Cont&oacute;metros para Grifos","","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , , "0", , , ],
		...
		["||Maestro Cont&oacute;metros","", "imgenes/icon5.gif", "imgenes/icon5.gif", , , , , , ],
    ...
    ["Log&iacute;stica","","imgenes/icon1.gif","imgenes/icon1o.gif", , , "0", , , ],
		...
		["|Busqueda Sensitiva Detalle","reportes/buscasen.php","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , , "0", , , ],
		
		["|Cuadre F&iacute;sico de Almacen","compras/cuadre_fisicoAlmacen.php?menu_temp=2","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , , "0", , , ],
		...
		["||Inventario Valorizado x Categ.","compras/inv_valorizado_pCateg.php?menu_temp=1","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , , "0", , , ],
		...
		["||Consolidados Productos Vendidos","reporte_venta5.php", "imgenes/icon5.gif", "imgenes/icon5o.gif", "",rptRecoleccion , , , , ],

    	["||Comparativo Stock entre Almacenes","reportes/comp_stock_alma.php", "imgenes/icon5.gif", "imgenes/icon5o.gif", "",rptCompStock , , , , ],
		["||Productos Mas Vendidos","reportes/prodmasvend.php", "imgenes/icon5.gif", "imgenes/icon5o.gif", "",rptCompStock , , , , ],
		...
		*/		
		...
		["||Modelos ","", "imgenes/icon5.gif", "imgenes/icon5o.gif", "",  , , , , ],
		 ["|||Generador de Modelos ","compras/gen_docModelo.php?cod=&accion=grabar", "imgenes/icon5.gif", "imgenes/icon5o.gif", "",  , , , , ],
		["|||Seguimiento de Modelos ","modelo_trasformacion/genDocModelo.php", "imgenes/icon5.gif", "imgenes/icon5o.gif", "",  , , , , ],
		 
		 
		 ["||Transformaci&oacute;n ","", "imgenes/icon5.gif", "imgenes/icon5o.gif", "",  , , , , ],
		 ["|||Generador de Transformaci&oacute;n ","modelo_trasformacion/genDocTransformacion.php", "imgenes/icon5.gif", "imgenes/icon5o.gif", "",  , , , , ],
		 ["|||Seguimiento de Transformaci&oacute;n ","modelo_trasformacion/segimientoTransformacion.php", "imgenes/icon5.gif", "imgenes/icon5o.gif", "",  , , , , ],
		 
		 
		["||Combos Ofertas ","", "imgenes/icon5.gif", "imgenes/icon5o.gif", "",  , , , , ],
		
		["|||Generador de Combos Ofertas ","modelo_trasformacion/gen_docOferta", "imgenes/icon5.gif", "imgenes/icon5o.gif", "",  , , , , ],
		["|||Seguimiento de Combos Ofertas ","modelo_trasformacion/segimientoOferta.php", "imgenes/icon5.gif", "imgenes/icon5o.gif", "",  , , , , ],
		["|||Bonificaciones entregadas ","modelo_trasformacion/segimientoBoniEnt.php", "imgenes/icon5.gif", "imgenes/icon5o.gif", "",  , , , , ],
		
		/* -------------------------------- productos de Importacion---------------------------------------
		*/	
	["|Ingreso de Importaciones","","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , , "0", , , ],
	
		["||Maestro de Importaci&oacute;n","compras/gen_docImportacion.php?tipomov=1", "imgenes/icon5.gif", "imgenes/icon5.gif", , , , , , ],	
		["||Seguimiento de Importaci&oacute;n","ventas/genDocSegImportacion.php", "imgenes/icon5.gif", "imgenes/icon5.gif", , , , , , ],	
	...
	/* -----------------------------------------------------------------------
	 ...
	 ["Finanzas","","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , , "0", , , ],
			...
			["|Cuentas Proveedores","", "imgenes/icon5.gif", "imgenes/icon5.gif", ,cuentasC , , , , ],
				...
				["||Planilla de Pagos","Reportes/rpt_planilla_pago.php", "imgenes/icon5.gif", "imgenes/icon5.gif", , , , , , ],
 	...
 	["Administraci&oacute;n","","imgenes/icon1.gif" ,"imgenes/icon1o.gif" , , , "0", , , ],
	   ...
	   ["|Auxiliares","", "imgenes/icon5.gif", "imgenes/icon5.gif", , articulos, , , , ],	   
		...
		["||Chofer","administracion/chofer.php", "imgenes/icon5.gif", "imgenes/icon5.gif", , tipocambio, , , , ],
			...
			["||Clasificaci&oacute;n","administracion/m_clasificacion.php", "imgenes/icon5.gif", "imgenes/icon5.gif", , condicion, , , , ],
