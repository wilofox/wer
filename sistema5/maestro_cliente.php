...
//echo "entro";
  ...
  $razonsocial=apostrofe($_REQUEST['razonsocial']);
  $ruc=$_REQUEST['ruc'];
  ...
  $cel1=$_REQUEST['cel1'];
  $cel2=$_REQUEST['cel2'];
  $nombre_aval=$_REQUEST['nombre_aval'];
  $direccion_aval=$_REQUEST['direccion_aval'];
  $telefono_aval=$_REQUEST['telefono_aval'];
  ...
  $lider='N';
	 ...
	 if($accion=='n'){
			...
			$strSQL2= "insert into cliente (codcliente,tipo_aux,razonsocial,ruc,telefono,nombres,apellidos,t_persona,doc_iden,direccion,email,contacto,cargo,baja,web,clas_clie,condicion,estado_percep,por_percep,lider,codlider,tipoprov,responsable,ubigeo,zona,cel1,cel2,nombre_aval,direc_aval,tel_aval) values ('".$codigo."','".$_REQUEST['tAuxiliar']."','".$razonsocial."','".$ruc."','".$telefono."','".$nombres."' ,'".$apellidos."' ,'".$t_persona."' ,'".$doc_iden."' ,'".$direccion."' ,'".$email."' ,'".$contacto."','".$cargo."','".$baja."','".$web."','".$clas_clie."','".$condicion."','".$estado_percep."','".$por_percep."','".$lider."','".$codlider."','".$tipoprov."','".$responsable."','".$idubigeo."','".$zon."','".$cel1."','".$cel2."','".$nombre_aval."','".$direccion_aval."','".$telefono_aval."')";
   ...
   */		
	...
	$strSQL="update cliente set razonsocial='".$razonsocial."',ruc='".$ruc."',telefono='".$telefono."',nombres='".$nombres."' ,apellidos='".$apellidos."' ,t_persona='".$t_persona."' ,doc_iden='".$doc_iden."' ,direccion='".$direccion."' ,email='".$email."' ,contacto='".$contacto."' ,cargo='".$cargo."',baja='".$baja."',web='".$web."',clas_clie='".$clas_clie."',condicion='".$condicion."',estado_percep='".$estado_percep."',por_percep='".$por_percep."',tipo_aux='".$_REQUEST['tAuxiliar']."',lider='".$lider."',codlider='".$codlider."',tipoprov='".$tipoprov."',responsable='".$responsable."',ubigeo='".$idubigeo."',zona='".$zon."',cel2='".$cel2."',cel1='".$cel1."',nombre_aval='".$nombre_aval."',direc_aval='".$direccion_aval."',tel_aval='".$telefono_aval."'  where codcliente='".$codigo."'";
    ...
    <tr>
      <td height="27" colspan="11"><table width="275" border="0" cellpadding="0" cellspacing="0">
        <tr>
		  ...
		  if($_SESSION['zonas']=="S"){
		  ?>
          <td width="193" align="right"><span class="Estilo7">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Zona</b>&nbsp;</span><select name="xzona" id="xzona" onChange="filtrar('')">
          <option value="T">Todos</option>
          <?php 
		  $sqlz=mysql_query("select * from zonas",$cn);
		  while($rz=mysql_fetch_array($sqlz)){
			  echo "<option value='".$rz['codigo']."'>".$rz['codigo']."-".$rz['zona']."</option>";
		  }
		  ?></select></td>
          <?php 
		  }
    ...
    <tr bordercolor="#CCCCCC" >
      <td height="23" colspan="11" align="left" style="padding-left:05px;"  ><table width="800" height="23" border="0" cellpadding="1" cellspacing="1" style="border:#D8D8D8 solid 1px">
        <tr style="background-image:url(imagenes/grid3-hrow-over.gif)" bordercolor="#CCCCCC"  bgcolor="#F9F9F9" >
          ...
          <td class="Estilo30" colspan="2">Raz&oacute;n Social </td>
          ...
          <td width="43" align="left"><span class="Estilo30">C&oacute;digo</span></td>
        </tr>
      </table></td>
    </tr>
    <tr bordercolor="#CCCCCC" >
...
var zona="<?php echo $_SESSION['zonas'];?>";
...
var verzona="T";
if(zona=="S"){
verzona=document.form1.xzona.value;
}
doAjax('new_cliente.php','filtro='+filtro+'&tipo_aux='+tipo_aux+'&criterio='+criterio+'&pagina='+pagina+'&verz='+verzona,'cargar_detalle','get','0','1','','');
}
