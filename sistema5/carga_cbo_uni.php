...
include('conex_inicial.php');
		...
		if($precio_p=='')$precio_p=0;
			
?>


<select    name="presentacion" id="presentacion" style="width:140px" 
<? if ($tipo=='modelo'){?>

<? }else {?>
onchange="javascript:calculos_pretot();document.formulario.cantidad.select();document.formulario.cantidad.focus();" >
<? } ?>
			<option style="background:#CCCCCC"  value="<?php echo $unidad_p ?>"><?php echo substr($des_uni_p,0,10)."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".number_format($precio_p,4,'.','') ?></option>
...
$preciox=0;
			  ...
			  ?>
              <option value="<?php echo $row1['unidad'] ?>"><?php echo substr($row1['des_uni'],0,10)."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".number_format($preciox,2,'.','') ?></option>
