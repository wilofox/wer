...
<script type="text/javascript" src="npProlyam.js"></script> 
...
<script language="javascript">
    ...
    {
       var url="pruebaimp.php"; // colocar la URL a imprimir
       SaveHTML(url)
       objPlugin.PrintHTML(
            url,
...
<BODY class="indent">
    ...
    <BR><BR>
    <input name="button" type=button onClick="alert(objPlugin.getSO())" value="Call plugin.FunctionValue('getSO')">
    <BR>
    <BR>
