...
include('conex_inicial.php');
	...
	$strSQL_cla="select * from producto where categoria='".$_REQUEST['cod']."' ";
	$resultado_cla=mysql_query($strSQL_cla,$cn);
	$cont=mysql_num_rows($resultado_cla);
	
		if($cont==0){
		$strSQL="delete from categoria where idCategoria='" . $_REQUEST['cod'] . "'";
		mysql_query($strSQL,$cn);
		}else{
		echo "<script>alert('Esta categoria tiene productos relacionados...')</script>";
...
<form name="form1" method="post" action="categorias.php">
  <table width="100%" border="0">
     <tr style="background:url(imagenes/white-top-bottom.gif)">
       <td height="27" colspan="13" style="border:#999999">&nbsp;<span class="Estilo34">Administraci&oacute;n :: Art&iacute;culos :: <span class="Estilo14 Estilo38">Categor&iacute;as
    ...
    <tr>
      <td align="center"><table width="659" border="0" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC" >

    <tr>
      <td colspan="6">&nbsp;</td>
    </tr>
    <tr height="20px" style="background:url(imagenes/sky_blue_grid.gif); border:#999999 solid 1px">
      <td width="99" align="center" style=" border:#CCCCCC solid 1px" class="EstiloTexto1">C&oacute;digo</td>
      <td width="314" align="center" class="EstiloTexto1" style=" border:#CCCCCC solid 1px">Descripci&oacute;n</td>
      <td width="90" align="center" class="EstiloTexto1" style=" border:#CCCCCC solid 1px">Clasificaci&oacute;n</td>
  ...
  $resultados = mysql_query("select * from categoria order by idCategoria ",$cn);
...
while($row=mysql_fetch_array($resultados))
{
 ?>
    <tr  bgcolor="#FFFFFF">
      ...
      <td align="center"><span class="Estilo12"><?php echo $row['idCategoria'];?></span></td>
      <td><span class="Estilo12"><?php echo $row['des_cat'];?>&nbsp;</span></td>
      <td align="left"><span class="Estilo12"><?php echo $row['clasificacion'];?></span></td>
      <td width="69" align="center" bgcolor="#FFFFFF"><span class="Estilo13"><span class="Estilo12">&nbsp;<a href="javascript:editar('<?php echo $row['idCategoria']?>','actualizar');"><img src="imgenes/ico_edit.gif" border="0"></a></span></span></td>
      <td width="71" align="center" bgcolor="#FFFFFF"><span class="Estilo13"><span class="Estilo12"><a href="javascript:eliminar('<?php echo $row['idCategoria']?>');"><img src="imgenes/eliminar.gif" border="0"></a></span></span></td>
    </tr>
    <?php  
...
window.open('editar_categorias.php?cod='+cod+'&accion='+accion,'ventana','height=300, width=450, top=200, left=250');
}

function eliminar(cod){
	if(confirm('Esta seguro que desea eliminar este producto?')){
	location.href='categorias.php?cod='+cod;
	//this.form1.submit();
	}
