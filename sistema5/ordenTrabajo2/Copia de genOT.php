...
function listaprod(texto){
	...
	//alert(temp_criterio);
	doAjax('../compras/det_aux2.php','&clasificacion=1&nomb_det='+valor+'&temp='+temp+'&tipomov='+tipomov+'&tienda='+tienda+'&criterio='+temp_criterio+'&prov_asoc='+document.formulario.prov_asoc.value+'&moneda_doc='+moneda_doc+'&verCodAnexo&tipoBus='+controltipoBus[1]+'&codigoDoc='+codigoDoc,'detalle_prod','get','0','1','','');
...
$k++;
    ...
    Calendar.setup({
        ...
        <tr>
          ...
          <td class="Estilo14">F.Vencimiento           <!-- <span class="Estilo114">Tipo de Negocio</span>-->
		  </td>
          <td>
...
function validartecla(e,valor,temp){
	...
	if ( ( (e.keyCode>=96) && (e.keyCode<=105) || (e.keyCode>=48) && (e.keyCode<=57) )  || ((e.keyCode>=65) && (e.keyCode<=90)) || e.keyCode==8 || e.keyCode==32 ) {
		...
		doAjax('../compras/det_aux2.php','&clasificacion=1&nomb_det='+tempValor+'&temp='+temp+'&tipomov='+tipomov+'&tienda='+tienda+'&criterio='+temp_criterio+'&prov_asoc='+document.formulario.prov_asoc.value+'&moneda_doc='+moneda_doc+'&verCodAnexo&predefecto='+tempPreDefecto+'&tipoBus='+controltipoBus[1]+'&codigoDoc='+codigoDoc,'detalle_prod','get','0','1','','');
		 //alert('entro');
		}
