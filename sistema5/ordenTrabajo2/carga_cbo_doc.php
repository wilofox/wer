...
?>
			...
			<select  style="width:160" name="doc" id="doc"  onChange="cambiar_enfoque(this);" onFocus="enfocar_cbo(this);limpiar_enfoque(this);">
		  <option value="0"></option>
		  <?php 
		 
		   //$resultados10 = mysql_query("select * from operacion,docuser where codigo=doc and tipo=tipomov  and codigo!='TS' ".$filtro1."  and tipo='".$tipomov."' and empresa='".$empresa."' and usuario='".$usuario."' group by codigo order by descripcion ",$cn); 
		   $resultados10 = mysql_query("select * from  operacion where tipo='".$tipomov."' and (codigo='OT' or codigo='OS') order by descripcion ",$cn); 
