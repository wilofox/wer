  ...
  <tr bgcolor="<?php echo $color_row?>" onClick="entrada(this);Anular('S<?=$AnRK;?>')" ondblclick="doc_det(this)" >
	  ...
	  <? } ?>	<?php echo $AnRK;?>  </td>
             <td width="117" class="texto1"><?php echo $row['fecha']?></td>	
			  ...
			  list($cantidad,$nombreprod)=mysql_fetch_row(mysql_query("select cantidad,nom_prod from det_mov where cod_cab='".$row['cod_cab']."' order by cod_det limit 1"));
			  ?>			  </td>
              <td width="274" align="left" class="texto1"><?php echo $nombreprod?></td>
              <td width="66" align="center" class="texto1"><?php 
					//echo $row['cod_ope'];
			   ...
			   ?></td>
			  <td width="62" align="center" class="texto1"><?php 
				echo $cantidad;	
