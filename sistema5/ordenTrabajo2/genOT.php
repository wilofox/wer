...
//	var tecla=window.event.keyCode;
 	...
 	if (temporal_teclas=="") {
		...
		grabar_doc();
			...
			alert('No se puede guardar este un documento sin valor');			
			}
...
jQuery(document).bind('keyup', 'return',function (evt){jQuery('#_return').addClass('dirty'); 
	...
	if(document.getElementById('productos').style.visibility=='visible'){
		...
		var temp2=document.getElementById('tblproductos').rows[i].cells[2].childNodes[0].innerHTML;
		
		var temp3=document.getElementById('tblproductos').rows[i].cells[4].innerHTML;
		var temp4=document.getElementById('tblproductos').rows[i].cells[5].innerHTML;
		// alert(temp4);
	  ...
	  // document.formulario.precosto.value=unidad[6];
	   ...
	   document.formulario.ccajas.value=unidad[16];
	   if(unidad[16]=='S'){
			...
			enviar();
				...
				nombreVariable=document.getElementById('MB_frame');
					...
					if(document.formulario.cantidad.value!="" && document.formulario.termino.value!="" && document.formulario.codprod.value!="" && (document.formulario.punit.value=="" || document.formulario.punit.value==0) && !isset(nombreVariable) ){
						...
						if(document.formulario.doc.value='OT'){
						    if(document.activeElement.name=='cantidad' && document.formulario.ccajas.value=='S'){
								document.formulario.pcajas.focus();
								document.formulario.pcajas.select();
								return false;
							}
...
function listaprod(texto){
	...
	var codigoDoc=document.formulario.doc.value;
	//alert(temp_criterio);
	 var perm_chkElemProd=find_prm(tab_chkElemProd,tab_cod);
	 var perm_ElemProd=find_prm(tab_ElemProd,tab_cod);
 
	doAjax('../compras/det_aux2.php','&clasificacion=1&nomb_det='+valor+'&temp='+temp+'&tipomov='+tipomov+'&tienda='+tienda+'&criterio='+temp_criterio+'&prov_asoc='+document.formulario.prov_asoc.value+'&moneda_doc='+moneda_doc+'&verCodAnexo&tipoBus='+controltipoBus[1]+'&codigoDoc='+codigoDoc+'&chkElemProd='+perm_chkElemProd+'&ElemProd='+perm_ElemProd,'detalle_prod','get','0','1','','');
...
<form id="formulario" name="formulario" method="post" action="">
  <table width="807" border="0" cellpadding="0" cellspacing="0">
     ...
     <tr style="background:url(../imagenes/white-top-bottom.gif)">
       <td height="27" colspan="13" style="border:#999999">&nbsp;<span class="Estilo34">Ventas :: &Oacute;rdenes de Trabajo de Producci&oacute;n :: Generador de &Oacute;rdenes de Trabajo <span class="Estilo14 Estilo38">
...
$k++;
    ...
    Calendar.setup({
        ...
        <tr>
          ...
          <td align="left"> <div id="cbo_doc" style="visibility:visible; width:170px; ">
          ...
          <td class="Estilo14">F.Vencimiento           <!-- <span class="Estilo114">Tipo de Negocio</span>-->		  </td>
          <td>
		  
		  <input name="fven" type="text" size="15" maxlength="10"  value="<?php echo date('d-m-Y')?>"  onKeyUp="generar_ceros(event,'0',this)" onChange="enfocar_fecha(this)">
    ...
    Calendar.setup({
		...
		<!--	<button type="button" id="btnAreasC"  onClick="verAreasCosto()"  style="height:20; width:120px; font-size:10px" >Seleccionar</button>-->			</td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td ></td>
      <td colspan="7"><table id="tblCampos" width="720" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="227"><span class="Estilo14">Producto:</span></td>
          <td width="140"><span class="Estilo14">Presentaci&oacute;n:</span></td>
          <td width="10">&nbsp;</td>
          <td width="62"><span class="Estilo14">Cant.:</span></td>
          <td width="10">&nbsp;</td>
          <td id="tdcajas1" style="display:none"><span class="Estilo14">Cajas</span></td>
          <td width="10">&nbsp;</td>
          <td width="59"><span class="Estilo14">P.Unit:</span></td>
          <td width="10">&nbsp;</td>
          <td width="54"><span class="Estilo14">&nbsp;</span><span class="Estilo14">Total:</span></td>
          <td width="103" align="center"><span class="Estilo14">Notas</span></td>
        </tr>
        <tr>
          ...
          <td>&nbsp;</td>
          <td width="66" align="left" id="tdcajas2" style="display:none"><span class="Estilo14">
          ...
          <td align="center"><input  name="precio2" type="hidden" size="3"/>
            <input name="notas" type="text" size="12" maxlength="30"></td>
        </tr>
      </table></td>
    </tr>
	  ...
	  <div id="resultado">
	    <table width="711" border="0" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
          ...
          <tr style="font:Verdana, Arial, Helvetica, sans-serif; font-size:12px">
            ...
            <td align="right" bgcolor="#FFFFFF">&nbsp;</td>
            <td colspan="2" bgcolor="#FFFFFF"><table width="121" border="0" cellpadding="0" cellspacing="0">
              <tr>
...
-->
 ...
 <div id="areasCosto" style="border:#238CE2 solid 1px; background:#E2FAFE; position:absolute; left:401px; top:139px; width:304px; height:150px; z-index:2; visibility:hidden; background-color: #F1FBFE;">
   <table width="297" height="263" border="0" cellpadding="0" cellspacing="0">
     <tr style="background:url(../imagenes/bg_contentbase2.gif); background-position:100px 60px; color:#FFFFFF">
       ...
       <td width="289"><span class="Estilo32"><strong>Tipos de Negocio  </strong></span></td>
	   ...
	   <table width="326" height="100%" border="0" cellpadding="0" cellspacing="0">
         ...
         <tr>
           ...
           <td width="287" height="140" valign="top">
               <div style="overflow-y:scroll; width:280px; height:200px">
                 <table width="286" height="40" border="0" cellpadding="0" cellspacing="0">
                   <tr>
                     ...
                     <td width="190" align="center" bgcolor="#00BBBB"><span class="Estilo32"><strong>Descripci&oacute;n </strong></span></td>
                   </tr>
                   <?php 
...
function view_cbo_uni(texto){
	...
	document.formulario.serie_ing.value="S";
		...
		document.formulario.cantidad.focus();
			if(document.formulario.doc.value=="OT"){
			document.formulario.punit.readOnly="readonly";
			document.formulario.precio.readOnly="readonly";
			}
		}else{
		calc_pre_total();
...
//alert(temp);
	...
	function rpta_bus_numero(texto){
		...
		if(document.getElementById("capaCopiarDoc").style.visibility=="visible"){
			...
			document.formulario.almacen.disabled=true;
		    //document.formulario.auxiliar.disabled=false;						
			if(document.formulario.doc.value=="OS"){
			document.formulario.auxiliar.disabled=false;
			document.formulario.auxiliar.focus();
			document.formulario.auxiliar.select();			
			}else{
			document.formulario.auxiliar.value="Cliente Varios";
			document.formulario.auxiliar2.value="001";
			document.formulario.auxiliar.disabled=true;
			document.formulario.responsable.disabled=false;
			document.formulario.responsable.focus();
			}
...
function validartecla(e,valor,temp){
	...
	if ( ( (e.keyCode>=96) && (e.keyCode<=105) || (e.keyCode>=48) && (e.keyCode<=57) )  || ((e.keyCode>=65) && (e.keyCode<=90)) || e.keyCode==8 || e.keyCode==32 ) {
		...
		if(document.getElementById(temp).style.visibility!='visible' ){
			...
			tempPreDefecto=find_prm(tab_predefecto,tab_cod);
			//alert(tempPreDefecto);
		...
		doAjax('../compras/det_aux2.php','&clasificacion=1&nomb_det='+tempValor+'&temp='+temp+'&tipomov='+tipomov+'&tienda='+tienda+'&criterio='+temp_criterio+'&prov_asoc='+document.formulario.prov_asoc.value+'&moneda_doc='+moneda_doc+'&verCodAnexo&predefecto='+tempPreDefecto+'&tipoBus='+controltipoBus[1]+'&codigoDoc='+codigoDoc+'&chkElemProd='+perm_chkElemProd+'&ElemProd='+perm_ElemProd,'detalle_prod','get','0','1','','');
		 //alert('entro');
		}
...
function cargar_cbo_doc(){
	...
	//alert(temp[12]+" "+temp[18]);
			...
			//alert(tab10);
			 ...
			 tab_chkElemProd=temp[42].split(",");
			 tab_ElemProd=temp[43].split(",");
			// alert(temp[42]);
...
//if(document.getElementById('productos').style.visibility=='visible'){
		...
		var temp2=document.getElementById('tblproductos').rows[indice].cells[2].childNodes[0].innerHTML;
		
		var temp3=document.getElementById('tblproductos').rows[indice].cells[4].innerHTML;
		var temp4=document.getElementById('tblproductos').rows[indice].cells[5].innerHTML;
		// alert(temp4);
		   var unidad=temp4.split("-");
	   document.formulario.uni_p.value=unidad[0];
	   document.formulario.factor_p.value=unidad[1];
