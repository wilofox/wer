<?php 
	...
	while($arr2=mysql_fetch_array($rs2)){
		...
		//echo "<li>$arr2[0] <i>$arr3[2]  $arr3[3]</i> <b>$arr4[3]</b>";
	}
    //---------------------------------------------------------------------------------
	*/
	/*
...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>:::: SISTEMA Gedeon PC :::::</TITLE>
...
//       objPlugin.PrintHTML(url,document.getElementById("printer").value);
	...
	var tempResp="<?php echo $_REQUEST['rep'] ?>";
	  if(tempResp=='S'){
	    generateCoverDiv("capa_fondo","#000000",30);
		document.getElementById("capaAlert").style.visibility="visible";
	  	doAjax('peticion_ajax5.php','&peticion=repararBD','tempR2','get','0','1','','');
	  }else{
		  //alert(objPlugin.getComputerName());
			try{
...
<div id="capaAlert" style="background:#E2FAFE; position:absolute; left:344px; top:231px; z-index:2; visibility:hidden; background-color: #F1FBFE; width: 517px; height: 198px;">
 <!--<form id="frm_cajaFact" name="frm_cajaFact">-->
 <table width="516" height="198" border="0" cellpadding="0" cellspacing="0" >
  <tr>
    <td height="27" colspan="3" ><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="54" height="19" style="background:url(imagenes/img_panelbox/top_logo.gif) repeat-x scroll 0 0 transparent">&nbsp;</td>
        <td width="456" style="background:url(imagenes/img_panelbox/top_m.gif) repeat-x scroll 0 0 transparent; "><table width="455" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="435"><span class="Estilo119 Estilo10">Restaurando Sistema </span></td>
            <td width="20" align="center" style="cursor:pointer" onClick="cerrarCaja()">&nbsp;</td>
          </tr>
        </table></td>
  ...
  <tr>
    <td width="7" height="161" style="background:url(imagenes/img_panelbox/left.gif) repeat scroll 0 0 transparent"></td>
    <td width="494" align="center" valign="top"><span class="Estilo12"><br>
        <span class="Estilo14">Se est&aacute; realizando un mantenimiento del sistema, no cierre esta ventana hasta que termine. Gracias </span></span><br>
      <br>        <img src="imgenes/cargando2.gif" width="16" height="16"><br>
    <br>
    <span class="Estilo13">Verificando Integridad de Datos </span></td>
    <td width="7" style=" background:url(imagenes/img_panelbox/right.gif) repeat scroll 0 0 transparent"></td>
  </tr>
  ...
  <tr>
    ...
    <td width="7" style="background:url(imagenes/img_panelbox/bottom_r.gif) repeat scroll 0 0 transparent"></td>
  </tr>
</table>
<!--</form>-->
...
if(estado=='p'){
	alert("No tiene permiso para acceder al sistema");
}
if(estado=='ht'){
	alert("No tiene permiso esta fuera del horario de trabajo ");
}
