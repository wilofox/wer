...
?>
  ...
  <tr bgcolor="<?php echo $color_row?>" onClick="entrada(this)" ondblclick="doc_det(this)"  >
	  ...
	  <? } ?>	  </td>
             <td width="87" class="texto1" ><?php echo $row['des_tienda']?></td>	
			  <td width="67" class="texto1" ><?php echo formatofecha(substr($row['fecha'],0,10));?></td>	
              <td width="127" class="texto1"><?php echo substr(caracteres($row['razonsocial']),0,22);?></td>
              <td width="124"  class="texto1" title="Hol"><?php 
			  ...
			  ?></td>
			  <td width="92" align="center" class="texto1"><?php 
			 ...
			 $strSQL09="select * from condicion where codigo='".$row[27]."'  ";
			  ...
			  echo $row09['nombre'];
			   ...
			   ?></td>
			  <td width="87" align="center" class="texto1"><?php echo formatofecha(substr($row['f_venc'],0,10));?></td>	
			  <td width="39" align="center" class="texto1"><?php  if ($row['archivo']<>''){ echo '<a href="../ventas/'.$row['archivo'].'" target="_blank"><img src="../imagenes/archivo.png" width="15" height="15" border="0" border="0"></a>';}?></td>
			  <td width="29" align="center" class="texto1"><?php if ($row['obs1']<>''){ echo '-|-'; }; ?></td>		 
    </tr>
  <?php }?>
</table>
</div>
