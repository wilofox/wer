...
<table width="905" border="0">
  <tr>
    <td  align="center"></td>
    <td colspan="11" align="center"><span class="Estilo1">Reporte Seguimiento O.R. </span></td>
  </tr>
  <tr>
    <td  align="center"></td>
...
$sql="select * from cab_mov where cod_cab='".$row['cod_cab']."'  and cod_ope ='OR' and flag<>'A'
LIMIT 0, 1  ";
$resultadoX=mysql_query($sql,$cn);
while($rowX=mysql_fetch_array($resultadoX)){
$est="";
