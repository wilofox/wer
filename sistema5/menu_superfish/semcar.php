		...
		<?php /*?>	
			...
			<li class="current">
				...
				<ul>
					...
					<li>
						<a style="display:<?php echo $transferencia ?>" class="lnk" rel="ordenTrabajo2/genDocRefOT2.php?docRef=OT">Seguimiento de O.T.</a>
					</li>
					<li>
						<a style="display:<?php echo $transferencia ?>" class="lnk" rel="ordenTrabajo2/matprimxterm.php?docRef=OT">Transformaci&oacute;n / Producto Terminados</a>						
					</li>
				</ul>
			</li>
...
<!---------------------------------------------------Administracion------------------------------------------------->
	<li class="current">
		<a style="display:block" href="#">Administracin</a>
		<ul>
			...
			<li class="current">
				...
				<ul>
					...
					<li><a style="display:<?php echo  $condicion ?>" class="lnk" rel="administracion/m_clasificacion.php">Clasificacin</a></li>
				</ul>
			</li>
			<li class="current">
				<a style="display:<?php echo  $articulos ?>" href="#">Articulos</a>
				<ul>
					<li><a style="display:<?php echo  $articulos ?>" class="lnk" rel="productos.php">Soporte Productos</a></li>
					<li><a style="display:<?php echo  $articulos ?>" class="lnk" rel="clasificacion.php">Clasificacin</a></li>
			...
			<li class="current">
				<a style="display:<?php echo  $configuracion ?>" href="#">Configuracin</a>
				<ul>
