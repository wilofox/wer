		...
		<ul>
			<li class="current">
				...
				<ul>
					...
					<li>
						<a style="display:<?php echo $transferencia ?>" class="lnk" rel="ventas/genDocRefPCs.php">Seguimiento de PCs</a>						
					</li>
					<li><a style="display:<?php echo  $cajamult ?>" class="lnk" rel="ventas/genDocMiltifactura.php">Caja - Multifacturaci&oacute;n</a></li>
					<li><a style="display:<?php echo  $cajacred ?>" class="lnk" rel="ventas/genDocSegMiltifac.php">Caja - Cr&eacute;ditos</a></li>
					<li><a style="display:<?php echo  $cajacred ?>" class="lnk" rel="ventas/genDocMiltifacturaGuias.php">Multifacturacion - Guias</a></li>
			...
			<li class="current">
				<a style="display:<?php echo $centroCosto ?>" href="#">&Oacute;rdenes de Trabajo de Producci&oacute;n</a>
				<ul>
					<li>
						<a style="display:<?php echo $centroCosto ?>" class="lnk" rel="ordenTrabajo2/genOT.php?tipomov=2">Generador de &Oacute;rdenes Trabajo</a>
					</li>
					<li>
						<a style="display:<?php echo $transferencia ?>" class="lnk" rel="ordenTrabajo2/genDocRefOT2.php?docRef=OT">Seguimiento de Producci&oacute;n </a>
					</li>
					<li>
						<a style="display:<?php echo $transferencia ?>" class="lnk" rel="ordenTrabajo2/matprimxterm.php?docRef=OT">Plantilla de Transformaci&oacute;n </a>						
					</li>
					<li>
						<a style="display:<?php echo $transferencia ?>" class="lnk" rel="ordenTrabajo2/genDocRefOT3.php?docRef=OT">Seguimiento de Entregas Parciales</a>						
					</li>
		...
		<?php /*?>	
		    <li class="current">
				...
				<ul>
					...
					<li><a style="display:<?php echo  $ventaxref ?>" class="lnk" rel="#">Listado Planilla por D&iacute;as</a></li>
				</ul>
			</li>
			<?php */?>
			...
			<li class="current">
				...
				<ul>
					...
					<li><a style="display:<?php echo  $configuracion ?>" class="lnk" rel="configuracion/anexo.php">Etiqueta de Anexo</a></li>
						<li><a style="display:<?php echo  $configuracion ?>" class="lnk" rel="configuracion/produccion.php">Etiqueta de Producci&oacute;n</a></li>
				</ul>
			</li>
