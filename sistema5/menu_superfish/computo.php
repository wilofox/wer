...
<ul class="sf-menu">
	...
	<li class="current">
		...
		<li><a style="display:<?php echo  $cajacred ?>" class="lnk" rel="ventas/genDocMiltifacturaGuias.php">Seguimiento de Guias Facturadas</a></li>
			...
			<li class="current">
				<a style="display:<?php echo  $servTecGar ?>" href="#">Servicio T&eacute;cnico y Garant&iacute;a</a>
				<ul>
					<li><a style="display:<?php echo  $servTecGar ?>" class="lnk" rel="serv_tg/genDoc.php">&Oacute;rdenes Pendientes de Entrega</a></li>
					<li><a style="display:<?php echo  $servTecGar ?>" class="lnk" rel="serv_tg/genDocSeg.php">Seguimiento de Art&iacute;culos Entregados</a></li>
				</ul>
			</li>
		...
		<?php /*?>
          ...
          <?php /*?>
			...
			<!--<li><a style="display:<?php  //echo  $ventas ?>" class="lnk" rel="ventas/productos_cliente/index.php">Productos por cliente</a></li>-->
		</ul>
	</li>
	...
	<li class="current">
		...
		<ul>
			...
			<li><a style="display:<?php echo  $BusuqedaSen ?>" class="lnk" rel="reportes/buscasen.php">B&uacute;squeda Sensitiva Detalle</a></li>
			...
			<li>
				<a style="display:<?php echo  $inventarios ?>" rel="#">Inventarios</a>
				<ul>
					<li><a style="display:<?php echo  $inventarios ?>" class="lnk" rel="compras/kardex_fisico.php">Kardex F&iacute;sico</a></li>
					...
					<li><a style="display:<?php echo  $inventarios ?>" class="lnk" rel="reportes/prodmasvend.php">Productos m &aacute;s Vendidos</a></li>
				</ul>
			</li>
			...
			<li>
				<a style="display:<?php if($_SESSION['nivel_usu']=="1"){ echo "block";}else{echo  $inventarios;} ?>" rel="#">Control de Series</a>
				<ul>
					<li><a style="display:<?php  echo $inventarios; ?>" class="lnk" rel="compras/inv_valorizado_serien.php?menu_temp=1">Inventario F&iacute;sico de Series</a></li>
					<li><a  style="display:<?php  if($_SESSION['nivel_usu']=="1"){ echo "block";}else{echo  $inventarios;}  ?>" class="lnk2" rel="reportes/rptbusqueda_series.php">B&uacute;squeda Sensitiva de Series</a></li>
				</ul>
			</li>

			<li>
				<a style="display:<?php echo  $modelosTransf ?>" href="#">Modelos y Transformaciones</a>
				<ul>
					<li>
			...
			<?php /*?><li>
				<a style="display:<?php echo  $inventariosNP ?>" class="lnk" rel="#">Inventario de Nuevos Productos</a>
				<ul>
					<li><a style="display:<?php echo  $inventarios ?>" class="lnk" rel="compras/inv_valorizado_serien.php?menu_temp=1">Maestro de Importaci&oacute;n</a></li>
					<li><a style="display:<?php echo  $inventarios ?>" class="lnk" rel="ventas/genDocSegImportacion.php">Seguimiento de Importaci&oacute;n</a></li>
				</ul>
			</li><?php */?>
	...
	<li class="current">
		...
		<ul>
			<li class="current">
				<a style="display:<?php echo  $cuentasC ?>" href="#">Cr&eacute;ditos y Cobranzas</a>
				<ul>
		...
		<ul>
			...
			<li class="current">
				...
				<ul>
					...
					<li><a style="display:<?php echo  $transfCont ?>" class="lnk" rel="contabilidad/kardex_permantente_f.php">Kardex Permanente 12.1(f&iacute;sico)</a></li>
			...
			<li class="current">
				<a style="display:<?php echo  $contabilidad ?>" href="#">Auditor&iacute;a</a>
				<ul>
...
<!---------------------------------------------------Administracion------------------------------------------------->
		...
		<ul>
			...
			<li class="current">
				...
				<ul>
					...
					<li><a style="display:<?php echo  $articulos ?>" class="lnk" rel="recalculo.php">Rec&aacute;lculo de Stocks Y Costos</a></li>
					<li><a style="display:<?php echo  $articulos ?>" class="lnk2" rel="formatos/configForm.php">Editor de Formatos</a></li>
					
				</ul>
			</li>
			<li><a style="display:<?php echo  $usuarios ?>" class="lnk" rel="lista_usuarios.php">Personal</a></li>
	...
	<li class="current">
		...
		<ul>
			...
			<li><a style="display:block" class="lnk" rel="ayuda/temp.php">Temas de Ayuda </a></li>
		</ul>
	</li>
