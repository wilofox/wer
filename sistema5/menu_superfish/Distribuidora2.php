...
<ul class="sf-menu">
		...
		<ul>
			<li class="current">
				...
				<ul>
					...
					<li><a style="display:<?php echo  $ptoventa ?>" class="lnk" rel="pedido2.php">Punto de Vendedores</a></li>			
					<li><a style="display:<?php echo  $ptoventa ?>" class="lnk" rel="ventas/genDocSegMiltifac.php">Caja - Cr&eacute;ditos</a></li>
						
						<?php /*?><li><a style="display:<?php   $ptoventa ?>" class="lnk" rel="ventas/SeguimientoPedidos.php">Seguimiento de Pedidos</a></li>
						
					<li ><a  style="display:<?php echo  $rptCierre ?>" class="lnk" rel="reporte_cierre.php">Reporte de Cierre</a></li>
					<li>
						<a style="display:<?php echo $transferencia ?>" class="lnk" rel="ordenTrabajo2/genDocRefPCs.php?docRef=OT">Seguimiento de PCs </a>						
					</li>
					<?php */?>
				</ul>
			</li>
	...
	<li class="current">
		...
		<li>	
		<a style="display:<?php echo  $inventarios ?>" class="lnk" rel="#">Generar Guias x Transferencias</a>
			<ul>
			...
			<li>
				<a style="display:<?php echo  $transferencia ?>" href="#">Modelos y transformaciones</a><ul><li>
	...
	<li class="current">
		...
		<ul>
			...
			<li class="current">
				...
				<ul>
					<li><a style="display:<?php echo  $cuentasP ?>" class="lnk" rel="Finanzas/cuentaCorrienteN.php?tipo=1">Pago Cuentas Proveedores</a></li>
					<li><a style="display:<?php echo  $cuentasP ?>" class="lnk" rel="Finanzas/Estado_Cta_Cte.php?tipo=1">Estado Cta. Cte. Proveedor</a></li>
					<li><a style="display:<?php echo  $cuentasP ?>" class="lnk" rel="Finanzas/reportect1.php?tipo=1">Documentos Pendientes Proveedores</a></li>
					<!--<li><a style="display:<?php echo  $cuentasP ?>" class="lnk" rel="ventas/segimientoPases.php">Seguimento de Pases - Proveedores</a></li>-->
					<li><a style="display:<?php echo  $cuentasP ?>" class="lnk" rel="reportes/rpt_planilla_pago.php">Planilla de Pagos</a></li>
					
				    <?php /*?><li><a href="#">Canje Letras Proveedores</a>
				      <ul>
			      ...
			      <li><a href="#">Programacion Pago Proveedores</a>
                    <ul>
		...
		<ul>
			...
			<li class="current">
				...
				<ul>
                    ...
                    <li><a style="display:<?php echo  $zonas ?>" href="#">Zonas</a>
					<ul>
						<li><a style="display:<?php echo  $zonas ?>" class="lnk" rel="administracion/m_zonas.php">Zonas de Venta</a></li>
						<li><a style="display:<?php echo  $zonas ?>" class="lnk" rel="Vendedorxzona.php">Vendedores por Zona</a></li>
					</ul></li>
	            </ul>
		    </li>
		  <li class="current"> <a href="#">Finanzas</a>
            <ul>
			...
			<li class="current">
				...
				<ul>
					<li><a style="display:<?php echo  $utiles ?>" class="lnk" rel="tcambio.php">Tipo de Cambio</a></li>
					<li><a style="display:<?php echo  $utiles ?>" class="lnk" rel="administracion/backup.php">Backups</a></li>
					<li><a style="display:<?php echo  $utiles ?>" class="lnk" rel="recalculo.php">Rec&aacute;lculo de Stocks y Costos</a></li>
					<li><a style="display:<?php echo  $utiles ?>" class="lnk2" rel="formatos/configForm.php">Editor de Formatos</a></li>
				</ul>
			</li>


			<li class="current">
				<a style="display:<?php echo  $usuarios ?>" href="#">Personal</a>
				<ul>
