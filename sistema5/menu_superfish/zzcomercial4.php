		...
		<ul>
			<li class="current">
				...
				<ul>
                  ...
                  <li><a style="display:<?php echo  $rptVencCob7Day ?>" class="lnk" rel="Finanzas/rpt_vencimientosxdia.php?tipo=2">Reporte de Vencimientos de Cobranzas a 7 dias</a></li>
				</ul>
			...
			<li class="current">
				...
				<ul>
                  ...
                  <li><a style="display:<?php echo  $rptVencPag7Day ?>" class="lnk" rel="Finanzas/rpt_vencimientosxdia.php?tipo=1">Reporte de Vencimientos de Pagos a 7 dias</a></li>
				</ul>
			</li>
		...
		<ul>
			...
			<li class="current">
				...
				<ul>
					...
					<li><a style="display:<?php echo  $transfCont ?>" class="lnk" rel="contabilidad/kardex_permantente_f.php">Kardex Permanente 13.1(fisico y Valorizado)</a></li>
					...
					<li><a style="display:<?php echo  $transfCont ?>" class="lnk" rel="contabilidad3.php">Transferencia a Contabilidad (Pagos) </a></li>
