...
<ul class="sf-menu">
		...
		<?php /*?>	
		    <li class="current">
				...
				<ul>
					...
					<li><a style="display:<?php echo  $cajacred ?>" class="lnk" rel="ventas/genDocSegMiltifac.php">Caja - Cr&eacute;ditos</a></li>
	...
	<?php /*?>		<li class="current">
				<a style="display:block" href="#">Modulo Puntos - Lider </a>
				<ul>
					<li><a style="display:<?php echo $catalogoPre ?>" class="lnk" rel="puntos/seguimientopuntos.php" >Seguimiento de Puntos</a></li>
					
					<li><a style="display:<?php echo $catalogoPre ?>" class="lnk" rel="puntos/seguimiento_canje.php" >Seguimiento de Canjes</a></li>
					
					<li><a style="display:<?php echo  $condicion ?>" class="lnk" rel="reportes/seguimientolider.php">Seguimiento de L&iacute;deres</a></li>
		...
		<?php /*?>
			...
			<li>
				<a style="display:<?php echo  $ventaxref ?>" class="lnk" rel="#">M&oacute;dulo: Acumulacion de Puntos</a>
				<ul>
					...
					<li><a class="lnk" rel="transporte/mant_productos.php">Mantenimiento de Productos</a></li>
				</ul>
			</li>
	...
	<li class="current">
		...
		<ul>
			...
			<!--<li><a style="display:<?php echo  $compras ?>" class="lnk" rel="compras/cuadre_fisicoAlmacen.php?menu_temp=2">Cuadre F&iacute;sico de Almac&eacute;n</a></li>-->
		...
		<ul>
			...
			<li class="current">
				...
				<ul>
					...
					<li><a style="display:<?php echo  $cuentasC ?>" class="lnk" rel="ventas/segimientoPases.php">Seguimiento de Pases - Proveedores</a></li>
			...
			<li><a style="display:<?php echo  $flujoC ?>" class="lnk" rel="ventas/genDocSegMiltifac.php">Caja - Cr&eacute;ditos</a></li>
		</ul>
		...
		<ul>
			...
			<li class="current">
				...
				-->					
				    ...
				    <li> <a style="display:<?php echo  $contabilidad ?>" href="#">Integrador de Sistemas </a>
                      <ul>
                        <li><a style="display:<?php echo  $transfCont ?>" class="lnk" rel="importar_excel2/form_import.php">Importador de archivos </a></li>
                      </ul>
				    </li>
				</ul>
			</li>
