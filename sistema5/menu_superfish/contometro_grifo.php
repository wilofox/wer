...
<ul class="sf-menu">
	...
	<li class="current">
		...
		<?php /*?>
          ...
          <?php /*?>
			...
			<li>
				<a style="display:block" class="lnk" rel="#">Cont&oacute;metros para Grifos</a>
				<ul>
					<li>
						<a style="display:block" class="lnk" rel="#">Maestros Cont&oacute;metros</a>
						<ul>
					...
					<li><a style="display:<?php  ?>" class="lnk" rel="contometro/hist_contometro.php">Historial de Cont&oacute;metros</a></li>
					<li><a style="display:<?php  ?>" class="lnk" rel="contometro/hist_varillaje.php">Ingreso de Varillaje</a></li>
					<li><a style="display:<?php  ?>" class="lnk" rel="contometro/informe_ContTanq.php">Informe de Cont&oacute;metros y Tanque</a>s</li>
				</ul>
			</li>
		</ul>
	</li>
	...
	<li class="current">
		...
		<ul>
			...
			<li><a style="display:<?php echo  $transferencia ?>" class="lnk" rel="reportes/buscasen.php">Busqueda Sensitiva Detalle</a></li>
			<li><a style="display:<?php echo  $compras ?>" class="lnk" rel="compras/cuadre_fisicoAlmacen.php?menu_temp=2">Cuadre Fsico de Almacen</a></li>
			...
			<li>
				...
				<ul>
					...
					<li><a style="display:<?php echo  $redocC ?>" class="lnk" rel="catalogo_prod.php">Catlogo de Productos</a></li>
		...
		<ul>
			<li class="current">
				...
				<ul>
					...
					<li><a style="display:<?php echo  $cuentasC ?>" class="lnk" rel="reportes/rpt_creditoxcliente.php">Crditos por Cliente</a></li>
				</ul>
			</li>
			<li class="current">
...
<!---------------------------------------------------Administracion------------------------------------------------->
	<li class="current">
		...
		<ul>
			...
			<li class="current">
				<a style="display:<?php echo  $articulos ?>" href="#">utiles</a>
				<ul>
