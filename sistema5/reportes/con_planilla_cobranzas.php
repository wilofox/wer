...
function mostrar_totales($mo,$tp,$whe){
	...
	$res=" <tr height='30' align='center'><td colspan='13' class='Detalle1' ><strong>TOTAL ".strtoupper($row_tot['patip'])." S/.: <span style='color=#0066FF'>".number_format($row_tot['totals'],2)."</span></strong></td></tr><tr height='30' align='center'><td colspan='13' class='Detalle1' ><strong>TOTAL ".strtoupper($row_tot['patip'])." US$.: <span style='color=#0066FF'>".number_format($row_tot['totald'],2)."</span></strong></td></tr>";
	//}
	$res.="|";
	//if($mo!=''){
	...
	$rs=mysql_query($sql,$cn);
	$row_tot=mysql_fetch_array($rs);
	$res.="<tr height='30' align='center'><td colspan='13' class='Detalle1' ><strong>TOTAL TIPO S/.: <span style='color=#0066FF'>".number_format($row_tot['totals'],2)."</span></strong></td></tr><tr height='30' align='center'><td colspan='13' class='Detalle1' ><strong>TOTAL TIPO US$.: <span style='color=#0066FF'>".number_format($row_tot['totald'],2)."</span></strong></td></tr>";
	//}
	$res.="|";
