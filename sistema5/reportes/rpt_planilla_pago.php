...
<table width="760" height="404" border="0" cellpadding="0" cellspacing="0">
    <tr style="background:url(../imagenes/white-top-bottom.gif)">
      ...
      <td width="760" height="25" colspan="11" style="border:#999999;"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="606"><span class="Estilo100">Finanzas :: Cuentas Proveedores :: Planilla de Pagos </span>
            <input type="hidden" name="carga" id="carga" value="N" />
		<input type="hidden" name="cod_user" id="cod_user" value="<?=$_SESSION['codvendedor'];?>" />
			</td>
          <td width="193"><b>Seleccionar Modalidad</b>
...
{		?>              <option value="<?php echo $row1['cod_suc'] ?>"><?php echo $row1['des_suc'] ?></option>
          ...
          <td width="83" class="Estilo25"><div align="right">Razon Social:</div></td>
    ...
    <tr>
      ...
      <td style="padding-top:10px">
        ...
        <tr  style="border:#999999 solid 1px;">
          <td width="22" align="center" bgcolor="#666666" class="text6"    >&nbsp;</td>
          ...
          <td width="92" bgcolor="#666666" class="text6" >C.P.</td>
          </tr>
        <tr  style="background:url(../imagenes/sky_blue_grid.gif); border:#999999 solid 1px">
          ...
          <td width="56" align="center"  style=" border:#CCCCCC solid 1px"><span class="texto2"><strong>Fec.Pago</strong></span></td>
          <td width="42" align="center"  style=" border:#CCCCCC solid 1px" ><span class="texto2"><strong>Td.</strong></span></td>
          <td width="71"  style=" border:#CCCCCC solid 1px" ><span class="texto2"><strong>N&deg; Doc. </strong></span></td>
          <td width="120"  style=" border:#CCCCCC solid 1px"><span class="texto2"><strong>CLIENTE</strong></span></td>
          <td width="59"  style=" border:#CCCCCC solid 1px"><span class="texto2"><strong>Vcto.Doc.</strong></span></td>
          <td width="72"  style=" border:#CCCCCC solid 1px"><span class="texto2"><strong>Total Doc.</strong></span></td>
          <td width="95"  style=" border:#CCCCCC solid 1px"><span class="texto2"><strong>Refer Doc.</strong></span></td>
          <td width="32"  style=" border:#CCCCCC solid 1px" ><span class="texto2"><strong>T.C.</strong></span></td>
          <td width="62"  style=" border:#CCCCCC solid 1px" ><span class="texto2"><strong>S/.</strong></span></td>
          <td width="64"  style=" border:#CCCCCC solid 1px" ><span class="texto2"><strong>US$.</strong></span></td>
          <td  style=" border:#CCCCCC solid 1px" ><span class="texto2"><strong>Tip.Pago</strong></span></td>
          </tr>
        <tr>
          <td colspan="13"><div id="detalle" style="width:800px; height:250px;" > </div></td>
        </tr>
      </table></td>
    </tr>
    <tr>
...
doAjax('det_planilla_pagos.php','fecha1='+fecha1+'&fecha2='+fecha2+'&sucursal='+sucursal+'&almacen='+almacen+'&cliente='+cliente+'&responsable='+responsable+'&agruparc='+agruparc+'&agrupard='+agrupard+'&pagina='+pagina+'&cod_user='+cod_user,'view_det','get','0','1','','');
...
doAjax('documentos.php','&temp='+temp+'&reporte=COBRANZAS&pagos','listadocumentos','get','0','1','','');
	}
}
...
//if(confirm("Seguro de Aceptar configuracin")){
	...
	doAjax('documentos.php','&docRk='+docRk+'&reporte=COBRANZAS','','get','0','1','','');
...
*/
	...
	win00=window.open('det_planilla_pagos.php?fecha1='+fecha1+'&fecha2='+fecha2+'&sucursal='+sucursal+'&almacen='+almacen+'&cliente='+cliente+'&responsable='+responsable+'&agruparc='+agruparc+'&agrupard='+agrupard+'&pagina='+pagina+'&cod_user='+cod_user+'&excel=',"","toolbar=no,status=no, menubar=no, scrollbars=yes,resizable=yes, width=620, height=520,left=50 top=50");
