	...
	try{
		for(var i=0;i<document.form1.Tienda.length;i++){
			if(document.form1.Tienda[i].checked){
				tienda=document.form1.Tienda[i].value+"|"+tienda;
				temp1=1;
			}
		}
	}catch(e){
		if(document.form1.Tienda.checked){
			tienda=document.form1.Tienda.value+"|";
			temp1=1;
		}
	}
	if(fecha1==''){
...
if(validar_form(document.form1)){	
	...
	htmlreporte="?chkSalidas="+chkSalidas+"&imprimir="+imprimir+"&fecha1="+fecha1+"&fecha2="+fecha2+"&sucursal="+sucursal+"&tienda="+tienda+"&clasificacion="+clasificacion+"&categoria="+categoria+"&subcategoria="+subcategoria+"&orden="+orden+"&mostrar="+mostrar+"&cant="+cant;
...
<table width="629" height="203" border="0" align="left"  cellpadding="0" cellspacing="0">
  <tr>
