      ...
      <td style="padding-top:10px">
        ...
        <tr  style="border:#999999 solid 1px;">
          <td width="25" align="center" bgcolor="#666666" class="text6"    >&nbsp;</td>
           <td width="93" bgcolor="#666666" class="text6" >C.P.</td>
        ...
        <tr  style="background:url(../imagenes/sky_blue_grid.gif); border:#999999 solid 1px">
          ...
          <td width="30"  style=" border:#CCCCCC solid 1px" ><span class="texto2"><strong>T.C.</strong></span></td>
          <td width="73"  style=" border:#CCCCCC solid 1px" ><span class="texto2"><strong>S/.</strong></span></td>
          <td width="73"  style=" border:#CCCCCC solid 1px" ><span class="texto2"><strong>US$.</strong></span></td>
          ...
          <td width="119"  style=" border:#CCCCCC solid 1px"><span class="texto2"><strong>CLIENTE</strong></span></td>
          <td width="84"  style=" border:#CCCCCC solid 1px" ><span class="texto2"><strong>Referencia </strong></span></td>
          <td width="75"  style=" border:#CCCCCC solid 1px"><span class="texto2"><strong>Vcto.Doc.</strong></span></td>
          <td width="103"  style=" border:#CCCCCC solid 1px"><span class="texto2"><strong>Total Doc.</strong></span></td>
          </tr>
        <tr>
...
doAjax('det_planilla_cobranzas.php','fecha1='+fecha1+'&fecha2='+fecha2+'&sucursal='+sucursal+'&almacen='+almacen+'&cliente='+cliente+'&responsable='+responsable+'&agruparc='+agruparc+'&agrupard='+agrupard+'&pagina='+pagina+'&cod_user='+cod_user+'&t_pago='+t_pago,'view_det','get','0','1','','');
...
*/
	...
	win00=window.open('det_planilla_cobranzas.php?fecha1='+fecha1+'&fecha2='+fecha2+'&sucursal='+sucursal+'&almacen='+almacen+'&cliente='+cliente+'&responsable='+responsable+'&agruparc='+agruparc+'&agrupard='+agrupard+'&pagina='+pagina+'&cod_user='+cod_user+'&excel=&t_pago='+t_pago,"","toolbar=no,status=no, menubar=no, scrollbars=yes,resizable=yes, width=620, height=520,left=50 top=50");
