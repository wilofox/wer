...
<table width="896" height="429"  align="center">
  ...
  <tr>
	...
	<input type="hidden" name="chktds_alma" value="<?php  $tds_alma=$_POST['chktds_alma'];
								 ...
								 <input type="hidden" name="cmbclas" value="<?php echo $cmbclas ?>" id="cboclas"/>
								 <input type="hidden" name="cmbcat" value="<?php echo $cmbcat ?>" id="cbocat"/>
								 <input type="hidden" name="cmbsub" value="<?php echo $cmbsub ?>" id="cbosub"/>
...
for($i=0;$i<count($cod_doc_i);$i++){							  																								$temp_cod_doc_i=$temp_cod_doc_i.$cod_doc_i[$i].'-';
}
...
echo $temp_cod_doc_s=substr($temp_cod_doc_s,0,strlen($temp_cod_doc_s)-1); ?>" id="chkSalidas"/>
    ...
    <td colspan="4" align="center"><?
		...
		?>				
		<!-- Del </span> <?php echo $fecha1;?><span class="Estilo27"> al </span><?php echo $fecha2;?>-->		</td>
  </tr>
  <tr>
...
//cod_suc ='$sucursal' AND 
  ...
  <tr>
    <td colspan="4" align="center">
	<div id="detalle">
	  <table width="781" height="61" border="0" cellpadding="1" cellspacing="1">
	    <tr>
...
//rpt_comp_stock_paginacion.php
	doAjax('rpt_comp_stock_paginacion.php','fecha1='+fecha1+'&fecha2='+fecha2+'&mostrar2='+mostrar2+'&checkbox='+checkbox+'&chk_tiendas='+chk_tiendas+'&chktds_alma='+chktds_alma+'&cboformato='+cboformato+'&cmbPres='+cmbPres+'&cmbValor='+cmbValor+'&txtorden='+txtorden+'&cboclas='+cmbclas+'&cbocat='+cmbcat+'&cbosub='+cmbsub+'&chkclas='+chkclas+'&chksub='+chksub+'&chkcat='+chkcat+'&cbosucursal='+cbosucursal+'&agr_cla='+agr_cla+'&agr_cat='+agr_cat+'&agr_sub='+agr_sub+'&chkIngresos='+chkIngresos+'&chkSalidas='+chkSalidas+'&Sistema='+Sistema+'&pagina='+pagina,'view_det','post','0','1','','');
