...
echo "<table><tr><td colspan='10' height='100px' valign='middle' align='center' style='font-size:18px;font:bold' >Reporte  Creditos por cliente</td></tr>
<tr class='c_texto'><td  colspan='10'><b>fecha:".date("d-m-Y")."</b></td></tr>
<tr class='c_texto'><td colspan='10'><b>De ".$_REQUEST['fecha1']." al ".$_REQUEST['fecha2']."</b></td></tr>
</table>";
}
?>
<style>
...
<div id="detalle" style="width:2000px; height:200px; overflow:auto ; padding-left:10px; font-size:10px" >

 <table border="0" cellpadding="0" cellspacing="1">
        <tr  style="border:#999999 solid 1px;" bgcolor="#CCCCCC">
          <td width="58" align="center"  class="text6"><b>Loc.</b></td>
		  <td width="100"  class="text6" ><b>F. Emis.</b></td>
		    <td width="110" align="center"  class="text6"><strong>Doc.</strong></td>
			<td width="125"  class="text6"><strong>Condicion</strong></td>
			<td width="150"  class="text6"><strong> Cliente </strong></td>
			<td width="200" style=" border:#CCCCCC solid 1px"><span class="texto2"><strong>Chofer</strong></span></td>
			<td width="80"  style=" border:#CCCCCC solid 1px"><span class="texto2"><strong>DNI</strong></span></td>
		    <td width="56"  style=" border:#CCCCCC solid 1px"><span class="texto2"><strong>Placa</strong></span></td>
			<td width="100"  class="text6"><strong>Referencia </strong></td>
			<td width="70" style=" border:#CCCCCC solid 1px" ><span class="texto2"><strong>C&oacute;digo</strong></span></td>

          <td width="100" style=" border:#CCCCCC solid 1px"><span class="texto2"><strong>Descripcion</strong></span></td>
		  <td width="30"   style=" border:#CCCCCC solid 1px"><span class="texto2"><strong>Gls</strong></span></td>
          <td width="65"  style=" border:#CCCCCC solid 1px" ><span class="texto2"><strong>P.Unit.</strong></span></td>
          <td width="80"  style=" border:#CCCCCC solid 1px" ><span class="texto2"><strong>Total</strong></span></td>
    </tr>
</table>
 <br/>
<?php
...
order by fecha";
	...
	while($row=mysql_fetch_array($resultado2)){
		...
		<table width="763" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td style="color:#000066; font-size:12px;" colspan="10"><b>
			<?
			if ($agruparc==0){
			echo $row['cliente'];
			//echo '&nbsp;&nbsp;&nbsp;';
...
".$FilSR."   ".$FilTE."  ".$FilDocInc."	 ".$TransRk."	
 ...
 <?php
		...
		/*	echo '<tr><td colspan="16"align="right" style="color:#000066"><b>------------------------------------------<br>';
...
while($row4=mysql_fetch_array($resultado4)){
  ...
  <tr class="c_texto">
	 ...
	 <td width="30" align="center" ><?=$row3['almacen'];?></td>

    <td width="100" ><?=formatobarrafecha(substr($row3['fecha'],0,10));?></td>
	<td width="110" align="center" ><?=$row3['cod_ope']." ".$row3['Num_doc'];?></td>
	<td width="90" ><?=caracteres($row3['nombre']); ?></td>
	    <td width="150" title="<?=caracteres($row3['razonsocial']);?>" ><? echo substr(caracteres($row3['razonsocial']), 0, 12)  ?></td>
<td width="200"><?php echo $nomchof ?></td>
<td width="80"><?php echo $dnichof ?></td>
<td width="60"><?php echo $placatrans ?></td>
    <td width="100" ><?=caracteres($row3['flag_r']); ?></td>
    <td width="70" align="center" ><?php echo $row4['cod_prod'] ?></td>
    <td width="100" title="<?=$row4['nom_prod'];?>" ><? echo substr(caracteres($row4['nom_prod']), 0, 40)  ?></td>
    	<td width="30" align="center" ><?php echo $row4['cantidad'] ?></td>
    <td width="60" align="center" ><?php echo number_format($row4['precio']+0.0000,4)/*echo number_format($row3['total']/$row4['cantidad'],2)*/  ?></td>
	    <td width="80" align="right"><?php echo number_format($row4['precio']*$row4['cantidad'],2) ?>	
	<? 
	if ($row3['moneda']=='01'){
	...
	<tr>
    <td  align="right" colspan='14'><? /*if ($row3['moneda']=='01'){echo'S/.';}else{echo'US$.';}  ?> <?=$row3['total'];*/ ?></td>
  </tr>
		...
		<?php 
			...
			/*echo '<tr><td colspan="16"align="right" style="color:#000066;text-align:right"><b>------------------------------------------<br>';
			echo 'TOTAL DOC. (S/.) &nbsp;&nbsp;&nbsp;'.number_format($TolSoles,2).'&nbsp;&nbsp;&nbsp;<br>';
			echo 'TOTAL DOC. (US$.) &nbsp;&nbsp;&nbsp;'.number_format($TolDolares,2).'&nbsp;&nbsp;&nbsp;</b><br><br>					<br></td></tr>';*/
		}
		?>	
</table>
<?
...
echo '<div align="right" style=" padding-right:15px"><b>------------------------------------------<br>';
