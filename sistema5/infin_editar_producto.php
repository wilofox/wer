...
<form action="" method="post"  name="form1" id="form1"  enctype="multipart/form-data" >
  ...
  <table width="624" height="497" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td bgcolor="#FAF3E2"><input name="codprod3" type="text" value="<?php echo $codprod3;?>" size="30" maxlength="25" onKeyUp="saltar_campo(event,this)"></td>
    </tr>
    <tr>
      <td height="22" bgcolor="#FAF3E2">&nbsp;</td>
    ...
    <tr>
	  ...
	  <select name="und" id="und" onChange="validarSubunidad()" style="width:160px"  >
	  <?php 	  
   ...
   ?>
    ...
    <tr>
      <td height="22" bgcolor="#FAF3E2">&nbsp;</td>
      <td bgcolor="#FAF3E2"><span class="Estilo56">Factor Princ. </span></td>
      <td colspan="2" rowspan="4" bgcolor="#FAF3E2"><table width="504" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="24"><input name="factor" type="text" value="<?php echo $factor;?>" size="5" maxlength="10" />
          <span class="Estilo56">Factor Comp. </span>
		  <input name="factorC" type="text" value="<?php echo $factorC;?>" size="5" maxlength="10" />
		  </td>
          <td ><span class="Estilo56"  style="visibility:hidden">Sub-Unidad
            <?php 
	 ...
	 for (i=0;i<document.form1.clasificacion.options.length;i++)
        {
		  ...
		  <input name="txtclasificacion" type="text" id="txtclasificacion" onKeyUp="validartecla(event,this,'#auxiliares')" onFocus="validartecla(event,this,'#auxiliares')" onBlur="javascript:templ=0" size="18" maxlength="50" autocomplete="off" value="<?php echo $nomclas ?>">
            <input name="hdclasificacion" type="hidden" id="hdclasificacion"  size="3" value="<?php echo $clasificacion ?>"/>
		  </td>
...
while($row0=mysql_fetch_array($resultados0))
{
	  ...
	  ?>
		  ...
		  <input name="txtcategoria" type="text" id="txtcategoria" onKeyUp="validartecla(event,this,'#auxiliares')" onFocus="validartecla(event,this,'#auxiliares')" onBlur="javascript:templ=0" size="18" maxlength="50" autocomplete="off" value="<?php echo $nomcat ?>"><input name="hdcategoria" type="hidden" id="hdcategoria"  value="<?php echo $categoria ?>" size="3"/></td>
          <td width="304"><span class="Estilo56"  style="visibility:visible">Series
...
while($row0=mysql_fetch_array($resultados0))
{
    ...
    <tr>
      <td height="23" bgcolor="#FAF3E2">&nbsp;</td>
      <td bgcolor="#FAF3E2"><span class="Estilo56"><?=$CatgNomEti3;?></span></td>
    </tr>
    <tr>
