...
//echo "select * from tienda where cod_suc='$codsuc' order by des_tienda";
?>
 <select  style="width:160" name="almacen" onfocus="enfocar_cbo(this);limpiar_enfoque(this)" onChange="cambiar_enfoque(this);">
...
<option value="<?php echo $row1['cod_tienda'] ?>"> <?php echo $row1['des_tienda'] ?></option>
		 ...
		 ?>
	  			  ...
	  			  <input type="hidden" name="dir_tienda" value="<?php echo htmlspecialchars($dir_tienda) ?>" />
