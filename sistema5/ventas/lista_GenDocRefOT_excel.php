...
<table width="905" border="0">
  <tr>
    <td  align="center"></td>
    <td colspan="11" align="center"><span class="Estilo1">Reporte Seguimiento O.T. </span></td>
  </tr>
  <tr>
    <td  align="center"></td>
...
<table width="773"  border="0" cellpadding="0" cellspacing="1">
  ...
  <?php 
		...
		//------------------------------------------
			...
			$inifec=explode("-",$fec1);
			$finfec=explode("-",$fec2);
			$tpOrder=$_REQUEST['tporden'];
			if($tpOrder!=""){
			$filtroOrden=" order by  C.razonsocial ".$tpOrder; 
			}else{
			$filtroOrden=" ";
			}
...
inner join cliente C on CM.cliente =C.codcliente 	
$SQLConsulta and fecha between '".$inifec[2]."-".$inifec[1]."-".$inifec[0]."' and '".$finfec[2]."-".$finfec[1]."-".$finfec[0]."' $filtroOrden ";
...
?>
  ...
  <tr  onClick="entrada(this)" onDblClick="doc_det(this)"  >
      <td width="1" align="center"></td>
             ...
             <td width="88" align="center"  class="texto1"><?php echo substr($row['fecha'],0,10)?></td>	
			  <td width="96" align="center" class="texto1"><?php echo $row['serie'].'-'.$row['Num_doc']; ?></td>	
              <td width="184" class="texto1"><?php echo $row['razonsocial']?></td>
			  ...
			  if ($row['monedaSD']=='02'){echo 'US$.';}else{echo 'S/.';}
			   ...
			   ?></td>
              <td width="74" align="right" class="texto1" ><?php 
	...
	echo $row['total'];
			  ...
			  ?></td>
			  <td width="128" align="right" class="texto1" >
			  <?php 
	...
	echo formatofecha(substr($rowR['fecha'],0,10)).'-|-'.$rowR['Num_doc'];		
			   ...
			   ?></td>			  
			  <td width="54" align="center" class="texto1" ><?php echo $row['tienda']?></td>	
			  <td width="32" align="right" class="texto1" ><?php  if ($row['archivo']<>''){ echo 'X';}?></td>
			  <td width="54" align="center" class="texto1" ><?php if ($row['obs1']<>''){ echo '-|-'; }; ?></td>	
