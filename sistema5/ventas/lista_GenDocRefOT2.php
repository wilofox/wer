  ...
  <tr bgcolor="<?php echo $color_row?>" onClick="entrada(this)" ondblclick="doc_det(this)" >
	  ...
	  <? } ?>	  </td>
             <td width="117" class="texto1"><?php echo $row['fecha']?></td>	
              ...
              <td width="194" class="texto1"><?php echo $row['razonsocial']?></td>
              <td width="156" align="center" class="texto1"><?php echo $row['dirDestino']?></td>
              <td width="17" align="right" class="texto1"><?  
			  if($moneda==''){
			  ...
			  if ($row['monedaSD']=='02'){echo 'US$.';}else{echo 'S/.';}
			   ...
			   ?></td>
			  <td width="71" align="right" class="texto1"><?php 
	...
	echo $row['total'];
			  ...
			  ?></td>			  
			  <td colspan="3" width="122" align="center" class="texto1"><?php 
