...
//echo "entro";
 $accion=$_REQUEST['accion'];
	 ...
	 if($accion=='n'){
		$clase->new_area_costos($id,$costo);
	}

	if($accion=='e'){
	//echo  $_REQUEST['codigo'];
		$clase->act_area_costos($id,$costo);
	}
...
<table width="400" height="200" border="1" cellpadding="0" cellspacing="0">
  ...
  <table width="792" height="169" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" >
    <tr style="background:url(../imagenes/white-top-bottom.gif)">
       <td height="27" colspan="13" style="border:#999999">&nbsp;<span class="Estilo34">Mantenimientos :: <span class="Estilo14 Estilo38">Tipos de Negocio </span></span></td>
    </tr>
    <tr>
      <td width="792" colspan="7"><table width="98%" height="21" border="0" cellpadding="0" cellspacing="0" style="border-bottom:#CCCCCC solid 1px">
        <tr>
          ...
          <td width="106" ><table title="Nuevo[F3]" width="85" height="21" border="0" cellpadding="0" cellspacing="0">
              <tr onMouseOver="entrar_btn(this);" onMouseOut="salir_btn(this)" style="cursor:pointer" onClick="javascript: doAjax('new_area_costo.php','accion=n','nuevo_suc','get','0','1','','');" >
                <td width="1" ></td>
          ...
          <tr>
            ...
            <td width="70"><label>
              <select name="tipo" id="tipo" style="visibility:visible">
                ...
                <option value="nombre" selected>Costo</option>
              </select>
            </label></td>
            <td width="144"><label>
    ...
    <tr >
      <td height="25" colspan="8" align="center" class="EstiloTexto1">
	  <table width="617" border="0" cellpadding="0" cellspacing="0" style="border-bottom:#CCCCCC solid 1px">
        <tr>
          <td width="120" height="24" class="EstiloTexto1">Procesos del &Aacute;rea :&nbsp;&nbsp;            </td>
          <td width="360">&nbsp;
          <label class="EstiloTexto2" id="desArea"></label></td>
    ...
    <tr>
      <td colspan="8"><div id="resultado2"></div><div id="paginacion2"></div></td>
    </tr>
    <tr>
      <td colspan="8">&nbsp;</td>
    </tr>
...
doAjax('new_area_costo.php','accion=e&cod='+cod,'nuevo_suc','get','0','1','','');
//}
}
...
//alert(texto);
doAjax('listareacostos.php','condicion='+cond+'&texto='+texto+'&pag='+pag,'view_det','get','0','1','','');
}
...
obj.parentNode.parentNode.cells[3].childNodes[0].disabled=false;
...
obj.parentNode.parentNode.cells[5].childNodes[0].readOnly=false;
obj.parentNode.parentNode.cells[5].childNodes[0].style.background="#FFFFFF";
obj.parentNode.parentNode.cells[5].childNodes[0].style.border=" solid 1px";

obj.parentNode.parentNode.cells[6].childNodes[0].disabled=false;
obj.parentNode.parentNode.cells[7].style.display="none";
obj.parentNode.parentNode.cells[8].style.display="block";
...
function saveRow(idProcxArea,obj){
	...
	obj.parentNode.parentNode.cells[3].childNodes[0].disabled=true;
	...
	obj.parentNode.parentNode.cells[5].childNodes[0].readOnly=true;
	obj.parentNode.parentNode.cells[5].childNodes[0].style.background="none";
	obj.parentNode.parentNode.cells[5].childNodes[0].style.border="none";
	
	obj.parentNode.parentNode.cells[6].childNodes[0].disabled=true;
	obj.parentNode.parentNode.cells[7].style.display="block";
	obj.parentNode.parentNode.cells[8].style.display="none";
	
    var orden=obj.parentNode.parentNode.cells[0].childNodes[0].value;
	var unidad=obj.parentNode.parentNode.cells[3].childNodes[0].value;
	var costo1=obj.parentNode.parentNode.cells[4].childNodes[0].value;
	var costo2=obj.parentNode.parentNode.cells[5].childNodes[0].value;
	var cCosto=obj.parentNode.parentNode.cells[6].childNodes[0].value;
	...
	var arrayCodProc=idProcxArea+"|"+costo1+"|"+costo2+"|"+cCosto+"|"+orden+"|"+unidad;
