...
<tr height="20px" style="background:url(../imagenes/sky_blue_grid.gif); border:#999999 solid 1px">
      ...
      <td  width="50" align="center" style=" border:#CCCCCC solid 1px" class="EstiloTexto1">N.</td>
      <td   width="70" align="center" style=" border:#CCCCCC solid 1px" class="EstiloTexto1">Unidad</td>
    ...
    </tr><tr><td colspan="5"><div style="position:relative;width:550px;height:250px;overflow:auto;border:0px solid;padding:0px;margin:0px;"><table border="0" align="left">' ;
	  $temcat="";
	while($row=mysql_fetch_array($resultados)){
	//if($row['des_cat']!=$temcat){
 		//echo '<tr  bgcolor="#EEEEEE"><td colspan="8"><b>'.$row['des_cat'].'</b<</td></tr>';
...
<tr height="20px" style="background:url(../imagenes/sky_blue_grid.gif); border:#999999 solid 1px">
	...
	while($row=mysql_fetch_array($resultados)){
	 ...
	 echo '<tr bgcolor="#FFFFFF" >
		  ...
		  <td width="50" align="center"><span class="Estilo12">'.$row['id'].'</span></td>
		  <td width="200"><span class="Estilo12">'.$row['ccosto'].'</span></td>
		  <td width="45" align="center"><a href=\'javascript:editar( "'.$row['id'].'");\'><img src="../imgenes/ico_edit.gif" border="0"></a></td>
		  <td width="45" align="center"><a href=\'javascript:eliminar("'.$row['id'].'");\'><img src="../imgenes/eliminar.gif" border="0"></a></td>
		</tr>';
		//$temcat=$row['des_cat'];
...
<tr height="20px" style="background:url(../imagenes/sky_blue_grid.gif); border:#999999 solid 1px" >
	...
	while($row=mysql_fetch_array($resultados)){
	 ...
	 echo '<tr  bgcolor="#FFFFFF" onclick="entrada2(this)">
		  ...
		  <td width="160" align="center" class="Estilo12">'.$nombreProc.'</td>
...
function new_tpagos($id,$ncodigo,$ndescripcion,$nformato,$ncola,$modalidad){

//list($idcho,$nomcho)=explode("?",$cho);
	$strSQL2= "insert into t_pago (id,codigo,descripcion,formato,cola,modalidad)values ($id,'$ncodigo','$ndescripcion','$nformato','$ncola','$modalidad')";
		//echo $strSQL2;		
	mysql_query($strSQL2);
...
function act_tpagos($id,$ncodigo,$ndescripcion,$nformato,$ncola,$modalidad){
/*echo "<script>if(confirm('Esta seguro que desea eliminar esta unidad?')){}</script>";*/
$strSQL="update t_pago set codigo='".$ncodigo."',descripcion='".$ndescripcion."',formato='".$nformato."',cola='".$ncola."',modalidad='".$modalidad."' where id=".$id;
//echo $strSQL;
mysql_query($strSQL);
