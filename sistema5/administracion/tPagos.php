...
//echo "entro";
 $accion=$_REQUEST['accion'];
	 ...
	 if($accion=='n'){
		$clase->new_tpagos($id,$codigo,$descripcion,$formato,$cola,$modalidad,$cc1,$cc2,'');
		//new_tpagos($id,$ncodigo,$ndescripcion,$nformato,$ncola,$modalidad,$permiso){
	}

	if($accion=='e'){
	//echo  $_REQUEST['codigo'];
		$clase->act_tpagos($id,$codigo,$descripcion,$formato,$cola,$modalidad,$cc1,$cc2,'');
	}
	if($accion=='el' && isset($_REQUEST['codigo'])){
	//echo $_REQUEST['cod'];
		$clase->elim_tpagos($_REQUEST['codigo']);
	}
...
cargar_combos('temp_modalidad',"modalidad");
}
...
evt.keyCode=0;
	evt.returnValue=false;
//	alert("m");
doAjax('new_tpago.php','accion=n','nuevo_suc','get','0','1','','');
return false; });
...
<body onLoad="cargar_datos(0)">
  ...
  <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC" >
      <tr style="background:url(../imagenes/white-top-bottom.gif)">
       <td height="27" colspan="13" style="border:#999999"><span class="Estilo34">Administraci&oacute;n :: <span class="Estilo14 Estilo38">Tipos de Pago  </span></span></td>
    </tr>
	<tr>
      <td colspan="7"><table width="99%" height="21" border="0" cellpadding="0" cellspacing="0" style="border-bottom:#CCCCCC solid 1px">
        <tr>
          ...
          <td width="76" ><table title="Nuevo[F3]" width="85" height="21" border="0" cellpadding="0" cellspacing="0">
              <tr onMouseOver="entrar_btn(this);" onMouseOut="salir_btn(this)" style="cursor:pointer" onClick="javascript: doAjax('new_tpago.php','accion=n','nuevo_suc','get','0','1','','');" >
                <td width="1" ></td>
...
doAjax('new_tpago.php','accion=e&cod='+cod,'nuevo_suc','get','0','1','','');
//}
}
function eliminar(cod){

	if(confirm('Esta seguro que desea eliminar ?')){
	location.href='tPagos.php?accion=el&codigo='+cod;
	//this.form1.submit();
	}
...
doAjax('lista_tpagos.php','condicion='+cond+'&texto='+texto+'&pag='+pag,'view_det','get','0','1','','');
