...
//echo "entro";
 $accion=$_REQUEST['accion'];
    ...
    switch($accion){
        case 'n':$clase->new_zonas($idclasificacion,$nombre);break;
        case 'e':$clase->act_zonas($idclasificacion,$nombre);break;
        case 'el':$clase->elim_zonas($idclasificacion);break;
    }
...
evt.keyCode=0;
	evt.returnValue=false;
//	alert("m");
 doAjax('new_zonas.php','accion=n','nuevo_suc','get','0','1','','');
...
<?php
  ...
  <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC" >
    <tr style="background:url(../imagenes/white-top-bottom.gif)">
       <td height="27" colspan="13" style="border:#999999">&nbsp;<span class="Estilo34">Auxiliares :: <span class="Estilo14 Estilo38">Zonas</span></span></td>
    </tr>
	<tr>
      <td colspan="7"><table width="99%" height="21" border="0" cellpadding="0" cellspacing="0" style="border-bottom:#CCCCCC solid 1px">
        <tr>
          ...
          <td width="76" ><table title="Nuevo[F3]" width="102" height="21" border="0" cellpadding="0" cellspacing="0">
              <tr onMouseOver="entrar_btn(this);" onMouseOut="salir_btn(this)" style="cursor:pointer" onClick="javascript: doAjax('new_zonas.php','accion=n','nuevo_suc','get','0','1','','');" >
                <td width="1" ></td>
      ...
      <td colspan="7"><form name="formbuscar" method="post" action="?" onSubmit="return false"><table width="329" border="0" align="center">
          <tr>
            ...
            <select name="cbtipo" id="cbtipo">
              ...
              <option value="zona" selected>Nombre</option>
              </select>
            </label></td>
            <td width="18"><label>
...
function editar(cod){
//alert(cod);
	if(confirm('Esta seguro que desea editar esta Zona puede tener clientes/Vendedores Asignados')){
doAjax('new_zonas.php','accion=e&cod='+cod,'nuevo_suc','get','0','1','','');
}
}
...
function eliminar(cod){
	...
	location.href='m_zonas.php?accion=el&codigo='+cod;
	//this.form1.submit();
	}
...
doAjax('listzonas.php','tipo='+cond+'&texto='+texto+'&pag='+pag,'view_det','get','0','1','','');
