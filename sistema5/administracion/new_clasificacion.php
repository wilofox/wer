...
list($cid,$cnombre,$ccprecio,$cctipo)=$clase->consulta_clasificacion($_REQUEST['cod']);
}
    ?>
...
<table width="270" height="72" border="1" cellpadding="0" cellspacing="0" bgcolor="#DDDDDD">
  <tr>
    <td><table width="268" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFE7D7">
      ...
      <tr bgcolor="#003399">
        <td width="8">&nbsp;</td>
        <td colspan="6"><strong><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Clasificaci&oacute;n</font></strong></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
        ...
        <td colspan="6"><table width="251" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td colspan="3" style="color:#000000"><font face="Verdana, Arial, Helvetica, sans-serif" size="1px"><strong>
              <?php if($_REQUEST['accion']=="n"){echo $clase->cod_autogenerado('codigo','clas_clie');}else{ echo $cid;}?>
              <input name="codigo" type="hidden" id="codigo"  value="<?php if($_REQUEST['accion']=="n"){echo $clase->cod_autogenerado('codigo','clas_clie');}else{ echo $cid;}?>"/>
              <input type="hidden" name="precio2" value="<?php echo $ccprecio?>" />
            </strong></font></td>
          </tr>
         <!-- <tr>
          ...
          <tr>
            ...
            <td colspan="3"><font face="Verdana, Arial, Helvetica, sans-serif" size="1px"><strong>
              <?php /*?><input name="precio" type="text" id="precio"  style="height:18; font-size:10px" value="<?php echo $ccprecio?>" size="20"  onkeypress="return val_numeros(event)" /><?php */?>
			  			  
              <select name="precio">
                <option value="precio1">precio1</option>
                <option value="precio2">precio2</option>
                <option value="precio3">precio3</option>
                <option value="precio4">precio4</option>
                <option value="precio5">precio5</option>
		            ...
		            <tr>
            <td height="27" style="color:#000000"><font face="Verdana, Arial, Helvetica, sans-serif" size="1px"><strong>Tipo  :</strong></font></td>
            <td colspan="3"><font face="Verdana, Arial, Helvetica, sans-serif" size="1px"><strong>
              <input name="tipo" type="text" id="tipo"  style="height:18; font-size:10px" value="<?php echo $cctipo?>" size="20" maxlength="1" />
            </strong></font></td>
          </tr>
        </table></td>
        </tr>
