...
//echo "entro";
 $accion=$_REQUEST['accion'];
	 ...
	 if($accion=='n'){
		$clase->new_procesos($id,$nombre,$descripcion);
	}

	if($accion=='e'){
	//echo  $_REQUEST['codigo'];
		$clase->act_procesos($id,$nombre,$descripcion);
	}
	if($accion=='el' && isset($_REQUEST['codigo'])){
	//echo $_REQUEST['cod'];
		$clase->elim_procesos($_REQUEST['codigo']);
	}
...
event.keyCode=0;
	event.returnValue=false;
//	alert("m");
 doAjax('new_proceso.php','accion=n','nuevo_suc','get','0','1','','');
...
<?php
  ...
  <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC" >
       ...
       <td height="27" colspan="13" style="border:#999999"><span class="Estilo34">Mantenimientos :: <span class="Estilo14 Estilo38">Actividades de Obra  </span></span></td>
    </tr>
    <tr>
      <td colspan="7"><table width="99%" height="21" border="0" cellpadding="0" cellspacing="0" style="border-bottom:#CCCCCC solid 1px">
        <tr>
          ...
          <td width="76" ><table title="Nuevo[F3]" width="85" height="21" border="0" cellpadding="0" cellspacing="0">
              <tr onMouseOver="entrar_btn(this);" onMouseOut="salir_btn(this)" style="cursor:pointer" onClick="javascript: doAjax('new_proceso.php','accion=n','nuevo_suc','get','0','1','','');" >
                <td width="1" ></td>
...
doAjax('new_proceso.php','accion=e&cod='+cod,'nuevo_suc','get','0','1','','');
//}
}
function eliminar(cod){

	if(confirm('Esta seguro que desea eliminar ?')){
	location.href='procesos.php?accion=el&codigo='+cod;
	//this.form1.submit();
	}
...
doAjax('lista_procesos.php','condicion='+cond+'&texto='+texto+'&pag='+pag,'view_det','get','0','1','','');
