...
if(isset($_REQUEST['cod'])){
	//,$ccprecio,$cctipo
list($cid,$cnombre)=$clase->consulta_zonas($_REQUEST['cod']);
}
    ?>
...
<table width="270" height="72" border="1" cellpadding="0" cellspacing="0" bgcolor="#DDDDDD">
  <tr>
    <td><table width="268" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFE7D7">
      ...
      <tr bgcolor="#003399">
        <td width="8">&nbsp;</td>
        <td colspan="6"><strong><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Zonas</font></strong></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
        ...
        <td colspan="6"><table width="251" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td colspan="3" style="color:#000000"><font face="Verdana, Arial, Helvetica, sans-serif" size="1px"><strong>
              <?php if($_REQUEST['accion']=="n"){echo $clase->cod_autogenerado2('codigo','zonas','A');}else{ echo $cid;}?>
              <input name="codigo" type="hidden" id="codigo"  value="<?php if($_REQUEST['accion']=="n"){echo $clase->cod_autogenerado2('codigo','zonas','A');}else{ echo $cid;}?>"/>
            </strong></font></td>
          </tr>
         <!-- <tr>
            ...
            <td colspan="3"><font face="Verdana, Arial, Helvetica, sans-serif" size="1px"><strong>
              <input name="nombre" type="text" id="nombre"  style="height:18; font-size:10px" value="<?php //echo $nombre?>" size="20" onkeypress="return val_letras(event);" />
                 ...
                 <td><input autocomplete="off" id="nombre" name="nombre" type="text" size="20" maxlength="50"  style="height:18; font-size:10px" value="<?php if(isset($cnombre)){echo $cnombre;}else{echo "";} ?>" />
                  </span></td>
         </tr>
         <!-- <tr>
