...
//echo "entro";
 $accion=$_REQUEST['accion'];
	 ...
	 if($accion=='n'){
		$clase->new_costos($id,$costo);
	}

	if($accion=='e'){
	//echo  $_REQUEST['codigo'];
		$clase->act_costos($id,$costo);
	}
	if($accion=='el' && isset($_REQUEST['cod'])){
	//echo $_REQUEST['cod'];
		$clase->elim_costos($_REQUEST['cod']);
	}
...
event.keyCode=0;
	event.returnValue=false;
//	alert("m");
 doAjax('new_costo.php','accion=n','nuevo_suc','get','0','1','','');
...
<?php
  ...
  <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC" >
     <tr style="background:url(../imagenes/white-top-bottom.gif)">
       <td height="27" colspan="13" style="border:#999999"><span class="Estilo34">Mantenimientos :: <span class="Estilo14 Estilo38">Centro de  Costos </span></span></td>
    </tr>
      ...
      <td colspan="7"><table width="98%" height="21" border="0" cellpadding="0" cellspacing="0" style="border-bottom:#CCCCCC solid 1px">
        <tr>
          ...
          <td width="76" ><table title="Nuevo[F3]" width="85" height="21" border="0" cellpadding="0" cellspacing="0">
              <tr onMouseOver="entrar_btn(this);" onMouseOut="salir_btn(this)" style="cursor:pointer" onClick="javascript: doAjax('new_costo.php','accion=n','nuevo_suc','get','0','1','','');" >
                <td width="1" ></td>
      ...
      <td colspan="7"><form name="formbuscar" method="post" action="?" onSubmit="return false"><table width="329" border="0" align="center">
          <tr>
            ...
            <select name="tipo" id="tipo">
              ...
              <option value="ccosto" selected>Costo</option>
              </select>
            </label></td>
            <td width="18"><label>
...
doAjax('new_costo.php','accion=e&cod='+cod,'nuevo_suc','get','0','1','','');
//}
}
...
function eliminar(cod){
	...
	location.href='m_costo.php?accion=el&cod='+cod;
	//this.form1.submit();
	}
...
doAjax('listcostos.php','condicion='+cond+'&texto='+texto+'&pag='+pag,'view_det','get','0','1','','');
