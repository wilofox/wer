...
//echo "entro";
 $accion=$_REQUEST['accion'];
				...
				$cprecio=$_REQUEST['precio'];
				$ctipo=$_REQUEST['tipo'];
					
	 if($accion=='n'){
		$clase->new_clasificacion($idclasificacion,$nombre,$cprecio,$ctipo);
	}

	if($accion=='e'){
	//echo  $_REQUEST['codigo'];
		$clase->act_clasificacion($idclasificacion,$nombre,$cprecio,$ctipo);
	}
...
seleccionar_cbo('precio',document.form1.precio2.value);
}
...
evt.keyCode=0;
	evt.returnValue=false;
//	alert("m");
 doAjax('new_clasificacion.php','accion=n','nuevo_suc','get','0','1','','');
...
<?php
  ...
  <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC" >
    <tr style="background:url(../imagenes/white-top-bottom.gif)">
       <td height="27" colspan="13" style="border:#999999">&nbsp;<span class="Estilo34">Administraci&oacute;n :: Auxiliares :: <span class="Estilo14 Estilo38">Clasificaci&oacute;n</span></span></td>
    </tr>
	<tr>
      <td colspan="7"><table width="99%" height="21" border="0" cellpadding="0" cellspacing="0" style="border-bottom:#CCCCCC solid 1px">
        <tr>
          ...
          <td width="76" ><table title="Nuevo[F3]" width="102" height="21" border="0" cellpadding="0" cellspacing="0">
              <tr onMouseOver="entrar_btn(this);" onMouseOut="salir_btn(this)" style="cursor:pointer" onClick="javascript: doAjax('new_clasificacion.php','accion=n','nuevo_suc','get','0','1','','');" >
                <td width="1" ></td>
...
doAjax('new_clasificacion.php','accion=e&cod='+cod,'nuevo_suc','get','0','1','','');
}
}
...
doAjax('listclasificacion.php','tipo='+cond+'&texto='+texto+'&pag='+pag,'view_det','get','0','1','','');
