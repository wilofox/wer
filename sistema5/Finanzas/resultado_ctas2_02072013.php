...
if($sucursal=="0"){
	$filtro_multi=" and cab_mov.cod_ope not in ('NC','TN') and cab_mov.deuda='S' and cab_mov.tipo='$tipo' ";
}else{
	if($tienda=="0"){
		$filtro_multi=" and sucursal='$sucursal' and cab_mov.cod_ope not in ('NC','TN') and cab_mov.deuda='S' and cab_mov.tipo='$tipo' ";
	}else{
		$filtro_multi=" and tienda='$tienda' and sucursal='$sucursal' and cab_mov.cod_ope not in ('NC','TN') and cab_mov.deuda='S' and cab_mov.tipo='$tipo' ";
	}
}
		 		 
	$strSQL_pagos="SELECT *,cab_mov.moneda as mon FROM pagos INNER JOIN cab_mov ON cab_mov.cod_cab=pagos.referencia WHERE DATE(pagos.fecha) between '".$fecha1."' and '".$fecha2."' and cliente='".$codigo."'".$filtro_multi;
	...
	$strSQL_pagos="SELECT NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,cab_mov.*,moneda as mon from cab_mov where DATE(substr(cab_mov.fecha,1,10)) < '".$fecha2."' and cliente='".$codigo."'".$filtro_multi.$doc1." UNION ".$strSQL_pagos;
	$dp=0;
	$doc="";
	...
	$strSQL_saldo="select * from cab_mov where tipo='$tipo' ".$doc;
...
?>	
    ...
    <td width="232" rowspan="5"><table width="193" height="90" border="0"  align="left" cellpadding="0" cellspacing="0" style="border:#CCCCCC solid 1px">
      ...
      <tr>
        <td class="Estilo7">&nbsp;</td>
        <td height="42" class="Estilo7"><input readonly="readolnly" name="fecha_ini" type="text" size="10" maxlength="10" value="<?php echo formatofecha($fecha1)?>"></td>
        <td class="Estilo7"><input name="fecha_fin" type="text" readonly="readolnly" size="10" maxlength="10" value="<?php echo formatofecha($fecha2)?>"></td>
      </tr>
    </table></td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="8"><span class="Estilo7">
      ...
      <input style="background-color:#FFF1BB" readonly="readonly" name="descripcion" type="text" size="47" maxlength="200" value="<?php echo $descripcion;?>">
...
&nbsp;</span></td>
  ...
  <tr>
    ...
    <td width="82"><input readonly="readolnly" name="textfield" type="text" size="12" maxlength="10" value="<?php echo $docs;?>"></td>
  ...
  <tr>
    ...
    <td width="109" class="Estilo117">
      <input name="saldo_ini_s" readonly="readonly" type="text" size="10" maxlength="10" value="<?php echo $saldo_ant_s; ?>">
    </span></td>
...
//	if($cont10>1){	 
	...
	while($row10=mysql_fetch_array($resultados10)){
		...
		$strpagos="Select pagos.* from pagos WHERE fecha>='$fecha1' and referencia='".$referencia."' ORDER BY fechap";
