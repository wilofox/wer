...
<form name="form1" method="post" action="">
      <table width="790" height="450" border="0" cellpadding="0" cellspacing="0">
        <tr style="background:url(../imagenes/white-top-bottom.gif)">
          <td width="790" height="22" colspan="6" align="left" style="border:#999999"><span class="Estilo100 Estilo24"><span class="Estilo103"><?php echo $titu; ?>
        ...
        <tr >
          <td height="108" colspan="6" align="left"><table width="783" border="0" cellpadding="0" cellspacing="0"  style="border:#CCCCCC solid 1px; padding-left:5px ">
            <tr>
              <td width="781" height="103" align="left" valign="top">
	 ...
	 for (i=0;i<document.form1.vendedor.options.length;i++)
        {
            ...
            if (document.form1.vendedor.options[i].value==valor1)
               ...
               document.form1.vendedor.options[i].selected=true;
                  ...
                  <td colspan="3">                <span class="Estilo17 text5 text5 Estilo19 Estilo27 Estilo31"><span class="text5 text5 Estilo19 Estilo27 Estilo31  Estilo30"><span class="Estilo24">Caja</span></span></span>                    <select name="serie" style="width:120">
                      <option value="000">------ Todos -------</option>
                      <?php 
	 ...
	 for (i=0;i<document.form1.serie.options.length;i++)
        {
            ...
            if (document.form1.serie.options[i].value==valor1)
               ...
               document.form1.serie.options[i].selected=true;
                  ...
                  <input onClick="cargar_detalle('')" style="width:70px; cursor:pointer" type="button" name="Submit" value="Procesar" >
                  <img src="../imagenes/ico-excel.gif" alt="Excel" width="20" height="20" style="cursor:pointer" onClick="enviar_excel();"></td>
                </tr>
                <tr>
                  <td height="25"  align="left"><span class="Estilo17 text5 text5 Estilo19 Estilo27 Estilo31"><span class="text5 text5 Estilo19 Estilo27 Estilo31  Estilo30"><span class="Estilo24">Tienda</span></span></span></td>
                  <td align="left">
				  <div id="cbo_tienda">
	 ...
	 for (i=0;i<document.form1.turno.options.length;i++)
        {
            ...
            if (document.form1.turno.options[i].value==valor1)
               ...
               document.form1.turno.options[i].selected=true;
                  ...
                  <td width="53" align="center"><!-- <a href="#" onClick="javascript:imprSelec()">&nbsp;&nbsp;<img src="../imgenes/fileprint.png" width="25" height="25" border="0"> </a>--></td>
                  <td width="216" colspan="2" rowspan="2" align="center"><table width="206">
                    <tr>
                      <td width="198"><label>
                        <input name="TipoRep" type="radio" id="TipoRep_0" value="T">
                        Todos (Cancelados y Pendientes)</label></td>
                    </tr>
                    <tr>
                      <td><label>
                        <input type="radio" name="TipoRep" value="C" id="TipoRep_1">
                        Cancelados</label></td>
                    </tr>
                    <tr>
                      <td><label>
                        <input name="TipoRep" type="radio" id="TipoRep_2" value="P" checked>
                        Pendientes a la fecha</label></td>
                    </tr>
                  </table></td>
                </tr>
				    <tr>
                  ...
                  <td colspan="2" align="center"><table width="169">
                    <tr>
                      <td width="161"><input name="acliente" type="checkbox" id="acliente" value="checkbox" style="border:0px;">
                        <?php echo $agruparpor; ?>                  
                      </tr>
                    <tr>
                      <td><input name="detallePagos" type="checkbox" id="detallePagos" value="checkbox" style="border:0px;">
                        Detallar Pagos </td>
                      </tr>
                  </table></td>
                </tr>
        ...
        <tr>
		  ...
		  <div id="detalle" style="width:790px; height:300px; overflow:scroll">
        ...
        <tr>
          <td  colspan="6" valign="top">
		   <div id="paginacion" style="width:790px; height:20px;">
...
for(var x=0;x<document.form1.TipoRep.length;x++){
	if(document.form1.TipoRep[x].checked){
		var tiporep=document.form1.TipoRep[x].value;
	}
}

window.open('det_rpt1.php?fecha='+fecha+'&fecha2='+fecha2+'&sucursal='+sucursal+'&almacen='+almacen+'&vendedor='+vendedor+'&turno='+turno+'&serie='+serie+'&codcli='+codcli+'&acliente='+acliente+'&tipo='+tipo+'&pagina='+'&formato='+formato+'&excel&tiporep='+tiporep,"","toolbar=no,status=no, menubar=no, scrollbars=yes, width=672, height=350,left=300 top=250");
...
doAjax('det_rpt1.php','fecha='+fecha+'&fecha2='+fecha2+'&sucursal='+sucursal+'&almacen='+almacen+'&vendedor='+vendedor+'&turno='+turno+'&serie='+serie+'&codcli='+codcli+'&acliente='+acliente+'&tipo='+tipo+'&pagina='+pagina+'&formato='+formato+'&tiporep='+tiporep,'view_det','get','0','1','','');
}
