...
function validartecla(e,valor,temp){
	...
	if ( ( (e.keyCode>=96) && (e.keyCode<=105) || (e.keyCode>=48) && (e.keyCode<=57) )  || ((e.keyCode>=65) && (e.keyCode<=90)) || e.keyCode==8 || e.keyCode==32 ) {
		...
		var estSP='V';
		//alert(valor);
	doAjax('../compras/det_aux.php','&clasificacion=1&nomb_det='+valor+'&temp='+temp+'&tipomov='+tipomov+'&tienda='+tienda+'&criterio='+temp_criterio+'&prov_asoc='+document.formulario.prov_asoc.value+'&moneda_doc='+'1&flujoc','detalle_prod','get','0','1','','');
		}	
	}
}
...
function listaprod(texto){
	...
	var valor=document.formulario.codprod.value;
...
win00 = window.open('cajachicaxls.php?tienda='+tienda+'&fecha='+fecha,"","toolbar=no,status=no, menubar=no, scrollbars=yes,resizable=yes, width=620, height=520,left=50 top=50");
...
<input name="tipomov"  type="hidden" value="" size="15" />
  <table width="" height="" border="0" cellpadding="0" cellspacing="0">
    <tr  style="background:url(../imagenes/white-top-bottom.gif)">
	  ...
	  <span class="Estilo21 Estilo19 Estilo1 Estilo15 Estilo8"><span class="Estilo21 Estilo19 Estilo15  text5 Estilo12 Estilo48"><strong> Finanzas :: Caja Chica       
<!--<input name="auxiliar" type="text" id="auxiliar" value="<?php //echo $tipo_aux; ?>">-->
      </strong></span></span>	  </td>
    </tr>
    <tr>
      <td height="203">&nbsp;</td>
      <td valign="top"><table width="771" height="444" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td height="43"></td>
          <td height="43"></td>
          <td width="377" rowspan="9">	  <table width="377" height="213" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" align="left">
            <tr>
        ...
        <tr>
          <td width="48" height="2" valign="middle">&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td width="48" height="7" valign="middle">&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td width="48" height="15" valign="middle"><span class="Estilo46">Tienda</span></td>
          <td><select name="tienda" style="font:Verdana, Arial, Helvetica, sans-serif; font-size:10px" onChange="cambiar_foco(1,event)">
            <option value="-1">Seleccione la Tienda</option>
            <?php 
		    $resultados11 = mysql_query("SELECT t.cod_tienda as codig, CONCAT(t.cod_tienda,' - ',t.des_tienda,'//',s.des_suc) as tienda FROM tienda t, sucursal s WHERE s.cod_suc=t.cod_suc order by des_tienda ",$cn); 
			while($row11=mysql_fetch_array($resultados11)){
				if($row11['codig']==$_SESSION['user_tienda']){
				
					?>
            <option selected value="<?php echo $row11['codig'];?>"><?php echo $row11['tienda'];?></option>
          <?php }else{ ?>
            <option value="<?php echo $row11['codig'];?>"><?php echo $row11['tienda'];?></option>
            <?php }}?>
          </select></td>
        </tr>
        <tr>
          <td width="48" height="24" valign="middle">&nbsp;</td>
          <td><?php	$fechai=gmdate('Y-m-d',time()-18000);?></td>
        </tr>
        <tr>
          <td width="48" height="21" valign="middle">&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          ...
          <td><span class="Estilo15">
            ...
            <button type="reset" id="f_trigger_b1" style="height:18; vertical-align:bottom" >...</button>
				...
				<span class="Estilo47">(aaaa-mm-dd)</span></span></td>
        </tr>
        <tr>
          <td valign="middle">&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <td width="2"></td>
          ...
          <td align="center" bgcolor="#D8D8D8"><span class="Estilo14">N&uacute;mero</span></td>
          <td width="155" align="center" bgcolor="#D8D8D8"><span class="Estilo14">Auxiliares</span></td>
        ...
        <td></td>
		  ...
		  <input name="tcambio" id="tcambio" type="text" style="font-size:12px" size="6" maxlength="6" value='<?php echo number_format($_SESSION['tc_promedio'],3)?>' onKeyUp="cambiar_foco(4,event)"></span>          </td>
          ...
          <td align="center"><span class="Estilo15">
            <input autocomplete="off" name="auxiliar" id="auxiliar" type="text" style="font-size:12px" size="18" maxlength="50" onKeyUp="validartecla(event,this,'auxiliares')">
      ...
      <tr>
        ...
        <tr>
          ...
          <td colspan="2"><span class="Estilo14">
            <input type="button" name="r_soles" onClick="recaudacion(1)" value="Recaudaci&oacute;n Soles">
          </span></td>
          <td colspan="2">&nbsp;</td>
          <td colspan="2"><input type="hidden" name="Submit" value="Aceptar" onClick="insertar_flujo()" />
            <input type="button" name="r_dolar" onClick="recaudacion(2)" value="Recaudaci&oacute;n D&oacute;lares"></td>
          <td width="4" align="right">&nbsp;</td>
        </tr>
        <tr>
          <td colspan="10"><strong>Exportar:</strong> <img style="cursor:pointer" onClick="enviar_excel();" src="../imagenes/ico-excel.gif" width="20" height="20"></td>
          </tr>
        <tr>
