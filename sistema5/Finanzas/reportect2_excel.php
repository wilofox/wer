...
if($tipo=='1'){
$titu="Relación de Documentos Compras / Ingresos";
}else{
...
<body>
<table width="788" height="151" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="788"><form name="form1" method="post" action="">
      <table width="784" height="254" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="5" height="19">&nbsp;</td>
          <td width="779" colspan="6" align="center"><span class="Estilo20"><?php echo $titu; ?></span></td>
        </tr>
        <tr>
          <td height="19">&nbsp;</td>
        ...
        <tr>
		  ...
		  <table width="772" border="0" cellpadding="1" cellspacing="1">
            <tr>
              <td width="149" height="18" bgcolor="#006699"><span style="color:#FFFFFF">Fecha Canc. </span></td>
              ...
              <td width="96" align="right" bgcolor="#006699"><span style="color:#FFFFFF">Nro.Operaci&oacute;n</span></td>
            </tr>
            ...
            <tr bgcolor="#F9F9F9" onClick="entrada(this)">
              <td align="left" ><span class="Estilo10"><?php echo $fecha1?></span></td>
			...
			<tr bgcolor="#F9F9F9" onClick="entrada(this)">
              ...
              <td align="center" ><font color="#FF0000" style="text-decoration:line-through"><?php echo $items?></font></td>
              <td align="right" ><font color="#FF0000" style="text-decoration:line-through"><?php echo $importe?></font></td>
              <td align="right" ><font color="#FF0000" style="text-decoration:line-through"><?php echo $igv?></font></td>
              <td align="right" ><font color="#FF0000" style="text-decoration:line-through"><?php echo number_format($total,2)?></font></td>
              <td align="center" ><font color="#FF0000" style="text-decoration:line-through"><?php echo $noperacion?></font></td>
            </tr>
		    ...
		    <tr>
		      <td height="21" bgcolor="#F9F9F9">&nbsp;</td>
		      <td bgcolor="#F9F9F9">&nbsp;</td>
		      <td colspan="6" bgcolor="#F9F9F9">----------------------------------------------------------------------------------------------------------------------------------</td>
		      </tr>
		    <tr>
		      <td height="21" bgcolor="#F9F9F9">&nbsp;</td>
              <td bgcolor="#F9F9F9">&nbsp;</td>
